...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->string('lieu_pays', 100)->default('Côte d Ivoire')->comment('Pays');
            $table->text('instructions_acces')->nullable()->comment('Instructions d accès');
            ...
            $table->boolean('liste_attente')->default(false)->comment('Liste d attente activée');
            ...
            $table->date('date_ouverture_inscription')->nullable()->comment('Date d ouverture des inscriptions');
            ...
            $table->decimal('prix_inscription', 10, 2)->nullable()->comment('Prix d inscription');
            $table->json('tarifs_categories')->nullable()->comment('Tarifs par catégorie (JSON)');
            $table->text('conditions_inscription')->nullable()->comment('Conditions d inscription');
            ...
            $table->timestamp('annule_le')->nullable()->comment('Date d annulation');
            ...
            $table->json('galerie_images')->nullable()->comment('Galerie d images (JSON)');
            ...
            $table->index(['lieu_ville'], 'idx_events_localisation');
        ...
        DB::statement("
            ...
            SELECT
                ...
                CASE
                    ...
                    WHEN e.liste_attente = true AND e.nombre_inscrits >= e.places_disponibles THEN 'Liste d attente'
        ...
        DB::statement("
            ...
            SELECT
                ...
                e.prix_inscription,
                ev.statut_inscription,
                e.nombre_inscrits,
                e.places_disponibles,
                CONCAT(org.prenom, ' ', org.nom) AS nom_organisateur
            FROM events e
            LEFT JOIN events_a_venir ev ON e.id = ev.id
            LEFT JOIN users org ON e.organisateur_principal_id = org.id
