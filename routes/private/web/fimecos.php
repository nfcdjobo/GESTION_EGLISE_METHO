...
Route::prefix('dashboard')->name('private.')->middleware(['auth', 'verified', 'user.status'])->group(function () {
    ...
    Route::prefix('subscriptions')->name('subscriptions.')->group(function () {
        ...
        Route::get('/mes-statistiques', [SubscriptionController::class, 'mesStatistiques'])->name('mes-statistiques');
        ...
        Route::get('peut-souscrire/{fimeco_id}', [SubscriptionController::class, 'peutSouscrire'])->name('peut_souscrire');
