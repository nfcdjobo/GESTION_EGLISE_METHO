...
@section('title', 'Moyens de Paiement - Dons')
...
<section class="donation-section">
    <div class="container">
        ...
        <div class="services-grid">
            @forelse($parametresDons as $parametreDon)
                <div class="payment-card {{ str_replace('_', '-', $parametreDon->type) }}">
                    <div class="payment-header">
                        ...
                        <div class="payment-info">
                            <h3>{{ $parametreDon->type_libelle }}</h3>
                        ...
                        <div class="payment-details">
                            <div class="account-number">
                                <span class="account-label">
                                    @if($parametreDon->type === 'mobile_money')
                                        Numéro Mobile Money
                                    @elseif($parametreDon->type === 'carte_bancaire')
                                        Numéro de Carte
                                    @else
                                        Numéro de Compte
                                    @endif
                                </span>
                                <div class="account-value">{{ $parametreDon->numero_compte }}</div>
                            </div>
                        </div>
                        ...
                        @if($parametreDon->qrcode)
                            <div class="qrcode-container">
                                ...
                                <img src="{{ asset('storage/' . $parametreDon->qrcode) }}"
                                     alt="QR Code {{ $parametreDon->operateur }}">
                            </div>
                        @endif
                    </div>

                    <a href="{{ route('public.donates.create', $parametreDon) }}"
                       class="donate-button">
