...
<div class="space-y-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('private.projets.show', $projet) }}" class="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">{{ $projet->nom_projet }}</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
    ...
    <form action="{{ route('private.projets.update', $projet) }}" method="POST" enctype="multipart/form-data" id="projetForm" class="space-y-8">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nom_projet" name="nom_projet" value="{{ old('nom_projet', $projet->nom_projet) }}" required maxlength="200" placeholder="Ex: Construction nouveau sanctuaire"
                            ...
                            <div>
                                ...
                                <input type="text" id="code_projet" name="code_projet" readonly disabled value="{{ old('code_projet', $projet->code_projet) }}" required maxlength="50" placeholder="Ex: CONST2024001"
                        ...
                        <div>
                            ...
                            <div class="@error('description') has-error @enderror">
                                <textarea id="description" name="description" rows="4" placeholder="Description détaillée du projet"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ old('description', $projet->description) }}</textarea>
                            </div>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="@error('objectif') has-error @enderror">
                                <textarea id="objectif" name="objectif" rows="4" placeholder="Objectifs du projet"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ old('objectif', $projet->objectif) }}</textarea>
                            </div>
                            @error('objectif')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                         ...
                         <div>
                            ...
                            <div class="@error('contexte') has-error @enderror">
                                <textarea id="contexte" name="contexte" rows="4" placeholder="Contextes du projet"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ old('contexte', $projet->contexte) }}</textarea>
                            </div>
                            @error('contexte')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            ...
                            <div>
                                ...
                                <select id="type_projet" name="type_projet" required
                                    ...
                                    @foreach($options['types_projet'] as $key => $label)
                                        <option value="{{ $key }}" {{ old('type_projet', $projet->type_projet) == $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('type_projet')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="categorie" name="categorie" required
                                    ...
                                    @foreach($options['categories'] as $key => $label)
                                        <option value="{{ $key }}" {{ old('categorie', $projet->categorie) == $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('categorie')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="priorite" name="priorite"
                                    ...
                                    @foreach($options['priorites'] as $key => $label)
                                        <option value="{{ $key }}" {{ old('priorite', $projet->priorite) == $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('priorite')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" id="budget_prevu" name="budget_prevu" value="{{ old('budget_prevu', $projet->budget_prevu) }}" min="0" step="0.01" placeholder="0"
                            ...
                            <div>
                                ...
                                <input type="number" id="budget_minimum" name="budget_minimum" value="{{ old('budget_minimum', $projet->budget_minimum) }}" min="0" step="0.01" placeholder="0"
                            ...
                            <div>
                                ...
                                <select id="devise" name="devise"
                                    ...
                                    <option value="XOF" {{ old('devise', $projet->devise) == 'XOF' ? 'selected' : '' }}>Franc CFA (XOF)</option>
                                    <option value="EUR" {{ old('devise', $projet->devise) == 'EUR' ? 'selected' : '' }}>Euro (EUR)</option>
                                    <option value="USD" {{ old('devise', $projet->devise) == 'USD' ? 'selected' : '' }}>Dollar US (USD)</option>
                                </select>
                                @error('devise')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        @if($projet->budget_collecte > 0 || $projet->budget_depense > 0)
                        <div class="bg-slate-50 rounded-xl p-4">
                            <h4 class="font-medium text-slate-800 mb-3">Suivi financier</h4>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                <div>
                                    <span class="text-slate-600">Collecté:</span>
                                    <span class="font-semibold text-green-600">{{ number_format($projet->budget_collecte, 0, ',', ' ') }} {{ $projet->devise }}</span>
                                </div>
                                <div>
                                    <span class="text-slate-600">Dépensé:</span>
                                    <span class="font-semibold text-red-600">{{ number_format($projet->budget_depense, 0, ',', ' ') }} {{ $projet->devise }}</span>
                                </div>
                                <div>
                                    <span class="text-slate-600">Financement:</span>
                                    <span class="font-semibold text-blue-600">{{ $projet->pourcentage_financement }}%</span>
                                </div>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="date" id="date_debut" name="date_debut" value="{{ old('date_debut', $projet->date_debut?->format('Y-m-d')) }}"
                            ...
                            <div>
                                ...
                                <input type="date" id="date_fin_prevue" name="date_fin_prevue" value="{{ old('date_fin_prevue', $projet->date_fin_prevue?->format('Y-m-d')) }}"
                            ...
                            <div>
                                ...
                                <input type="number" id="duree_prevue_jours" name="duree_prevue_jours" value="{{ old('duree_prevue_jours', $projet->duree_prevue_jours) }}" min="1" placeholder="0"
                        ...
                        <div class="bg-blue-50 rounded-xl p-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="w-full bg-blue-200 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $projet->pourcentage_completion }}%"></div>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <select id="responsable_id" name="responsable_id"
                                    ...
                                    @foreach($options['responsables'] as $responsable)
                                        <option value="{{ $responsable['id'] }}" {{ old('responsable_id', $projet->responsable_id) == $responsable['id'] ? 'selected' : '' }}>{{ $responsable['nom_complet'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="coordinateur_id" name="coordinateur_id"
                                    ...
                                    @foreach($options['responsables'] as $responsable)
                                        <option value="{{ $responsable['id'] }}" {{ old('coordinateur_id', $projet->coordinateur_id) == $responsable['id'] ? 'selected' : '' }}>{{ $responsable['nom_complet'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="chef_projet_id" name="chef_projet_id"
                                    ...
                                    @foreach($options['responsables'] as $responsable)
                                        <option value="{{ $responsable['id'] }}" {{ old('chef_projet_id', $projet->chef_projet_id) == $responsable['id'] ? 'selected' : '' }}>{{ $responsable['nom_complet'] }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="localisation" name="localisation" value="{{ old('localisation', $projet->localisation) }}" maxlength="200" placeholder="Ex: Site de l'église"
                            ...
                            <div>
                                ...
                                <input type="text" id="ville" name="ville" value="{{ old('ville', $projet->ville) }}" maxlength="100" placeholder="Ex: Abidjan"
                            ...
                            <div>
                                ...
                                <input type="text" id="region" name="region" value="{{ old('region', $projet->region) }}" maxlength="100" placeholder="Ex: District Autonome d'Abidjan"
                        ...
                        <div>
                            ...
                            <div class="@error('adresse_complete') has-error @enderror">
                                <textarea id="adresse_complete" name="adresse_complete" rows="2" placeholder="Adresse complète du lieu du projet"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none">{{ old('adresse_complete', $projet->adresse_complete) }}</textarea>
                            </div>
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" id="visible_public" name="visible_public" value="1" {{ old('visible_public', $projet->visible_public) ? 'checked' : '' }}
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="ouvert_aux_dons" name="ouvert_aux_dons" value="1" {{ old('ouvert_aux_dons', $projet->ouvert_aux_dons) ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="necessite_suivi" name="necessite_suivi" value="1" {{ old('necessite_suivi', $projet->necessite_suivi) ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="projet_recurrent" name="projet_recurrent" value="1" {{ old('projet_recurrent', $projet->projet_recurrent) ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                            ...
                            <div id="recurrence_section" class="space-y-4 {{ $projet->projet_recurrent ? '' : 'hidden' }}">
                                <div>
                                    ...
                                    <select id="frequence_recurrence" name="frequence_recurrence"
                                        ...
                                        @foreach($options['frequences_recurrence'] as $key => $label)
                                            <option value="{{ $key }}" {{ old('frequence_recurrence', $projet->frequence_recurrence) == $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <input type="url" id="site_web" name="site_web" value="{{ old('site_web', $projet->site_web) }}" placeholder="https://..."
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm text-slate-600">{{ $projet->created_at->format('d/m/Y') }}</span>
                        </div>
                        @if($projet->approuve_le)
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-slate-700">Approuvé le:</span>
                            <span class="text-sm text-slate-600">{{ $projet->approuve_le->format('d/m/Y') }}</span>
                        </div>
                        @endif
                        @if($projet->date_debut)
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-slate-700">Débuté le:</span>
                            <span class="text-sm text-slate-600">{{ $projet->date_debut->format('d/m/Y') }}</span>
                        </div>
                        @endif
                    </div>
                </div>
...
{{-- NOUVEAU : Bouton recherche financement --}}
...
@endif
                        ...
                        <a href="{{ route('private.projets.show', $projet) }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-cyan-600 text-white text-sm font-medium rounded-xl hover:bg-cyan-700 transition-colors">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="{{ route('private.projets.show', $projet) }}" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
