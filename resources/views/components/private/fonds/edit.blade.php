...
@section('content')
    <div class="space-y-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('private.fonds.show', $formData['fonds']) }}"
                                class="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">{{ $formData['fonds']->numero_transaction }}</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700">
                            Cette transaction ne peut plus être modifiée car elle a été
                            {{ $formData['fonds']->statut == 'validee' ? 'validée' : $formData['fonds']->statut }}.
                        </p>
                    </div>
                </div>
            </div>
        ...
        @can('fonds.update')
            <form action="{{ route('private.fonds.update', $formData['fonds']) }}" method="POST" id="transactionForm"
                class="space-y-8">
                @csrf
                @method('PUT')
                            ...
                            <div class="p-6 space-y-6">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div class="text-lg font-bold text-slate-900">
                                                {{ $formData['fonds']->numero_transaction }}</div>
                                        </div>
                                        <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <select id="type_transaction" name="type_transaction" required {{ !$formData['fonds']->peutEtreModifiee() ? 'disabled' : '' }}
                                            ...
                                            <option value="offrande_libre" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'offrande_libre' ? 'selected' : '' }}>
                                                Offrande libre</option>
                                            ...
                                            <option value="offrande_speciale" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'offrande_speciale' ? 'selected' : '' }}>
                                                Offrande spéciale</option>
                                            <option value="offrande_mission" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'offrande_mission' ? 'selected' : '' }}>
                                                Offrande mission</option>
                                            ...
                                            <option value="don_special" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'don_special' ? 'selected' : '' }}>Don
                                                spécial</option>
                                            <option value="soutien_pasteur" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'soutien_pasteur' ? 'selected' : '' }}>
                                                Soutien pasteur</option>
                                            <option value="frais_ceremonie" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'frais_ceremonie' ? 'selected' : '' }}>
                                                Frais cérémonie</option>
                                            <option value="don_materiel" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'don_materiel' ? 'selected' : '' }}>Don
                                                matériel</option>
                                            <option value="autres" {{ old('type_transaction', $formData['fonds']->type_transaction) == 'autres' ? 'selected' : '' }}>Autres
                                            </option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <select id="categorie" name="categorie" required {{ !$formData['fonds']->peutEtreModifiee() ? 'disabled' : '' }}
                                            ...
                                            <option value="reguliere" {{ old('categorie', $formData['fonds']->categorie) == 'reguliere' ? 'selected' : '' }}>Régulière
                                            </option>
                                            <option value="exceptionnelle" {{ old('categorie', $formData['fonds']->categorie) == 'exceptionnelle' ? 'selected' : '' }}>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="date" id="date_transaction" name="date_transaction"
                                            value="{{ old('date_transaction', $formData['fonds']->date_transaction->format('Y-m-d')) }}"
                                            required {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                    ...
                                    <div>
                                        ...
                                        <input type="time" id="heure_transaction" name="heure_transaction"
                                            value="{{ old('heure_transaction', $formData['fonds']->heure_transaction?->format('H:i')) }}"
                                            {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="number" id="montant" name="montant"
                                                value="{{ old('montant', $formData['fonds']->montant) }}" required min="0.01"
                                                step="0.01" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                            ...
                                            <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                                <select name="devise" {{ !$formData['fonds']->peutEtreModifiee() ? 'disabled' : '' }}
                                                    class="border-none bg-transparent text-sm text-slate-600 focus:outline-none {{ !$formData['fonds']->peutEtreModifiee() ? 'cursor-not-allowed' : '' }}">
                                    ...
                                    <div>
                                        ...
                                        <select id="mode_paiement" name="mode_paiement" required {{ !$formData['fonds']->peutEtreModifiee() ? 'disabled' : '' }}
                                            ...
                                            <option value="especes" {{ old('mode_paiement', $formData['fonds']->mode_paiement) == 'especes' ? 'selected' : '' }}>Espèces
                                            </option>
                                            <option value="mobile_money" {{ old('mode_paiement', $formData['fonds']->mode_paiement) == 'mobile_money' ? 'selected' : '' }}>Mobile
                                                Money</option>
                                            <option value="virement" {{ old('mode_paiement', $formData['fonds']->mode_paiement) == 'virement' ? 'selected' : '' }}>Virement
                                                bancaire</option>
                                            <option value="cheque" {{ old('mode_paiement', $formData['fonds']->mode_paiement) == 'cheque' ? 'selected' : '' }}>Chèque
                                            </option>
                                            <option value="nature" {{ old('mode_paiement', $formData['fonds']->mode_paiement) == 'nature' ? 'selected' : '' }}>Don en nature
                                            </option>
                                        </select>
                                        @error('mode_paiement')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="reference_paiement" name="reference_paiement"
                                        value="{{ old('reference_paiement', $formData['fonds']->reference_paiement) }}"
                                        placeholder="Numéro de transaction, chèque, etc." {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="collecteur_id"
                                            class="block text-sm font-medium text-slate-700 mb-2">Collecteur</label>
                                ...
                                <div id="donateur_section" class="space-y-4">
                                    <div>
                                        <label for="donateur_id" class="block text-sm font-medium text-slate-700 mb-2">Donateur
                                            (membre)</label>
                                    ...
                                    <div id="donateur_externe_section"
                                        class="grid grid-cols-1 md:grid-cols-2 gap-4 {{ !$formData['fonds']->est_membre && !$formData['fonds']->est_anonyme ? '' : 'hidden' }}">
                                        <div>
                                            ...
                                            <input type="text" id="nom_donateur_anonyme" name="nom_donateur_anonyme"
                                                value="{{ old('nom_donateur_anonyme', $formData['fonds']->nom_donateur_anonyme) }}"
                                                placeholder="Nom et prénom" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="contact_donateur" name="contact_donateur"
                                                value="{{ old('contact_donateur', $formData['fonds']->contact_donateur) }}"
                                                placeholder="Téléphone ou email" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                ...
                                <div class="p-6 space-y-6">
                                    <div>
                                        ...
                                        <div class="@error('description_don_nature') has-error @enderror">
                                            <textarea id="description_don_nature" name="description_don_nature" rows="3"
                                                placeholder="Description détaillée du don en nature" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="valeur_estimee" name="valeur_estimee"
                                            value="{{ old('valeur_estimee', $formData['fonds']->valeur_estimee) }}" min="0"
                                            step="0.01" placeholder="Valeur en XOF" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" id="destination" name="destination"
                                            value="{{ old('destination', $formData['fonds']->destination) }}"
                                            placeholder="Projet ou usage spécifique" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                ...
                                <div>
                                    ...
                                    <div class="@error('instructions_donateur') has-error @enderror">
                                        <textarea id="instructions_donateur" name="instructions_donateur" rows="3"
                                            placeholder="Instructions ou souhaits particuliers du donateur" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div id="recurrence_section"
                                        class="space-y-4 {{ $formData['fonds']->est_recurrente ? '' : 'hidden' }}">
                                        <div>
                                            ...
                                            <select id="frequence_recurrence" name="frequence_recurrence" {{ !$formData['fonds']->peutEtreModifiee() ? 'disabled' : '' }}
                                                ...
                                                <option value="mensuelle" {{ old('frequence_recurrence', $formData['fonds']->frequence_recurrence) == 'mensuelle' ? 'selected' : '' }}>
                                                    Mensuelle</option>
                                                ...
                                                <option value="annuelle" {{ old('frequence_recurrence', $formData['fonds']->frequence_recurrence) == 'annuelle' ? 'selected' : '' }}>
                                                    Annuelle</option>
                                            </select>
                                        </div>
                                        ...
                                        @if($formData['fonds']->prochaine_echeance)
                                            <div class="text-sm text-slate-600">
                                                ...
                                                {{ $formData['fonds']->prochaine_echeance->format('d/m/Y') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" id="occasion_speciale" name="occasion_speciale"
                                            value="{{ old('occasion_speciale', $formData['fonds']->occasion_speciale) }}"
                                            placeholder="Noël, Pâques, anniversaire..." {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors {{ !$formData['fonds']->peutEtreModifiee() ? 'bg-slate-100 cursor-not-allowed' : '' }}">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="lieu_collecte" name="lieu_collecte"
                                            value="{{ old('lieu_collecte', $formData['fonds']->lieu_collecte) }}"
                                            placeholder="Lieu où la collecte a été effectuée" {{ !$formData['fonds']->peutEtreModifiee() ? 'readonly' : '' }}
                                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors {{ !$formData['fonds']->peutEtreModifiee() ? 'bg-slate-100 cursor-not-allowed' : '' }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-6 space-y-4">
                                    @if($formData['fonds']->validateur)
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="text-sm text-green-900">{{ $formData['fonds']->validateur->nom }}
                                                {{ $formData['fonds']->validateur->prenom }}</span>
                                        </div>
                                    @endif
                                    ...
                                    @if($formData['fonds']->validee_le)
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span
                                                class="text-sm text-green-900">{{ $formData['fonds']->validee_le->format('d/m/Y H:i') }}</span>
                                        </div>
                                    @endif
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-4 text-sm">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span
                                        class="text-slate-600">{{ $formData['fonds']->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                                ...
                                @if($formData['fonds']->updated_at && $formData['fonds']->updated_at != $formData['fonds']->created_at)
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-slate-600">{{ $formData['fonds']->updated_at->format('d/m/Y H:i') }}</span>
                                    </div>
                                @endif
                                ...
                                @if($formData['fonds']->createur)
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-slate-600">{{ $formData['fonds']->createur->nom }}
                                            {{ $formData['fonds']->createur->prenom }}</span>
                                    </div>
                                @endif
                                ...
                                @if($formData['fonds']->modificateur && $formData['fonds']->modificateur->id != $formData['fonds']->createur?->id)
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-slate-600">{{ $formData['fonds']->modificateur->nom }}
                                            {{ $formData['fonds']->modificateur->prenom }}</span>
                                    </div>
                                @endif
                                        ...
                                        @foreach($formData['fonds']->transactionsEnfants->take(5) as $enfant)
                                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                                <div>
                                                    ...
                                                    <div class="text-xs text-slate-500">{{ $enfant->date_transaction->format('d/m/Y') }}
                                                    </div>
                                                </div>
                                                <div class="text-right">
                                                    <div class="text-sm font-semibold text-slate-900">
                                                        {{ number_format($enfant->montant, 0, ',', ' ') }} {{ $enfant->devise }}</div>
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
                    <div class="p-6">
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a href="{{ route('private.fonds.index') }}"
                                class="inline-flex items-center justify-center px-8 py-3 bg-slate-500 text-white font-medium rounded-xl hover:bg-slate-600 transition-colors">
