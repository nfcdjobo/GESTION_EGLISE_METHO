...
@section('title', 'Télécharger un Média')
...
<div class="space-y-8">
    ...
    <!-- Formulaire d'upload -->
    <form action="{{ route('private.multimedia.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm" class="space-y-8">
        @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="@error('description') has-error @enderror">
                        <textarea name="description" id="description" rows="5" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Description détaillée du média">{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="@error('legende') has-error @enderror">
                        <textarea name="legende" id="legende" rows="2" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Légende courte pour l'affichage">{{ old('legende') }}</textarea>
                    </div>
                    @error('legende')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="date_prise" id="date_prise" value="{{ old('date_prise') }}"
                               class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        @error('date_prise')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="lieu_prise" id="lieu_prise" value="{{ old('lieu_prise') }}"
                               class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    ...
                    <div>
                        ...
                        <input type="text" name="photographe" id="photographe" value="{{ old('photographe') }}"
                               class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                    ...
                    <div>
                        ...
                        <input type="text" name="appareil" id="appareil" value="{{ old('appareil') }}"
                               class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                ...
                <div>
                    ...
                    <select name="qualite" id="qualite"
                        ...
                        @foreach($qualites as $key => $label)
                            <option value="{{ $key }}" {{ old('qualite', 'standard') == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <select name="niveau_acces" id="niveau_acces" required
                        ...
                        @foreach($niveaux_acces as $key => $label)
                            <option value="{{ $key }}" {{ old('niveau_acces', 'public') == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="usage_public" value="1" {{ old('usage_public', true) ? 'checked' : '' }}
                            ...
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="usage_site_web" value="1" {{ old('usage_site_web', true) ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                            ...
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="usage_reseaux_sociaux" value="1" {{ old('usage_reseaux_sociaux') ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                <span class="ml-3 text-sm text-slate-700">Partage sur réseaux sociaux</span>
                            </label>
                            <label class="flex items-center">
                                <input type="hidden" name="usage_commercial" value="0">
                                <input type="checkbox" name="usage_commercial" value="1" {{ old('usage_commercial') ? 'checked' : '' }}
                                       class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                ...
                                <input type="checkbox" name="contenu_sensible" value="1" {{ old('contenu_sensible') ? 'checked' : '' }}
                            ...
                            @can('feature_media')
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox" name="est_featured" value="1" {{ old('est_featured') ? 'checked' : '' }}
                ...
                <div>
                    ...
                    <div class="@error('restrictions_usage') has-error @enderror">
                    <textarea name="restrictions_usage" id="restrictions_usage" rows="3" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Précisez les restrictions particulières d'usage de ce média">{{ old('restrictions_usage') }}</textarea>
                    </div>
                ...
                <div id="warningSection" class="hidden">
                    ...
                    <div class="@error('avertissement') has-error @enderror">
                    <textarea name="avertissement" id="avertissement" rows="2"
                              ...
                              placeholder="Décrivez pourquoi ce contenu est sensible">{{ old('avertissement') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between gap-4 pt-6">
            <a href="{{ route('private.multimedia.index') }}" class="inline-flex items-center px-6 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
