            ...
            <div class="p-6">
                <div class="flex flex-wrap gap-3">
                    @canany(['permissions.update', 'permissions.toggle'])
                        @can('permissions.create')
                            @if (!$permission->is_system || auth()->user()->isSuperAdmin())
                                <a href="{{ route('private.permissions.edit', $permission) }}"
                    ...
                    @can('permissions.clone')
                        <button type="button" onclick="clonePermission()"
                    ...
                    @can('permissions.delete')
                        @if (!$permission->is_system)
                            <button type="button" onclick="deletePermission()"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            ...
                                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-sm text-slate-500">Niveau {{ $role->level }}
                                                        </div>
                                                    </div>
                                                </div>
                                                @can('roles.read')
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-slate-800 mb-4 flex items-center">
                                    ...
                                    Membress directs ({{ $permission->users->count() }})
                                </h3>
                                        ...
                                        @foreach ($permission->users as $user)
                                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-slate-900">{{ $user->nom_complet }}
                                                        </div>
                                ...
                                @else
                                    <div class="text-center py-8">
                                        ...
                                        <p class="text-slate-500">Aucun membres assigné directement</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="pt-4 border-t border-slate-200">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-slate-700">Total membres:</span>
                                <span
                                    class="text-xl font-bold text-blue-600">{{ $stats['total_users_direct'] + $stats['total_users_via_roles'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        @if ($permission->last_used_at)
                            <div>
                                ...
                                <p class="text-sm text-slate-600">{{ $permission->last_used_at->format('d/m/Y à H:i') }}
                                </p>
                            </div>
                        @else
                            <div>
                        ...
                        <div>
                            ...
                            <code
                                class="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">{{ $permission->guard_name }}</code>
                        </div>
                    </div>
                </div>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full">
            <div class="p-6">
                ...
                <p class="text-red-600 font-medium">Cette action est irréversible et supprimera toutes les associations.
                </p>
            </div>
