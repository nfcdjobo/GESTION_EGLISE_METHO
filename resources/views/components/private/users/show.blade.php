        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-users text-slate-500">Informations détaillées de
                                    {{ $user->nom_complet }} - {{ \Carbon\Carbon::now()->format('l d F Y') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-8">
                    <div class="flex items-center justify-between">
                            ...
                            <div class="flex-shrink-0">
                                @if ($user?->photo_profil)
                                    <img class="h-24 w-24 rounded-full object-cover border-4 border-white shadow-lg"
                                        src="{{ Storage::url($user->photo_profil) }}" alt="{{ $user->nom_complet }}">
                                @else
                                    <div
                        ...
                        <div class="flex space-x-3">
                            <a href="{{ route('private.users.index') }}"
                                class="inline-flex items-center px-4 py-2.5 bg-white/10border border-white/20 rounded-xl font-medium text-white hover:bg-white/20 transition-all duration-200">
                                <i class="fas fa-arrow-left mr-2"></i>Retour
                            </a>
                            @can('users.update')
                                <a href="{{ route('private.users.edit', $user) }}"
                                    class="inline-flex items-center px-4 py-2.5 bg-indigo-700 text-white rounded-xl font-medium hover:bg-indigo-800 transition-colors shadow-md hover:shadow-lg">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-slate-50 to-gray-50 border-b border-slate-200">
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <div class="text-center">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center mx-auto mb-2 shadow-lg">
                        ...
                        <div class="text-center">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mx-auto mb-2 shadow-lg">
                        ...
                        <div class="text-center">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center mx-auto mb-2 shadow-lg">
                        ...
                        <div class="text-center">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mx-auto mb-2 shadow-lg">
                        ...
                        <div class="text-center">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl flex items-center justify-center mx-auto mb-2 shadow-lg">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div
                        ...
                        <div class="p-6 border-b border-slate-200">
                            <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                <div
                                    class="w-10 h-10 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm font-semibold text-slate-900">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $user->sexe === 'masculin' ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800' }}">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm font-semibold text-slate-900">
                                        {{ $user->statut_matrimonial ? ucfirst($user->statut_matrimonial) : 'Non renseigné' }}
                                    </p>
                                </div>
                                <div class="space-y-1">
                    ...
                    <div
                        ...
                        <div class="p-6 border-b border-slate-200">
                            <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                <div
                                    class="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                @if ($user->telephone_2)
                                    <div class="space-y-1">
                                        <label class="block text-sm font-medium text-slate-500">Téléphone
                                            secondaire</label>
                                        <p class="text-sm font-semibold text-slate-900">
                                            <a href="tel:{{ $user->telephone_2 }}"
                                                class="inline-flex items-center text-indigo-600 hover:text-indigo-700 transition-colors">
                                                <i class="fas fa-phone mr-2"></i>
                                                {{ $user->telephone_2 }}
                                            </a>
                    ...
                    <div
                        ...
                        <div class="p-6 border-b border-slate-200">
                            <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                <div
                                    class="w-10 h-10 bg-gradient-to-r from-red-500 to-pink-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                    ...
                    @if ($user->profession || $user->employeur)
                        <div
                            ...
                            <div class="p-6 border-b border-slate-200">
                                <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                    ...
                    @if ($user->contact_urgence_nom || $user->contact_urgence_telephone)
                        <div
                            ...
                            <div class="p-6 border-b border-slate-200">
                                <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    @if ($user->contact_urgence_telephone)
                                        <div class="space-y-1">
                                            ...
                                            <p class="text-sm font-semibold text-slate-900">
                                                <a href="tel:{{ $user->contact_urgence_telephone }}"
                                    ...
                                    @if ($user->contact_urgence_relation)
                                        <div class="space-y-1">
                                            ...
                                            <p class="text-sm font-semibold text-slate-900">
                                                {{ $user->contact_urgence_relation }}</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="space-y-8">
                    ...
                    <div
                        ...
                        <div class="p-6 border-b border-slate-200">
                            <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                <div
                                    class="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                            ...
                            <div class="space-y-4">
                                ...
                                @if ($user->date_bapteme)
                                    <div class="space-y-1">
                                        ...
                                        <p class="text-sm font-semibold text-slate-900">
                                            {{ $user->date_bapteme->format('d/m/Y') }}</p>
                                    </div>
                                @endif
                                ...
                                @if ($user->roles->count() > 0)
                                    <div class="space-y-3">
                                        @foreach ($user->roles->where('pivot.actif', true) as $role)
                                            <div
                                                class="flex items-center justify-between p-3 bg-indigo-50 rounded-xl border-2 border-indigo-100">
                                                <div>
                                                ...
                                                @if ($role->pivot->expire_le)
                                                    <span class="text-xs text-slate-500 bg-white px-2 py-1 rounded-lg">
                                                        Expire:
                                                        {{ \Carbon\Carbon::parse($role->pivot->expire_le)->format('d/m/Y') }}
                                                    </span>
                                                @endif
                                            </div>
                                        @endforeach
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        @foreach ($user->permissions->where('pivot.is_granted', true) as $permission)
                                            <div
                                                class="flex items-center text-xs text-green-600 bg-green-50 px-3 py-2 rounded-lg">
                    ...
                    @if ($recentActivity->count() > 0)
                        <div
                            ...
                            <div class="p-6 border-b border-slate-200">
                                <h3 class="text-lg font-bold text-slate-800 flex items-center">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
            ...
            @if ($user->notes_admin)
                <div class="bg-yellow-50/80 backdrop-blur-sm border-2 border-yellow-200 rounded-2xl p-6 shadow-lg">
                    ...
                    <div
                        class="text-sm text-yellow-700 whitespace-pre-line bg-white/50 p-4 rounded-xl border border-yellow-200">
                        {{ $user->notes_admin }}</div>
                </div>
            @endif
        </div>
    </div>
