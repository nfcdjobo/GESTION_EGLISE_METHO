...
<body>
    ...
    <div class="document-header">
        <div class="header-content">
            <h1 class="document-title">{{ $rapport->titre_rapport }}</h1>
    ...
    <div class="meta-section">
        ...
        <div class="meta-grid">
            ...
            <div class="meta-cell">
                ...
                <div class="meta-value">{{ $rapport->redacteur ? $rapport->redacteur->nom . ' ' . $rapport->redacteur->prenom : 'Non assigné' }}</div>
            </div>
            <div class="meta-cell">
                <div class="meta-label">Statut Actuel</div>
                <div class="meta-value">{{ $rapport->statut_traduit }}</div>
            </div>
            @if($rapport->reunion || $rapport->validateur || $rapport->valide_le)
            <div class="meta-cell">
                <div class="meta-label">Réunion</div>
                <div class="meta-value">{{ $rapport->reunion ? $rapport->reunion->titre : 'Non associée' }}</div>
            </div>
            <div class="meta-cell">
            ...
            <div class="meta-cell">
                ...
                <div class="meta-value">{{ $rapport->validateur ? $rapport->validateur->nom . ' ' . $rapport->validateur->prenom : 'En attente' }}</div>
            </div>
            <div class="meta-cell">
                <div class="meta-label">Validé le</div>
                <div class="meta-value">{{ $rapport->valide_le ? $rapport->valide_le->format('d/m/Y') : 'En attente' }}</div>
            </div>
            @endif
        </div>
    </div>
    ...
    <!-- Statistiques Visuelles -->
    @if($rapport->nombre_presents || $rapport->montant_collecte || $rapport->note_satisfaction || ($rapport->points_traites && count($rapport->points_traites) > 0))
            ...
            <div class="stats-cell">
                <div class="stat-number">
                    <div class="rating-container">
                        @for($i = 1; $i <= 5; $i++)
                            <span class="star {{ $i <= $rapport->note_satisfaction ? 'filled' : 'empty' }}">★</span>
                        @endfor
                    </div>
                </div>
    ...
    <div class="document-footer">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <div class="footer-text">{{ now()->format('d/m/Y à H:i') }}</div>
            </div>
            <div class="footer-section">
                <div class="footer-title">Référence</div>
                <div class="footer-text">Rapport #{{ $rapport->id }}</div>
            </div>
            <div class="footer-section">
                <div class="footer-title">Validation</div>
                <div class="footer-text">
                    @if($rapport->validateur && $rapport->valide_le)
                        {{ $rapport->validateur->nom }} {{ $rapport->validateur->prenom }}<br>
                        {{ $rapport->valide_le->format('d/m/Y') }}
                    @else
                        En attente
                    @endif
                </div>
