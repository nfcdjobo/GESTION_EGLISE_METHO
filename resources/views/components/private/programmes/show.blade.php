                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <dd><code
                                        class="px-3 py-1 text-sm bg-slate-100 text-slate-800 rounded-lg">{{ $programme->code_programme }}</code>
                                </dd>
                            </div>
            ...
            <div class="space-y-6">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <div class="font-semibold text-slate-900">
                                        ...
                                        {{ $programme->responsablePrincipal->nom }}
                                    </div>
                                    @if ($programme->responsablePrincipal->email)
                                        <div class="text-sm text-slate-600">{{ $programme->responsablePrincipal->email }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        @if ($programme->updated_at != $programme->created_at)
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="text-sm text-slate-900">{{ $programme->updated_at->format('d/m/Y H:i') }}</span>
                            </div>
                        @endif
                ...
                <div
                    ...
                    <div class="p-6 space-y-3">
                        <a href="{{ route('private.programmes.index') }}?type={{ $programme->type_programme }}"
