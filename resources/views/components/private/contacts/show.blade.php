...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">{{ $contact->nom_eglise }}</h1>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-slate-500">{{ Str::limit($contact->nom_eglise, 30) }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex flex-wrap gap-2">
                @can('contacts.update')
                    <a href="{{ route('private.contacts.edit', $contact) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-yellow-600 to-amber-600 text-white text-sm font-medium rounded-xl hover:from-yellow-700 hover:to-amber-700 transition-all duration-200 shadow-md hover:shadow-lg">
                ...
                @can('contacts.update')
                    @if(!$contact->verifie)
                        <button onclick="verifyContact('{{ $contact->id }}')" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-sm font-medium rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
                            <i class="fas fa-check mr-2"></i> Vérifier
                        </button>
                    @endif
                @endcan

                <button onclick="showQRCode('{{ $contact->id }}')" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-medium rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="flex items-center space-x-6">
                    <div class="flex-shrink-0">
                        @if($contact->logo_url)
                            <img class="h-20 w-20 rounded-2xl object-cover shadow-lg" src="{{ $contact->logo_url }}" alt="{{ $contact->nom_eglise }}">
                        @else
                            <div class="h-20 w-20 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center shadow-lg">
                                <span class="text-white font-bold text-2xl">{{ substr($contact->nom_eglise, 0, 2) }}</span>
                            </div>
                        @endif
                    </div>
                    <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800">{{ number_format($contact->capacite_accueil) }}</p>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-bold text-slate-800">{{ $stats['derniere_verification']->diffForHumans() }}</p>
        ...
        <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-slate-900">{{ $contact->telephone_principal }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-slate-900">{{ $contact->telephone_secondaire }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <a href="mailto:{{ $contact->email_principal }}" class="text-lg font-semibold text-purple-600 hover:text-purple-700">{{ $contact->email_principal }}</a>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contact->whatsapp) }}" target="_blank" class="text-lg font-semibold text-green-600 hover:text-green-700">{{ $contact->whatsapp }}</a>
                            </div>
                        </div>
                        @endif
                    </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        <a href="https://www.google.com/maps?q={{ $contact->latitude }},{{ $contact->longitude }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <h4 class="text-lg font-semibold text-slate-900">{{ $contact->pasteur_principal }}</h4>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-sm text-slate-700">{{ $contact->telephone_pasteur }}</span>
                                </div>
                                @endif
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="mailto:{{ $contact->email_pasteur }}" class="text-sm text-purple-600 hover:text-purple-700">{{ $contact->email_pasteur }}</a>
                                </div>
                                @endif
                            </div>
                        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <a href="{{ $contact->site_web_principal }}" target="_blank" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                        <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                            <i class="fas fa-globe text-blue-600"></i>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-slate-700">Site web</p>
                            <p class="text-blue-600 hover:text-blue-700">{{ $contact->site_web_principal }}</p>
                        </div>
                    </a>
                    @endif

                    @if($contact->facebook_url)
                    <a href="{{ $contact->facebook_url }}" target="_blank" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                        <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                            <i class="fab fa-facebook text-blue-600"></i>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-slate-700">Facebook</p>
                            <p class="text-blue-600 hover:text-blue-700 text-sm">{{ Str::limit($contact->facebook_url, 30) }}</p>
                        </div>
                    </a>
                    @endif

                    @if($contact->instagram_url)
                    <a href="{{ $contact->instagram_url }}" target="_blank" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                        <div class="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center">
                            <i class="fab fa-instagram text-pink-600"></i>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-slate-700">Instagram</p>
                            <p class="text-pink-600 hover:text-pink-700 text-sm">{{ Str::limit($contact->instagram_url, 30) }}</p>
                        </div>
                    </a>
                    @endif

                    @if($contact->youtube_url)
                    <a href="{{ $contact->youtube_url }}" target="_blank" class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                        <div class="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center">
                            <i class="fab fa-youtube text-red-600"></i>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-slate-700">YouTube</p>
                            <p class="text-red-600 hover:text-red-700 text-sm">{{ Str::limit($contact->youtube_url, 30) }}</p>
                        </div>
                    </a>
                    @endif
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm text-slate-600">{{ $contact->derniere_verification->format('d/m/Y') }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm text-slate-600">{{ $contact->createur->nom }} {{ $contact->createur->prenom }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm text-slate-600">{{ $contact->responsableContact->nom }} {{ $contact->responsableContact->prenom }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="w-16 bg-gray-200 rounded-full h-2">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $stats['completude'] }}%"></div>
                            </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6 space-y-3">
                    @can('contacts.update')
                    <button onclick="toggleVisibility({{ $contact->id }})" class="w-full flex items-center justify-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-lg hover:bg-slate-700 transition-colors">
                    ...
                    @can('contacts.create')
                    <a href="{{ route('private.contacts.duplicate', $contact) }}" class="w-full flex items-center justify-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors">
                        <i class="fas fa-copy mr-2"></i> Dupliquer
                    </a>
                    @endcan

                    @can('contacts.delete')
                    <button onclick="deleteContact({{ $contact->id }})" class="w-full flex items-center justify-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition-colors">
