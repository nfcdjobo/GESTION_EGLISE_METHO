...
@section('title', 'Créer une FIMECO')
...
<div class="space-y-8">
    ...
    <form action="{{ route('private.fimecos.store') }}" method="POST" id="fimecoForm" class="space-y-8">
        @csrf
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            ...
                            <input type="text" id="nom" name="nom" value="{{ old('nom') }}" required maxlength="100" placeholder="Ex: FIMECO 2024 - Développement Infrastructure"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="date" id="debut" name="debut" value="{{ old('debut') }}" required
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('debut') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                                @error('debut')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" id="fin" name="fin" value="{{ old('fin') }}" required
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('fin') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror">
                                @error('fin')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
