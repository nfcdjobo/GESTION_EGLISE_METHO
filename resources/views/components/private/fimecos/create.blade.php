...
@section('content')
    <div class="space-y-8">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <form action="{{ route('private.fimecos.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Décrivez l'objectif et les détails du FIMECO...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" id="cible" name="cible" value="{{ old('cible') }}" required min="1"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="debut" name="debut" value="{{ old('debut', date('Y-m-d')) }}" required
    ...
    @push('scripts')
        <script>
            ...
            function validerDonnees() {
                ...
                fetch('{{ route("private.fimecos.validateFimecoData") }}', {
                    method: 'POST',
                    headers: {
