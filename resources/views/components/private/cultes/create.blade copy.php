...
@section('content')
    <div class="space-y-8">
        ...
        @can('cultes.create')
            <form action="{{ route('private.cultes.store') }}" method="POST" enctype="multipart/form-data" id="culteForm"
                class="space-y-8">
                @csrf
                    ...
                    <div class="lg:col-span-2 space-y-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" id="titre" name="titre" value="{{ old('titre') }}" required
                                            maxlength="200" placeholder="Ex: Culte du dimanche matin"
                                    ...
                                    <div>
                                        ...
                                        <select id="type_culte" name="type_culte" required
                                            ...
                                            @foreach(\App\Models\Culte::TYPE_CULTE as $key => $label)
                                                <option value="{{ $key }}" {{ old('type_culte') == $key ? 'selected' : '' }}>
                                                    {{ $label }}</option>
                                            @endforeach
                                        </select>
                                        @error('type_culte')
                                    ...
                                    <div>
                                        ...
                                        <select id="statut" name="statut" required
                                            ...
                                            @foreach(\App\Models\Culte::STATUT as $key => $label)
                                                <option value="{{ $key }}" {{ old('statut', 'planifie') == $key ? 'selected' : '' }}>
                                                    {{ $label }}</option>
                                            @endforeach
                                        </select>
                                        @error('statut')
                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="date" id="date_culte" name="date_culte" value="{{ old('date_culte') }}"
                                            required
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" id="lieu" name="lieu" value="{{ old('lieu', 'Église principale') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="capacite_prevue" name="capacite_prevue"
                                            value="{{ old('capacite_prevue') }}" min="1"
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                {{-- // Remplacez la section du template dans le HTML par ceci : --}}
                                <div id="officiant-template" style="display: none;">
                                    <!-- Utilisez display:none au lieu de hidden -->
                                    <div class="bg-slate-50 rounded-lg p-4 border border-slate-200 officiant-item">
                                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                            <div>
                                                ...
                                                <select
                                                    class="officiant-user w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                                    <!-- Retirez l'attribut required du template -->
                            ...
                            <div class="p-6 space-y-6">
                                <div>
                                    ...
                                    <input type="text" id="titre_message" name="titre_message"
                                        value="{{ old('titre_message') }}" maxlength="300" placeholder="Titre de la prédication"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="passage_biblique" name="passage_biblique"
                                        value="{{ old('passage_biblique') }}" maxlength="500" placeholder="Ex: Jean 3:16-17"
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex items-center">
                                            <input type="checkbox" id="necessite_invitation" name="necessite_invitation"
                                                value="1" {{ old('necessite_invitation') ? 'checked' : '' }}
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                        ...
                                        <div class="flex items-center">
                                            <input type="checkbox" id="diffusion_en_ligne" name="diffusion_en_ligne" value="1"
                                                {{ old('diffusion_en_ligne') ? 'checked' : '' }}
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                    ...
                                    <div id="liens_section" class="space-y-4 hidden">
                                        <div>
                                            ...
                                            <input type="url" id="lien_diffusion_live" name="lien_diffusion_live"
                                                value="{{ old('lien_diffusion_live') }}" placeholder="https://..."
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('addOfficiantBtn').addEventListener('click', function () {
                ...
                userSelect.addEventListener('change', updatePreviewOfficiants);
            ...
            function updatePreviewOfficiants() {
                ...
                officiants.forEach(officiant => {
                    const userSelect = officiant.querySelector('.officiant-user');
                    ...
                    const userName = userSelect.options[userSelect.selectedIndex]?.text || 'Non sélectionné';

                    if (userSelect.value) {
                        html += `<div class="text-xs">
                        <span class="font-medium">${titre}:</span> ${userName}
            ...
            document.getElementById('culteForm').addEventListener('submit', function (e) {
                ...
                if (officiants.length > 0 && !hasValidOfficiant) {
                    e.preventDefault();
                    alert('Veuillez compléter les informations des officiants ou les supprimer.');
                    return false;
                }
            });
