        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            {{ $interventions->where('type_intervention', 'predication')->count() }}</p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            {{ $interventions->where('type_intervention', 'temoignage')->count() }}</p>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="text-sm">
                                                <div class="text-slate-900 font-medium">
                                                    {{ $intervention->deleted_at->format('d/m/Y') }}</div>
                                                <div class="text-slate-500">{{ $intervention->deleted_at->format('H:i') }}
                                                </div>
                                                <div class="text-xs text-slate-400">
                                                    {{ $intervention->deleted_at->diffForHumans() }}</div>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4">
                                            <div class="flex items-center space-x-2">
                                                @can('interventions.restore')
                                                <button type="button"
                                                    onclick="restoreIntervention('{{ $intervention->id }}')"
                                                ...
                                                @can('interventions.delete')
                                                <button type="button"
                                                    onclick="deleteInterventionPermanently('{{ $intervention->id }}')"
