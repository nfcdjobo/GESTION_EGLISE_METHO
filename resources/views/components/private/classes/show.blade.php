...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">{{ $classe->nom }}</h1>
            ...
            <div class="flex items-center space-x-3">
                @can('classes.update')
                    <a href="{{ route('private.classes.edit', $classe) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-sm font-medium rounded-xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 overflow-hidden">
                ...
                <div class="relative h-64 bg-gradient-to-br from-blue-400 to-purple-500">
                    @if($classe->image_classe)
                        <img src="{{ Storage::url($classe->image_classe) }}" alt="{{ $classe->nom }}" class="w-full h-full object-cover">
                    @else
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-slate-900">{{ $classe->created_at->format('d/m/Y') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-slate-900">{{ $classe->updated_at->format('d/m/Y à H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            @if($classe->membres->count() > 6)
                                <a href="{{ route('private.classes.membres', $classe) }}" class="inline-flex items-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-all duration-200">
                    ...
                    @if($classe->membres->count() > 0)
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            @if($membre->date_naissance)
                                                <p class="text-xs text-slate-400">{{ $membre->date_naissance->diffInYears(now()) }} ans</p>
                                            @endif
                                        </div>
                                    </div>
                                    @can('classes.manage-members')
                                        <button onclick="removeMember('{{ $membre->id }}')" class="text-red-600 hover:text-red-800 p-2 rounded-lg hover:bg-red-50 transition-colors">
                        ...
                        @if($classe->membres->count() > 6)
                            <div class="mt-4 text-center">
                                ...
                                <a href="{{ route('private.classes.membres', $classe) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <!-- Places disponibles -->
                    <div class="text-center">
                        <div class="text-3xl font-bold text-green-600">{{ $classe->places_disponibles ?? (50 - $classe->nombre_inscrits) }}</div>
                    ...
                    <div>
                        ...
                        <div class="w-full bg-slate-200 rounded-full h-3">
                            <div class="bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full transition-all duration-300" style="width: {{ min($pourcentage, 100) }}%"></div>
                        </div>
                    </div>

                    <!-- Statut -->
                    <div class="text-center p-3 rounded-xl {{ $classe->nombre_inscrits >= 50 ? 'bg-red-50 border border-red-200' : 'bg-green-50 border border-green-200' }}">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6 space-y-3">
                    ...
                    @can('classes.read')
                        <a href="{{ route('private.classes.membres', $classe) }}" class="w-full inline-flex items-center justify-center px-4 py-3 bg-purple-600 text-white text-sm font-medium rounded-xl hover:bg-purple-700 transition-colors">
