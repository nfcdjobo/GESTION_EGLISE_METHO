    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                ...
                <button type="button" onclick="exportParametres()" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white text-sm font-medium rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800">{{ $parametres->horaires_cultes ? count($parametres->horaires_cultes) : '0' }}</p>
                    <p class="text-sm text-slate-500">Horaires de culte</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
                @if($parametres->horaires_cultes && count($parametres->horaires_cultes) > 0)
                    <div class="space-y-3">
                        @foreach($parametres->horaires_cultes as $horaire)
                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-medium text-slate-900">{{ $horaire['jour'] ?? 'N/A' }}</p>
                                        <p class="text-sm text-slate-500">{{ $horaire['type'] ?? 'Culte' }}</p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="font-medium text-slate-900">{{ $horaire['heure'] ?? 'N/A' }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-slate-500">Aucun horaire de culte configuré</p>
                    </div>
                @endif
            </div>
        </div>
