    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-blue-600 text-sm">Vérifiez votre email  <code class="bg-blue-100 px-2 py-1 rounded">{{ session('email') }}</code></p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div id="loginSection" class="section">
                ...
                <form method="POST" action="{{ route('security.login') }}" id="loginForm" class="space-y-6">
                    @csrf
            ...
            <div id="forgotSection" class="section hidden">
                ...
                <form method="POST" action="{{ route('security.request') }}" id="forgotForm" class="space-y-6">
                    @csrf
