    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-blue-600 text-sm">Vérifiez votre email ou utilisez ce token : <code class="bg-blue-100 px-2 py-1 rounded">{{ session('reset_token') }}</code></p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <div id="loginSection" class="section">
                ...
                <form method="POST" action="{{ route('security.login') }}" class="space-y-6">
                    @csrf
            ...
            <div id="forgotSection" class="section hidden">
                ...
                <form method="POST" action="{{ route('security.request') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('recovery') }}"
                            required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 @error('recovery') border-red-500 @enderror"
                            placeholder="exemple@email.com"
                        >
                        @error('recovery')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
