    ...
    @if(isset($rapport['informations_generales']))
        ...
        <div style="margin-bottom: 25px;">
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                <strong>{{ htmlspecialchars($rapport['informations_generales']['nom'] ?? 'N/A') }}</strong>
                            </td>
                            <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                {{ htmlspecialchars($rapport['informations_generales']['responsable'] ?? 'N/A') }}
                            </td>
                            <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                {{ htmlspecialchars($rapport['informations_generales']['periode'] ?? 'N/A') }}
                            </td>
                            <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                {{ htmlspecialchars($rapport['informations_generales']['date_creation'] ?? 'N/A') }}
                            </td>
                            <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                ...
                                @endphp
                                <span style="padding: 3px 8px; border-radius: 12px; font-size: 8px; font-weight: bold; text-transform: uppercase; background-color: {{ $bgColor }}; color: {{ $textColor }};">
            ...
            <div style="background-color: #eff6ff; border: 1px solid #bfdbfe; border-radius: 4px; padding: 10px; margin: 10px 0;">
                ...
                <div style="margin-top: 5px; font-size: 9px;">{{ nl2br(htmlspecialchars(strip_tags($rapport['informations_generales']['description']))) }}</div>
            </div>
            @endif
        </div>
    @endif
        ...
        <div style="margin-bottom: 25px;">
            ...
            <div style="width: 100%; margin: 12px 0; position: relative;">
                <div style="width: 100%; height: 24px; background-color: #e5e7eb; border-radius: 10px; border: 1px solid #d1d5db;">
                    <div style="height: 100%; background-color: {{ $progressColor }}; border-radius: 10px; width: {{ $progressWidth }}%;"></div>
                </div>
                <div style="position: absolute; top: 3px; left: 0; width: 100%; text-align: center;">
                    <span style="color: {{ $progressWidth > 15 ? 'white' : '#1f2937' }}; font-weight: bold; font-size: 11px; text-shadow: {{ $progressWidth > 15 ? '1px 1px 2px rgba(0,0,0,0.8)' : 'none' }};">
            ...
            <div style="width: 100%; margin-bottom: 15px;">
                <div style="float: left; width: 23%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #3b82f6;">{{ number_format($rapport['objectifs_et_resultats']['cible'] ?? 0, 0) }} FCFA</div>
                </div>
                <div style="float: left; width: 23%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">COLLECTÉ</div>
                    <div style="font-size: 12px; font-weight: bold; color: #059669;">{{ number_format($rapport['objectifs_et_resultats']['montant_solde'] ?? 0, 0) }} FCFA</div>
                </div>
                <div style="float: left; width: 23%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">RESTE</div>
                    <div style="font-size: 12px; font-weight: bold; color: #f59e0b;">{{ number_format($rapport['objectifs_et_resultats']['reste'] ?? 0, 0) }} FCFA</div>
                </div>
                ...
                <div style="float: left; width: 23%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #7c3aed;">+{{ number_format($rapport['objectifs_et_resultats']['montant_supplementaire'], 0) }} FCFA</div>
                </div>
                @endif
                <div style="clear: both;"></div>
            </div>
        ...
        <div style="margin-bottom: 25px;">
            ...
            <div style="width: 100%; margin-bottom: 15px;">
                <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #3b82f6;">{{ $rapport['statistiques_souscriptions']['nb_souscriptions_total'] ?? 0 }}</div>
                </div>
                <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">ACTIVES</div>
                    <div style="font-size: 12px; font-weight: bold; color: #059669;">{{ $rapport['statistiques_souscriptions']['nb_souscriptions_actives'] ?? 0 }}</div>
                </div>
                <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">COMPLÈTES</div>
                    <div style="font-size: 12px; font-weight: bold; color: #7c3aed;">{{ $rapport['statistiques_souscriptions']['nb_souscriptions_completes'] ?? 0 }}</div>
                </div>
                <div style="float: left; width: 21%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #f59e0b;">{{ $rapport['statistiques_souscriptions']['nb_souscriptions_partielles'] ?? 0 }}</div>
                </div>
                <div style="clear: both;"></div>
            </div>
            ...
            <div style="width: 100%; margin-bottom: 15px;">
                <div style="float: left; width: 23%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #dc2626;">{{ $rapport['statistiques_souscriptions']['nb_souscriptions_en_retard'] }}</div>
                </div>
                <div style="clear: both;"></div>
            </div>
            @endif
            ...
            <div style="width: 100%;">
                <div style="float: left; width: 48%; margin-right: 2%;">
                    <div style="display: flex; justify-content: space-between; padding: 4px 0; border-bottom: 1px solid #e5e7eb;">
                        ...
                        <span style="color: #6b7280; font-size: 8px;">{{ number_format($rapport['statistiques_souscriptions']['montant_total_souscrit'] ?? 0, 0) }}</span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 4px 0;">
                        <span style="font-weight: bold; color: #374151; font-size: 8px;">Montant payé:</span>
                        <span style="color: #6b7280; font-size: 8px;">{{ number_format($rapport['statistiques_souscriptions']['montant_total_paye'] ?? 0, 0) }}</span>
                    </div>
                </div>
                <div style="float: right; width: 48%;">
                    <div style="display: flex; justify-content: space-between; padding: 4px 0; border-bottom: 1px solid #e5e7eb;">
                        <span style="font-weight: bold; color: #374151; font-size: 8px;">Progression moy.:</span>
                        <span style="color: #6b7280; font-size: 8px;">{{ number_format($rapport['statistiques_souscriptions']['progression_moyenne_souscriptions'] ?? 0, 1) }}%</span>
                    </div>
                    <div style="display: flex; justify-content: space-between; padding: 4px 0;">
                        <span style="font-weight: bold; color: #374151; font-size: 8px;">Taux réussite:</span>
                        <span style="color: #6b7280; font-size: 8px;">{{ number_format($rapport['analyses']['taux_reussite'] ?? 0, 1) }}%</span>
                    </div>
                </div>
                <div style="clear: both;"></div>
            </div>
        ...
        <div style="margin-bottom: 25px;">
            ...
            <div style="width: 100%; margin-bottom: 15px;">
                <div style="float: left; width: 23%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    ...
                    <div style="font-size: 12px; font-weight: bold; color: #059669;">{{ number_format($rapport['analyses']['taux_reussite'] ?? 0, 1) }}%</div>
                </div>
                <div style="float: left; width: 23%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                    <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">DURÉE MOY.</div>
                    <div style="font-size: 12px; font-weight: bold; color: #3b82f6;">{{ number_format($rapport['analyses']['duree_moyenne_paiement'] ?? 0, 0) }}j</div>
                </div>
                <div style="clear: both;"></div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach($rapport['analyses']['repartition_types_paiement'] as $type => $data)
                                <tr style="background-color: {{ $loop->even ? '#f9fafb' : 'white' }};">
                                    <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                        <strong>{{ $data['libelle'] ?? ucfirst($type) }}</strong>
                                    </td>
                                    <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                        {{ $data['count'] ?? 0 }}
                                    </td>
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 8px; background-color: white;">
                    ...
                    <tbody>
                        @foreach($rapport['souscriptions_detail'] as $souscription)
                            <tr style="background-color: {{ $loop->even ? '#f9fafb' : 'white' }};">
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                    <strong>{{ htmlspecialchars($souscription['souscripteur'] ?? 'N/A') }}</strong>
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    {{ number_format($souscription['montant_souscrit'] ?? 0, 0) }}
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    {{ number_format($souscription['montant_paye'] ?? 0, 0) }}
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    {{ number_format($souscription['reste_a_payer'] ?? 0, 0) }}
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <span style="background-color: #fef3c7; padding: 1px 3px; border-radius: 2px;">
                                        {{ number_format($souscription['progression'] ?? 0, 1) }}%
                                    </span>
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    @php
                                    ...
                                    @endphp
                                    <span style="padding: 3px 8px; border-radius: 12px; font-size: 8px; font-weight: bold; text-transform: uppercase; {{ $badgeStyles }}">
                                        {{ ucfirst(str_replace('_', ' ', $statut)) }}
                                    </span>
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    {{ $souscription['date_souscription'] ?? 'N/A' }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 8px; background-color: white;">
                    ...
                    <tbody>
                        @foreach(array_slice($rapport['paiements_detail'], 0, 15) as $paiement)
                            <tr style="background-color: {{ $loop->even ? '#f9fafb' : 'white' }};">
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                    <strong>{{ htmlspecialchars($paiement['souscripteur'] ?? 'N/A') }}</strong>
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    {{ number_format($paiement['montant'] ?? 0, 0) }}
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    {{ htmlspecialchars($paiement['type_paiement'] ?? 'N/A') }}
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    @php
                                ...
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
                                    {{ htmlspecialchars($paiement['validateur'] ?? '-') }}
                                </td>
                                <td style="padding: 5px 4px; border: 1px solid #d1d5db; color: #1f2937; white-space: nowrap;">
