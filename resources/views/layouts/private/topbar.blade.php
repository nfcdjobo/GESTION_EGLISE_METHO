    ...
    <div class="flex items-center justify-between h-16 px-6">
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="font-bold text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hidden sm:block">{{ $AppParametres->nom_eglise ?? 'Méthodiste' }}</span>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            @if(Auth::user()->hasAnyRole(['super-admin', 'pasteur', 'president']))
