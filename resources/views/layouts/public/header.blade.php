<!-- Header -->
    <header>
        <div class="nav-container">
            <a href="{{ route('public.accueil') }}#accueil" class="logo">
                <img src="{{$AppParametres->logo ? Storage::url($AppParametres->logo) :  ''}}"
                    alt="Logo {{ $AppParametres->nom_eglise ?? '' }}">
                <div class="logo-text-v3">{{ $AppParametres->nom_eglise ?? 'Méthodiste' }}</div>
            </a>

            <!-- Menu Desktop -->
            <nav class="desktop-nav">
                <ul>
                    <li><a href="{{ url()->current() === route('public.accueil') ? '#accueil' : route('public.accueil') . '#accueil' }}" class="nav-link" data-section="accueil">Accueil</a></li>
                    <li><a href="{{ url()->current() === route('public.accueil') ? '#programmes' : route('public.accueil') . '#programmes' }}" class="nav-link" data-section="programmes">Programme</a></li>
                    <li><a href="{{ url()->current() === route('public.accueil') ? '#events' : route('public.accueil') . '#events' }}" class="nav-link" data-section="events">Événements</a></li>
                    {{-- <li><a href="{{route('public.donates.index')}}" class="nav-link external">Faire un don</a></li> --}}
                    <li><a href="{{route('public.donates.index')}}" class="nav-link external {{ request()->routeIs('public.donates.*') ? 'active' : '' }}">Faire un don</a></li>
                    <li><a href="{{ url()->current() === route('public.accueil') ? '#contact' : route('public.accueil') . '#contact' }}" class="nav-link" data-section="contact">Contact</a></li>
                    @auth
                        <li>
                            <a href="{{ route('private.dashboard') }}" class="nav-link external">Dashboard</a>
                        </li>
                    @else
                        <li><a href="{{ route('security.login') }}" class="nav-link external">Connexion</a></li>
                    @endauth
                </ul>
            </nav>
        ...
        <div class="mobile-menu" id="mobileMenu">
            <ul>
                <li><a href="{{ url()->current() === route('public.accueil') ? '#accueil' : route('public.accueil') . '#accueil' }}" class="mobile-link nav-link" data-section="accueil">Accueil</a></li>
                <li><a href="{{ url()->current() === route('public.accueil') ? '#programmes' : route('public.accueil') . '#programmes' }}" class="mobile-link nav-link" data-section="programmes">Programme</a></li>
                <li><a href="{{ url()->current() === route('public.accueil') ? '#events' : route('public.accueil') . '#events' }}" class="mobile-link nav-link" data-section="events">Événements</a></li>
                {{-- <li><a href="{{route('public.donates.index')}}" class="mobile-link nav-link external" class="mobile-link nav-link" data-page="donates">Faire un don</a></li> --}}
                <li><a href="{{route('public.donates.index')}}" class="nav-link external {{ request()->routeIs('public.donates.*') ? 'active' : '' }}">Faire un don</a></li>
                <li><a href="{{ url()->current() === route('public.accueil') ? '#contact' : route('public.accueil') . '#contact' }}" class="mobile-link nav-link" data-section="contact">Contact</a></li>
                @auth
