...
public function index(Request $request)
{
    ...
    return view('components.private.payments.index',
...
public function show(Request $request, string $id)
{
    ...
    return view('components.private.payments.show', compact('payment'));
}
...
public function edit(Request $request, string $id)
{
    ...
    return view('components.private.payments.edit',
...
{
    $request->validate([
        'montant' => ['required', 'numeric', 'min:1', 'max:999999.99'],
    ...
    try {
        $payment = $this->paymentService->modifierPaiement($id, $request->validated());
        ...
        return redirect()->route('private.payments.show', $payment)
...
public function typesPaiement(Request $request)
{
    ...
    {
        try {
            $payment = $this->paymentService->ajouterPaiement(
            ...
            return view('components.private.paiement.show', compact('payment'));
    ...
    public function valider(string $id): JsonResponse
    {
        ...
        try {
            $this->paymentService->validerPaiement($id, request('commentaire'));
