...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', isset($AppParametres) ? $AppParametres->nom_eglise : "Église Méthodiste Unie - Côte d'Ivoire"); ?></title>
    <!-- Font Awesome Icons -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="icon"
        href="<?php echo e($AppParametres->logo ? Storage::url($AppParametres->logo) :  ''); ?>"
        type="image/png" />
    <style>
        * {
            margin: 0;
