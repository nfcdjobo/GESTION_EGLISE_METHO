<?php $__env->startSection('title', 'Créer une Réunion'); ?>
...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('private.reunions.store')); ?>" method="POST" enctype="multipart/form-data" id="reunionForm" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="titre" name="titre" value="<?php echo e(old('titre')); ?>" required maxlength="200" placeholder="Ex: Réunion du conseil d'administration"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $typesReunions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($type->id); ?>" <?php echo e(old('type_reunion_id') == $type->id ? 'selected' : ''); ?>>
                                            <?php echo e($type->nom); ?>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="description" name="description" rows="4" placeholder="Description de la réunion"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('description')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="objectif" name="objectifs" rows="4" placeholder="Objectifs de la réunion"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('objectifs')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="planifiee" <?php echo e(old('statut', 'planifiee') == 'planifiee' ? 'selected' : ''); ?>>Planifiée</option>
                                    <option value="confirmee" <?php echo e(old('statut') == 'confirmee' ? 'selected' : ''); ?>>Confirmée</option>
                                    <option value="planifie" <?php echo e(old('statut') == 'planifie' ? 'selected' : ''); ?>>En préparation</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="faible" <?php echo e(old('niveau_priorite') == 'faible' ? 'selected' : ''); ?>>Faible</option>
                                    <option value="normale" <?php echo e(old('niveau_priorite', 'normale') == 'normale' ? 'selected' : ''); ?>>Normale</option>
                                    <option value="haute" <?php echo e(old('niveau_priorite') == 'haute' ? 'selected' : ''); ?>>Haute</option>
                                    <option value="urgente" <?php echo e(old('niveau_priorite') == 'urgente' ? 'selected' : ''); ?>>Urgente</option>
                                    <option value="critique" <?php echo e(old('niveau_priorite') == 'critique' ? 'selected' : ''); ?>>Critique</option>
                                </select>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="date" id="date_reunion" name="date_reunion" value="<?php echo e(old('date_reunion')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="time" id="heure_debut_prevue" name="heure_debut_prevue" value="<?php echo e(old('heure_debut_prevue')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="time" id="heure_fin_prevue" name="heure_fin_prevue" value="<?php echo e(old('heure_fin_prevue')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="lieu" name="lieu" value="<?php echo e(old('lieu', 'Salle de réunion')); ?>" required maxlength="200"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="salle" name="salle" value="<?php echo e(old('salle')); ?>" maxlength="100" placeholder="Ex: Salle de conférence A"
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="adresse_complete" name="adresse_complete" rows="2" placeholder="Adresse complète du lieu si différent du siège"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('adresse_complete')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="capacite_salle" name="capacite_salle" value="<?php echo e(old('capacite_salle')); ?>" min="1"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="nombre_places_disponibles" name="nombre_places_disponibles" value="<?php echo e(old('nombre_places_disponibles')); ?>" min="1"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('organisateur_principal_id') == $user->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('animateur_id') == $user->id ? 'selected' : ''); ?>>
                                            <?php echo e($user->nom); ?> <?php echo e($user->prenom); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('responsable_technique_id') == $user->id ? 'selected' : ''); ?>>
                                            <?php echo e($user->nom); ?> <?php echo e($user->prenom); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('responsable_accueil_id') == $user->id ? 'selected' : ''); ?>>
                                            <?php echo e($user->nom); ?> <?php echo e($user->prenom); ?>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="message_principal" name="message_principal" rows="4" placeholder="Message ou enseignement principal de la réunion"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('message_principal')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="passage_biblique" name="passage_biblique" value="<?php echo e(old('passage_biblique')); ?>" maxlength="500" placeholder="Ex: Jean 3:16-17"
...
unset($__errorArgs, $__bag); ?>">
                                    <textarea id="materiel_fourni" name="materiel_fourni" rows="3" placeholder="Matériel qui sera fourni aux participants"
                                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('materiel_fourni')); ?></textarea>
                                </div>
...
unset($__errorArgs, $__bag); ?>">
                                    <textarea id="materiel_apporter" name="materiel_apporter" rows="3" placeholder="Matériel que les participants doivent apporter"
                                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('materiel_apporter')); ?></textarea>
                                </div>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="enregistrement_autorise" name="enregistrement_autorise" value="1" <?php echo e(old('enregistrement_autorise') ? 'checked' : ''); ?>
                                ...
                                <div id="liens_section" class="space-y-4 hidden">
                                    <div>
                                        ...
                                        <input type="url" id="lien_diffusion" name="lien_diffusion" value="<?php echo e(old('lien_diffusion')); ?>" placeholder="https://..."
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" id="limite_inscription" name="limite_inscription" value="<?php echo e(old('limite_inscription')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="liste_attente_activee" name="liste_attente_activee" value="1" <?php echo e(old('liste_attente_activee') ? 'checked' : ''); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="frais_inscription" name="frais_inscription" value="<?php echo e(old('frais_inscription')); ?>" step="0.01" min="0"
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('private.reunions.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/reunions/create.blade.php ENDPATH**/ ?>