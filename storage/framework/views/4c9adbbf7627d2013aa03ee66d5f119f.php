                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-users text-slate-500">Mise à jour des informations de <?php echo e($user->nom_complet); ?> - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
