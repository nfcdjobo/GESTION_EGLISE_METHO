<?php $__env->startSection('title', 'Statistiques des Cultes'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('private.cultes.statistiques')); ?>"
                    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">Date début</label>
                        <input type="date" name="date_debut"
                            value="<?php echo e(request('date_debut', $statistiques['periode']['debut'])); ?>"
                    ...
                    <div>
                        ...
                        <input type="date" name="date_fin"
                            value="<?php echo e(request('date_fin', $statistiques['periode']['fin'])); ?>"
                            class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    <div>
                        ...
                        <select name="type_culte"
                            ...
                            <?php $__currentLoopData = \App\Models\Culte::TYPE_CULTE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(request('type_culte') == $key ? 'selected' : ''); ?>>
                        ...
                        <select name="programme_id"
                            ...
                            <?php $__currentLoopData = $programmes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($programme->id); ?>"
                                    <?php echo e(request('programme_id') == $programme->id ? 'selected' : ''); ?>><?php echo e($programme->nom); ?>
                ...
                <div class="text-center">
                    <p class="text-lg text-slate-700">
                        Statistiques du <span
                            class="font-bold text-blue-600"><?php echo e(\Carbon\Carbon::parse($statistiques['periode']['debut'])->format('d/m/Y')); ?></span>
                        au <span
                            class="font-bold text-blue-600"><?php echo e(\Carbon\Carbon::parse($statistiques['periode']['fin'])->format('d/m/Y')); ?></span>
                    </p>
                    <p class="text-sm text-slate-500 mt-1">
                        Période de
                        <?php echo e(\Carbon\Carbon::parse($statistiques['periode']['debut'])->diffInDays(\Carbon\Carbon::parse($statistiques['periode']['fin'])) + 1); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques['totaux']['nombre_cultes']); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques['totaux']['cultes_termines']); ?></p>
                        <p class="text-sm text-slate-500">Cultes terminés</p>
                        <?php if($statistiques['totaux']['nombre_cultes'] > 0): ?>
                            <p class="text-xs text-green-600">
                                <?php echo e(round(($statistiques['totaux']['cultes_termines'] / $statistiques['totaux']['nombre_cultes']) * 100, 1)); ?>%
                                de réalisation</p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e(number_format($statistiques['totaux']['total_participants'])); ?></p>
                        <p class="text-sm text-slate-500">Total participants</p>
                        <?php if($statistiques['moyennes']['participants_par_culte']): ?>
                            <p class="text-xs text-purple-600">
                                <?php echo e(round($statistiques['moyennes']['participants_par_culte'], 1)); ?> par culte</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e(number_format($statistiques['totaux']['total_offrandes'], 0)); ?>FCFA</p>
                        <p class="text-sm text-slate-500">Total offrandes</p>
                        <?php if($statistiques['moyennes']['offrandes_par_culte']): ?>
                            <p class="text-xs text-orange-600">
                                <?php echo e(number_format($statistiques['moyennes']['offrandes_par_culte'], 0)); ?>FCFA par culte</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques['totaux']['total_conversions']); ?>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques['totaux']['total_baptemes']); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques['totaux']['cultes_annules']); ?></p>
                        <p class="text-sm text-slate-500">Cultes annulés</p>
                        <?php if($statistiques['totaux']['nombre_cultes'] > 0): ?>
                            <p class="text-xs text-red-600">
                                <?php echo e(round(($statistiques['totaux']['cultes_annules'] / $statistiques['totaux']['nombre_cultes']) * 100, 1)); ?>%
                                d'annulation</p>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($statistiques['moyennes']['note_globale'] ? round($statistiques['moyennes']['note_globale'], 1) : '-'); ?>

                        </p>
                        <p class="text-sm text-slate-500">Note moyenne</p>
                        <?php if($statistiques['moyennes']['note_globale']): ?>
                            <div class="flex mt-1">
                                <?php for($i = 1; $i <= 10; $i++): ?>
                                    <i
                                        class="fas fa-star text-xs <?php echo e($i <= round($statistiques['moyennes']['note_globale']) ? 'text-amber-400' : 'text-slate-300'); ?>"></i>
                                <?php endfor; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center justify-between mb-2">
                                            ...
                                            <span class="text-sm text-slate-600"><?php echo e($type->nombre); ?> cultes
                                        ...
                                        <div class="flex items-center justify-between mt-2 text-sm text-slate-600">
                                            <span><?php echo e(number_format($type->total_participants ?: 0)); ?> participants</span>
                                            <span>Moy: <?php echo e(round($type->moyenne_participants ?: 0, 1)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $statistiques['par_mois']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mois): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="font-semibold text-slate-900"><?php echo e(ucfirst($moisNom)); ?></span>
                                        <span class="text-sm text-slate-600"><?php echo e($mois->nombre_cultes); ?> cultes</span>
                                    </div>
                                    <div class="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            <span class="text-slate-600">Participants:</span>
                                            <span
                                                class="font-semibold text-green-700"><?php echo e(number_format($mois->total_participants ?: 0)); ?></span>
                                        </div>
                                        <div>
                                            <span class="text-slate-600">Offrandes:</span>
                                            <span
                                                class="font-semibold text-emerald-700"><?php echo e(number_format($mois->total_offrandes ?: 0)); ?>FCFA</span>
                                        </div>
                                    </div>
                                    <div class="w-full bg-gray-200 rounded-full h-2 mt-3">
                                        <div class="bg-gradient-to-r from-green-500 to-emerald-500 h-2 rounded-full transition-all duration-300"
                                            style="width: <?php echo e($participantsPercentage); ?>%"></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="text-center p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl">
                        <div class="text-3xl font-bold text-blue-600 mb-2">
                            <?php echo e(round($statistiques['moyennes']['participants_par_culte'] ?: 0, 1)); ?></div>
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                        <div class="text-3xl font-bold text-green-600 mb-2">
                            <?php echo e(number_format($statistiques['moyennes']['offrandes_par_culte'] ?: 0, 0)); ?>FCFA</div>
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                        <div class="text-3xl font-bold text-purple-600 mb-2">
                            <?php echo e(round($statistiques['moyennes']['note_louange'] ?: 0, 1)); ?>/10</div>
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl">
                        <div class="text-3xl font-bold text-amber-600 mb-2">
                            <?php echo e(round($statistiques['moyennes']['note_message'] ?: 0, 1)); ?>/10</div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cultes.planning')): ?>
                        <a href="<?php echo e(route('private.cultes.planning')); ?>"
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cultes.dashboard')): ?>
                        <a href="<?php echo e(route('private.cultes.dashboard')); ?>"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cultes.create')): ?>
                        <a href="<?php echo e(route('private.cultes.create')); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function exportStats() {
                ...
                window.location.href = "<?php echo e(route('private.cultes.statistiques')); ?>?" + params.toString();
            }
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/cultes/statistiques.blade.php ENDPATH**/ ?>