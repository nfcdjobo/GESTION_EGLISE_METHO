        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e(number_format($statistiques['totaux']['total_offrandes'], 0)); ?>€</p>
                        <p class="text-sm text-slate-500">Total offrandes</p>
                        <?php if($statistiques['moyennes']['offrandes_par_culte']): ?>
                            <p class="text-xs text-orange-600">
                                <?php echo e(number_format($statistiques['moyennes']['offrandes_par_culte'], 0)); ?>€ par culte</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                                ...
                                <div class="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <span
                                                class="font-semibold text-emerald-700"><?php echo e(number_format($mois->total_offrandes ?: 0)); ?>€</span>
                                        </div>
                                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                        <div class="text-3xl font-bold text-green-600 mb-2">
                            <?php echo e(number_format($statistiques['moyennes']['offrandes_par_culte'] ?: 0, 0)); ?>€</div>
