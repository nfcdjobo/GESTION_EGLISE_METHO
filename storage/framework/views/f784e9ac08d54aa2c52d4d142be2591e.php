<?php $__env->startSection('title', 'Annonces Publiques'); ?>
...
<div class="space-y-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-1">Toutes les annonces actuellement visibles par le public - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('private.annonces.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-slate-600 to-slate-700 text-white text-sm font-medium rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select name="type_annonce" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="evenement" <?php echo e(request('type_annonce') == 'evenement' ? 'selected' : ''); ?>>Événement</option>
                        <option value="administrative" <?php echo e(request('type_annonce') == 'administrative' ? 'selected' : ''); ?>>Administrative</option>
                        <option value="pastorale" <?php echo e(request('type_annonce') == 'pastorale' ? 'selected' : ''); ?>>Pastorale</option>
                        <option value="urgence" <?php echo e(request('type_annonce') == 'urgence' ? 'selected' : ''); ?>>Urgence</option>
                        <option value="information" <?php echo e(request('type_annonce') == 'information' ? 'selected' : ''); ?>>Information</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="audience_cible" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="tous" <?php echo e(request('audience_cible') == 'tous' ? 'selected' : ''); ?>>Tous</option>
                        <option value="membres" <?php echo e(request('audience_cible') == 'membres' ? 'selected' : ''); ?>>Membres</option>
                        <option value="leadership" <?php echo e(request('audience_cible') == 'leadership' ? 'selected' : ''); ?>>Leadership</option>
                        <option value="jeunes" <?php echo e(request('audience_cible') == 'jeunes' ? 'selected' : ''); ?>>Jeunes</option>
                    </select>
                </div>
                <div class="md:col-span-2 flex gap-2 items-end">
                    ...
                    <a href="<?php echo e(route('private.annonces.annoncesActives')); ?>" class="inline-flex items-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-colors">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6">
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($annonces->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($annonces->where('type_annonce', 'evenement')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($annonces->where('afficher_site_web', true)->count()); ?></p>
    ...
    <?php if($annonces->count() > 0): ?>
        <!-- Annonces urgentes -->
        <?php $annoncesUrgentes = $annonces->where('niveau_priorite', 'urgent'); ?>
        <?php if($annoncesUrgentes->count() > 0): ?>
            <div class="bg-red-50/80 rounded-2xl shadow-lg border border-red-200/50 hover:shadow-xl transition-all duration-300">
                <div class="p-6 border-b border-red-200">
                    <h2 class="text-xl font-bold text-red-800 flex items-center">
                        ...
                        Annonces Urgentes (<?php echo e($annoncesUrgentes->count()); ?>)
                    </h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <?php $__currentLoopData = $annoncesUrgentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('components.private.annonces.partials.card-publique', ['annonce' => $annonce, 'urgent' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php $annoncesImportantes = $annonces->where('niveau_priorite', 'important'); ?>
        <?php if($annoncesImportantes->count() > 0): ?>
            <div class="bg-yellow-50/80 rounded-2xl shadow-lg border border-yellow-200/50 hover:shadow-xl transition-all duration-300">
                <div class="p-6 border-b border-yellow-200">
                    <h2 class="text-xl font-bold text-yellow-800 flex items-center">
                        ...
                        Annonces Importantes (<?php echo e($annoncesImportantes->count()); ?>)
                    </h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $annoncesImportantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('components.private.annonces.partials.card-publique', ['annonce' => $annonce], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            </div>
        ...
        <!-- Autres annonces -->
        <?php $autresAnnonces = $annonces->where('niveau_priorite', 'normal'); ?>
        <?php if($autresAnnonces->count() > 0): ?>
            <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                <div class="p-6 border-b border-slate-200">
                    <h2 class="text-xl font-bold text-slate-800 flex items-center">
                        <i class="fas fa-list text-slate-600 mr-2"></i>
                        Autres Annonces (<?php echo e($autresAnnonces->count()); ?>)
                    </h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $autresAnnonces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php echo $__env->make('components.private.annonces.partials.card-publique', ['annonce' => $annonce], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
    ...
    <?php else: ?>
        <div class="text-center py-12">
            ...
            <p class="text-slate-500 mb-6">
                <?php if(request()->hasAny(['type_annonce', 'audience_cible'])): ?>
...
<?php if($annonces->where('niveau_priorite', 'urgent')->count() > 0): ?>
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/annonces/publiques.blade.php ENDPATH**/ ?>