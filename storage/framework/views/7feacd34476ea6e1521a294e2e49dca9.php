...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="dime" <?php echo e(old('type_transaction') == 'dime' ? 'selected' : ''); ?>>Dîme
                                        </option>
                                        ...
                                        <option value="offrande_construction" <?php echo e(old('type_transaction') == 'offrande_construction' ? 'selected' : ''); ?>>Offrande
                                            construction</option>
                                        ...
                                        <option value="autres" <?php echo e(old('type_transaction') == 'autres' ? 'selected' : ''); ?>>
                                            Autres</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="urgente" <?php echo e(old('categorie') == 'urgente' ? 'selected' : ''); ?>>Urgente
                                        </option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="date" id="date_transaction" name="date_transaction"
                                        value="<?php echo e(old('date_transaction', now()->format('Y-m-d'))); ?>" required
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="time" id="heure_transaction" name="heure_transaction"
                                        value="<?php echo e(old('heure_transaction')); ?>"
...
unset($__errorArgs, $__bag); ?>">
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                                            <select name="devise"
                                                ...
                                                <option value="XOF" <?php echo e(old('devise', 'XOF') == 'XOF' ? 'selected' : ''); ?>>XOF
                                                </option>
                                                <option value="EUR" <?php echo e(old('devise') == 'EUR' ? 'selected' : ''); ?>>EUR
                                                </option>
                                                <option value="USD" <?php echo e(old('devise') == 'USD' ? 'selected' : ''); ?>>USD
                                                </option>
                                            </select>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="virement" <?php echo e(old('mode_paiement') == 'virement' ? 'selected' : ''); ?>>
                                            Virement bancaire</option>
                                        <option value="cheque" <?php echo e(old('mode_paiement') == 'cheque' ? 'selected' : ''); ?>>Chèque
                                        </option>
                                        <option value="nature" <?php echo e(old('mode_paiement') == 'nature' ? 'selected' : ''); ?>>Don en
                                            nature</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <input type="hidden" id="collecteur_id" name="collecteur_id"
                                            value="<?php echo e(old('collecteur_id')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                            autocomplete="off" value="<?php echo e(old('donateur_search')); ?>">
                                        <input type="hidden" id="donateur_id" name="donateur_id"
                                            value="<?php echo e(old('donateur_id')); ?>">
                                ...
                                <div id="donateur_externe_section" class="grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                                    <div>
                                        ...
                                        <input type="text" id="nom_donateur_anonyme" name="nom_donateur_anonyme"
                                            value="<?php echo e(old('nom_donateur_anonyme')); ?>" placeholder="Nom et prénom"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="contact_donateur" name="contact_donateur"
                                            value="<?php echo e(old('contact_donateur')); ?>" placeholder="Téléphone ou email"
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                ...
                                <textarea id="description_don_nature" name="description_don_nature" rows="3"
                                    ...
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none <?php $__errorArgs = ['description_don_nature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description_don_nature')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="valeur_estimee" name="valeur_estimee"
                                    value="<?php echo e(old('valeur_estimee')); ?>" min="0" step="0.01" placeholder="Valeur en XOF"
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="destination" name="destination" value="<?php echo e(old('destination')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea id="instructions_donateur" name="instructions_donateur" rows="3"
                                    ...
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none <?php $__errorArgs = ['instructions_donateur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('instructions_donateur')); ?></textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="occasion_speciale" name="occasion_speciale"
                                        value="<?php echo e(old('occasion_speciale')); ?>" placeholder="Noël, Pâques, anniversaire..."
                                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="lieu_collecte" name="lieu_collecte"
                                        value="<?php echo e(old('lieu_collecte', 'Église principale')); ?>"
            ...
            class AutoComplete {
                ...
                async search(query) {
                    ...
                    try {
                        ...
                        const response = await fetch(`<?php echo e(route('private.users.search')); ?>?q=${encodeURIComponent(query)}`, {
