<?php $__env->startSection('title', 'Créer une Classe'); ?>
...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('private.classes.store')); ?>" method="POST" enctype="multipart/form-data" id="classeForm" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nom" name="nom" value="<?php echo e(old('nom')); ?>" required maxlength="255" placeholder="Ex: École du Dimanche - Enfants"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $tranches_age; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tranche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tranche); ?>" <?php echo e(old('tranche_age') == $tranche ? 'selected' : ''); ?>><?php echo e($tranche); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="age_minimum" name="age_minimum" value="<?php echo e(old('age_minimum')); ?>" min="0" max="120"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="age_maximum" name="age_maximum" value="<?php echo e(old('age_maximum')); ?>" min="0" max="120"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $utilisateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $utilisateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($utilisateur->id); ?>" <?php echo e(old('responsable_id') == $utilisateur->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $utilisateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $utilisateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($utilisateur->id); ?>" <?php echo e(old('enseignant_principal_id') == $utilisateur->id ? 'selected' : ''); ?>>
                                            <?php echo e($utilisateur->nom_complet); ?> (<?php echo e($utilisateur->email); ?>)
                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('private.classes.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
