<?php $__env->startSection('title', 'Alertes d\'Assiduité'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-500 mt-1">
                Membres nécessitant un suivi pastoral - <?php echo e($dateAnalyse->locale('fr')->format('l d F Y')); ?>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('private.alertes.assiduite-faible')); ?>"
                    ...
                    <div>
                        ...
                        <select name="type_alerte"
                            ...
                            <option value="both" <?php echo e($typeAlerte === 'both' ? 'selected' : ''); ?>>Toutes les alertes</option>
                            <option value="dimanches_successifs" <?php echo e($typeAlerte === 'dimanches_successifs' ? 'selected' : ''); ?>>Dimanches successifs</option>
                            <option value="cultes_mensuels" <?php echo e($typeAlerte === 'cultes_mensuels' ? 'selected' : ''); ?>>Cultes mensuels</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="severite"
                            ...
                            <option value="critique" <?php echo e(request('severite') === 'critique' ? 'selected' : ''); ?>>Critique</option>
                            <option value="attention" <?php echo e(request('severite') === 'attention' ? 'selected' : ''); ?>>Attention</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="periode_mois"
                            class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            <option value="1" <?php echo e($periodeMois == 1 ? 'selected' : ''); ?>>1 mois</option>
                            <option value="2" <?php echo e($periodeMois == 2 ? 'selected' : ''); ?>>2 mois</option>
                            <option value="3" <?php echo e($periodeMois == 3 ? 'selected' : ''); ?>>3 mois</option>
                            <option value="6" <?php echo e($periodeMois == 6 ? 'selected' : ''); ?>>6 mois</option>
                        </select>
                    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques['total_membres'] ?? 0); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(count($membres)); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(count($statistiques['dimanches_successifs'] ?? [])); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(count($statistiques['cultes_mensuels'] ?? [])); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(count($statistiques['critique'] ?? [])); ?></p>
            ...
            <div class="p-6 border-b border-slate-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <h2 class="text-xl font-bold text-slate-800 flex items-center">
                        ...
                        Membres nécessitant un suivi (<?php echo e(count($membres)); ?>)
                    </h2>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800">
                                <?php echo e(count($membres)); ?> membres en alerte
                            </span>
                            <span class="text-sm text-slate-600">
                                <?php echo e($dateAnalyse->format('d/m/Y')); ?>
                    ...
                    <div id="listView" class="space-y-4">
                        <?php $__currentLoopData = $membres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gradient-to-r from-white to-slate-50 rounded-xl border border-slate-200 p-4 hover:shadow-lg transition-all duration-300
                                <?php if($membre['severite'] === 'critique'): ?> border-l-4 border-l-red-500
                                <?php elseif($membre['severite'] === 'attention'): ?> border-l-4 border-l-orange-500
                                <?php else: ?> border-l-4 border-l-yellow-500 <?php endif; ?>"
                                data-membre-id="<?php echo e($membre['membre']['id']); ?>">
                                ...
                                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                    ...
                                    <div class="flex-1 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                        ...
                                        <div class="space-y-1">
                                            <div class="font-bold text-slate-900">
                                                <?php echo e($membre['membre']['nom_complet']); ?>

                                            </div>
                                            <?php if($membre['membre']['email']): ?>
                                                <div class="text-sm text-slate-600 flex items-center">
                                                    <i class="fas fa-envelope w-4 mr-1 text-blue-500"></i>
                                                    <?php echo e($membre['membre']['email']); ?>

                                                </div>
                                            <?php endif; ?>
                                            <?php if($membre['membre']['telephone']): ?>
                                                <div class="text-sm text-slate-600 flex items-center">
                                                    <i class="fas fa-phone w-4 mr-1 text-green-500"></i>
                                                    <?php echo e($membre['membre']['telephone']); ?>
                                        ...
                                        <div class="space-y-2">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                <?php if($membre['severite'] === 'critique'): ?> bg-red-100 text-red-800
                                                <?php elseif($membre['severite'] === 'attention'): ?> bg-orange-100 text-orange-800
                                                <?php else: ?> bg-yellow-100 text-yellow-800 <?php endif; ?>">
                                                <?php if($membre['severite'] === 'critique'): ?>
                                                    <i class="fas fa-exclamation-circle mr-1"></i> Critique
                                                <?php elseif($membre['severite'] === 'attention'): ?>
                                            ...
                                            <div class="text-sm">
                                                <span class="font-medium
                                                    <?php if($membre['score_assiduite'] >= 70): ?> text-green-600
                                                    <?php elseif($membre['score_assiduite'] >= 40): ?> text-yellow-600
                                                    <?php else: ?> text-red-600 <?php endif; ?>">
                                                    Assiduité : <?php echo e($membre['score_assiduite']); ?>%
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Alertes -->
                                        <div class="space-y-1">
                                            <?php $__currentLoopData = $membre['alertes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="text-xs">
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded-md font-medium
                                                        <?php if($alerte['severite'] === 'critique'): ?> bg-red-50 text-red-800 border border-red-200
                                                        <?php else: ?> bg-orange-50 text-orange-800 border border-orange-200 <?php endif; ?>">
                                                        <i class="fas
                                                            <?php if($alerte['type'] === 'dimanches_successifs'): ?> fa-calendar-times
                                                            <?php else: ?> fa-chart-line <?php endif; ?> mr-1"></i>
                                                        <?php echo e(ucfirst(str_replace('_', ' ', $alerte['type']))); ?>

                                                    </span>
                                                    <p class="text-slate-600 mt-1"><?php echo e($alerte['description']); ?></p>
                                                </div>
                                        ...
                                        <!-- Dernier culte -->
                                        <div class="space-y-1">
                                            <?php if($membre['dernier_culte']): ?>
                                                <div class="text-sm text-slate-600">
                                                    <i class="fas fa-calendar-alt w-4 mr-1"></i>
                                                    <?php echo e(\Carbon\Carbon::parse($membre['dernier_culte']['date'])->format('d/m/Y')); ?>

                                                </div>
                                                <div class="text-xs text-slate-500">
                                                    Il y a <?php echo e($membre['dernier_culte']['jours_depuis']); ?> jours
                                                </div>
                                            <?php else: ?>
                                    ...
                                    <div class="flex flex-wrap lg:flex-col gap-2 lg:w-48">
                                        <button onclick="contactMembre('<?php echo e($membre['membre']['id']); ?>')"
                                        ...
                                        <button onclick="planifierVisite('<?php echo e($membre['membre']['id']); ?>')"
                                        ...
                                        <button onclick="ajouterNote('<?php echo e($membre['membre']['id']); ?>')"
                                        ...
                                        <button onclick="marquerSuivi('<?php echo e($membre['membre']['id']); ?>')"
                                    ...
                                    <div class="flex flex-col items-end space-y-2">
                                        ...
                                        <div class="text-center">
                                            <div class="text-xl font-bold
                                                ...
                                                <?php elseif($membre['score_assiduite'] >= 40): ?> text-yellow-600
                                                <?php else: ?> text-red-600 <?php endif; ?>">
                                                <?php echo e($membre['score_assiduite']); ?>%
                                            </div>
                                ...
                                <div class="space-y-2 mb-4">
                                    <?php $__currentLoopData = $membre['alertes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="bg-white rounded-lg p-3 border-l-4
                                            <?php if($alerte['severite'] === 'critique'): ?> border-red-400 bg-red-50
                                            <?php else: ?> border-orange-400 bg-orange-50 <?php endif; ?>">
                                            <div class="flex items-center justify-between mb-1">
                                                <div class="flex items-center">
                                                    <i class="fas
                                                        <?php if($alerte['type'] === 'dimanches_successifs'): ?> fa-calendar-times text-red-500
                                                        <?php else: ?> fa-chart-line text-orange-500 <?php endif; ?> mr-2"></i>
                                                ...
                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                                                    <?php if($alerte['severite'] === 'critique'): ?> bg-red-100 text-red-700
                                                    <?php else: ?> bg-orange-100 text-orange-700 <?php endif; ?>">
                                                    <?php echo e(ucfirst($alerte['severite'])); ?>

                                                </span>
                                            </div>
                                            <p class="text-xs text-slate-600"><?php echo e($alerte['description']); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                    ...
                                    <div class="bg-slate-100 rounded-lg p-3 mb-4">
                                        <div class="text-sm">
                                            <div class="flex justify-between items-center">
                                                ...
                                                <span class="text-slate-600"><?php echo e(\Carbon\Carbon::parse($membre['dernier_culte']['date'])->format('d/m/Y')); ?></span>
                                            </div>
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="text-slate-500 mb-6">
                            <?php if($typeAlerte !== 'both' || $periodeMois !== 1): ?>
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/alertes/assiduite-faible.blade.php ENDPATH**/ ?>