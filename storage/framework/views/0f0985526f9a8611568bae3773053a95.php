        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-3">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscriptions.update')): ?>
                    <a href="<?php echo e(route('private.subscriptions.edit', $subscription['id'])); ?>"
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscriptions.report')): ?>
        ...
        <?php if(count($alertes) > 0): ?>
            <div class="space-y-3">
                <?php $__currentLoopData = $alertes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 rounded-xl border <?php if($alerte['type'] === 'danger'): ?> bg-red-50 border-red-200 <?php elseif($alerte['type'] === 'warning'): ?> bg-yellow-50 border-yellow-200 <?php else: ?> bg-blue-50 border-blue-200 <?php endif; ?>">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm <?php if($alerte['type'] === 'danger'): ?> text-red-800 <?php elseif($alerte['type'] === 'warning'): ?> text-yellow-800 <?php else: ?> text-blue-800 <?php endif; ?>">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg font-bold text-slate-900"><?php echo e($subscription['souscripteur']['nom'] ?? 'N/A'); ?></h3>
                                    <?php if($subscription['souscripteur']['email'] ?? false): ?>
                                        <p class="text-sm text-slate-600"><?php echo e($subscription['souscripteur']['email']); ?></p>
                                    <?php endif; ?>
                                    <?php if($subscription['souscripteur']['telephone_1'] ?? false): ?>
                            ...
                            <div class="border-l border-slate-200 pl-6">
                                <h3 class="text-lg font-bold text-slate-900"><?php echo e($subscription['fimeco']['nom'] ?? 'N/A'); ?></h3>
                                <?php if($subscription['fimeco']['description'] ?? false): ?>
                                    <p class="text-sm text-slate-600 mt-1"><?php echo e(Str::limit($subscription['fimeco']['description'], 100)); ?></p>
                                <?php endif; ?>

                                <div class="mt-3 space-y-2">
                                    <div class="flex justify-between text-sm">
                                        <span class="text-slate-600">Progression FIMECO:</span>
                                        <span class="font-medium"><?php echo e(number_format($subscription['fimeco']['progression'] ?? 0, 1)); ?>%</span>
                                    </div>
                                ...
                                <?php if($subscription['fimeco']['responsable'] ?? false): ?>
                                    <p class="text-xs text-slate-500 mt-2">
                                        Responsable: <?php echo e($subscription['fimeco']['responsable']['nom']); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <span class="text-lg font-bold text-slate-900"><?php echo e(number_format($subscription['progression'] ?? 0, 1)); ?>%</span>
                                </div>
                                <div class="w-full bg-slate-200 rounded-full h-4">
                                    <div class="h-4 rounded-full transition-all duration-500 <?php echo e(($subscription['progression'] ?? 0) >= 100 ? 'bg-gradient-to-r from-green-500 to-emerald-500' : (($subscription['progression'] ?? 0) >= 75 ? 'bg-gradient-to-r from-blue-500 to-purple-500' : (($subscription['progression'] ?? 0) >= 50 ? 'bg-gradient-to-r from-yellow-500 to-orange-500' : 'bg-gradient-to-r from-red-500 to-pink-500'))); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="text-center p-4 bg-slate-50 rounded-xl">
                                    <div class="text-2xl font-bold text-slate-900"><?php echo e(number_format($subscription['montant_souscrit'] ?? 0, 0, ',', ' ')); ?></div>
                                    <div class="text-sm text-slate-600">Montant souscrit (FCFA)</div>
                                </div>
                                <div class="text-center p-4 bg-green-50 rounded-xl">
                                    <div class="text-2xl font-bold text-green-600"><?php echo e(number_format($subscription['montant_paye'] ?? 0, 0, ',', ' ')); ?></div>
                                    <div class="text-sm text-slate-600">Montant payé (FCFA)</div>
                                </div>
                                <div class="text-center p-4 bg-orange-50 rounded-xl">
                                    <div class="text-2xl font-bold text-orange-600"><?php echo e(number_format($subscription['reste_a_payer'] ?? 0, 0, ',', ' ')); ?></div>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative flex justify-between">
                                    <div class="flex flex-col items-center">
                                        <div class="w-8 h-8 rounded-full <?php echo e(($subscription['progression'] ?? 0) >= 25 ? 'bg-green-500' : 'bg-slate-300'); ?> flex items-center justify-center">
                                    ...
                                    <div class="flex flex-col items-center">
                                        <div class="w-8 h-8 rounded-full <?php echo e(($subscription['progression'] ?? 0) >= 50 ? 'bg-green-500' : 'bg-slate-300'); ?> flex items-center justify-center">
                                    ...
                                    <div class="flex flex-col items-center">
                                        <div class="w-8 h-8 rounded-full <?php echo e(($subscription['progression'] ?? 0) >= 75 ? 'bg-green-500' : 'bg-slate-300'); ?> flex items-center justify-center">
                                    ...
                                    <div class="flex flex-col items-center">
                                        <div class="w-8 h-8 rounded-full <?php echo e(($subscription['progression'] ?? 0) >= 100 ? 'bg-green-500' : 'bg-slate-300'); ?> flex items-center justify-center">
                ...
                <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/30 hover:shadow-2xl transition-all duration-500">
                        ...
                        <div class="flex items-center justify-between">
                            <h2 class="text-xl font-bold text-slate-800 flex items-center">
                                ...
                                <span class="ml-2 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-slate-100 text-slate-700">
                                    <?php echo e(count($historique_paiements)); ?>

                                </span>
                            </h2>
                            <?php if($peut_effectuer_paiement && ($montant_maximum_payable ?? 0) > 0): ?>
                    ...
                    <div class="p-6">
                        <?php if(count($historique_paiements) > 0): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $historique_paiements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="group relative p-5 bg-gradient-to-r from-slate-50 to-slate-50/80 rounded-xl border border-slate-200/50 hover:from-slate-100 hover:to-slate-100/80 hover:border-slate-300/50 hover:shadow-md transition-all duration-300">
                                        ...
                                        <div class="absolute left-0 top-0 bottom-0 w-1 rounded-l-xl <?php echo e($payment->statut === 'valide' ? 'bg-gradient-to-b from-green-400 to-green-600' : ($payment->statut === 'en_attente' ? 'bg-gradient-to-b from-amber-400 to-orange-500' : 'bg-gradient-to-b from-red-400 to-red-600')); ?>"></div>

                                        <div class="flex items-start justify-between">
                                            <div class="flex items-start space-x-4 flex-1">
                                                <!-- Icône de statut -->
                                                <div class="flex-shrink-0">
                                                    <div class="relative w-12 h-12 rounded-xl <?php echo e($payment->statut === 'valide' ? 'bg-gradient-to-br from-green-100 to-green-200' : ($payment->statut === 'en_attente' ? 'bg-gradient-to-br from-amber-100 to-orange-200' : 'bg-gradient-to-br from-red-100 to-red-200')); ?> flex items-center justify-center shadow-sm">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="flex items-center flex-wrap gap-2 mb-2">
                                                        <span class="text-xl font-bold text-slate-900"><?php echo e(number_format($payment->montant, 0, ',', ' ')); ?> FCFA</span>
                                                        <div class="flex items-center space-x-2 text-sm">
                                                            <span class="inline-flex items-center px-2.5 py-1 rounded-full bg-blue-100 text-blue-800 font-medium">
                                                                <i class="fas fa-<?php echo e($payment->type_paiement === 'especes' ? 'coins' : ($payment->type_paiement === 'cheque' ? 'money-check' : ($payment->type_paiement === 'virement' ? 'university' : ($payment->type_paiement === 'carte' ? 'credit-card' : 'mobile-alt')))); ?> mr-1 text-xs"></i>
                                                                <?php echo e($payment->getTypePaiementLibelle()); ?>
                                                    ...
                                                    <div class="flex items-center space-x-3 text-sm text-slate-600 mb-2">
                                                        <span class="flex items-center">
                                                            ...
                                                            <?php echo e($payment->date_paiement->format('d/m/Y à H:i')); ?>

                                                        </span>
                                                        <?php if($payment->validateur): ?>
                                                            <span class="flex items-center">
                                                                <i class="fas fa-user-check mr-1.5 text-green-500"></i>
                                                                Validé par <?php echo e($payment->validateur->nom); ?>
                                                    ...
                                                    <?php if($payment->commentaire): ?>
                                                        <div class="mt-3 p-3 bg-white/70 rounded-lg border-l-4 border-slate-300">
                                                            <div class="flex items-start space-x-2">
                                                                ...
                                                                <span class="text-sm text-slate-700 italic"><?php echo e($payment->commentaire); ?></span>
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="flex flex-col items-end space-y-3 ml-4">
                                                ...
                                                <?php if($payment->statut === 'en_attente'): ?>
                                                    <div class="flex space-x-2">
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('payments.validate')): ?>
                                                            <button onclick="validerPaiement('<?php echo e($payment->id); ?>')"
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('payments.reject')): ?>
                                                            <button onclick="rejeterPaiement('<?php echo e($payment->id); ?>')"
                            ...
                            <?php if(count($historique_paiements) >= 10): ?>
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mt-1 <?php echo e(($subscription['statut'] ?? '') === 'completement_payee' ? 'bg-green-100 text-green-800' : (($subscription['statut'] ?? '') === 'partiellement_payee' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800')); ?>">
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium mt-1 <?php echo e(($subscription['statut_global'] ?? '') === 'objectif_atteint' ? 'bg-green-100 text-green-800' : (($subscription['statut_global'] ?? '') === 'presque_atteint' ? 'bg-blue-100 text-blue-800' : (($subscription['statut_global'] ?? '') === 'en_cours' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800'))); ?>">
                                <?php echo e($subscription['statut_global_libelle'] ?? 'N/A'); ?>
                        ...
                        <?php if($subscription['date_echeance'] ?? false): ?>
                            <div>
                                ...
                                <div class="text-slate-900 mt-1 <?php echo e($subscription['en_retard'] ?? false ? 'text-red-600' : ''); ?>">
                                    <i class="fas fa-calendar-times <?php echo e($subscription['en_retard'] ?? false ? 'text-red-600' : 'text-orange-600'); ?> mr-2"></i>
                                ...
                                <?php elseif(($subscription['jours_restants'] ?? 0) > 0): ?>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="text-center p-3 bg-blue-50 rounded-lg">
                                <div class="text-lg font-bold text-blue-600"><?php echo e($statistiques_paiements['nb_paiements_total'] ?? 0); ?></div>
                                <div class="text-xs text-slate-600">Total</div>
                            </div>
                            <div class="text-center p-3 bg-green-50 rounded-lg">
                                <div class="text-lg font-bold text-green-600"><?php echo e($statistiques_paiements['nb_paiements_valides'] ?? 0); ?></div>
                                <div class="text-xs text-slate-600">Validés</div>
                            </div>
                            <div class="text-center p-3 bg-yellow-50 rounded-lg">
                                <div class="text-lg font-bold text-yellow-600"><?php echo e($statistiques_paiements['nb_paiements_en_attente'] ?? 0); ?></div>
                                <div class="text-xs text-slate-600">En attente</div>
                            </div>
                            <div class="text-center p-3 bg-red-50 rounded-lg">
                                <div class="text-lg font-bold text-red-600"><?php echo e($statistiques_paiements['nb_paiements_rejetes'] ?? 0); ?></div>
                                <div class="text-xs text-slate-600">Rejetés</div>
                            </div>
                        </div>

                        <?php if(($statistiques_paiements['montant_moyen_paiement'] ?? 0) > 0): ?>
                            <hr class="border-slate-200">
                            <div>
                                <div class="text-sm font-medium text-slate-700">Paiement moyen</div>
                                <div class="text-lg font-bold text-slate-900"><?php echo e(number_format($statistiques_paiements['montant_moyen_paiement'], 0, ',', ' ')); ?> FCFA</div>
                            </div>
                        <?php endif; ?>

                        <?php if($statistiques_paiements['premier_paiement'] ?? false): ?>
                            <div>
                                <div class="text-sm font-medium text-slate-700">Premier paiement</div>
                                <div class="text-slate-900"><?php echo e(\Carbon\Carbon::parse($statistiques_paiements['premier_paiement'])->format('d/m/Y')); ?></div>
                            </div>
                        <?php endif; ?>

                        <?php if($statistiques_paiements['dernier_paiement'] ?? false): ?>
                            <div>
                                <div class="text-sm font-medium text-slate-700">Dernier paiement</div>
                                <div class="text-slate-900"><?php echo e(\Carbon\Carbon::parse($statistiques_paiements['dernier_paiement'])->format('d/m/Y')); ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<div id="paiementModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-3xl w-full mx-4 transform transition-all max-h-[90vh] overflow-y-auto">
        <div class="text-center mb-6">
            ...
            <p class="text-slate-500 text-sm mt-1">Souscription: <?php echo e($subscription['fimeco']['nom'] ?? 'N/A'); ?> - <?php echo e($subscription['souscripteur']['nom'] ?? 'N/A'); ?></p>
            ...
            <div class="mt-4 p-4 bg-slate-50 rounded-xl">
                <div class="grid grid-cols-3 gap-4 text-sm">
                    <div>
                        ...
                        <div class="font-bold text-slate-900"><?php echo e(number_format($subscription['montant_souscrit'] ?? 0, 0, ',', ' ')); ?> FCFA</div>
                    </div>
                    <div>
                        <span class="text-slate-600">Déjà payé:</span>
                        <div class="font-bold text-green-600"><?php echo e(number_format($subscription['montant_paye'] ?? 0, 0, ',', ' ')); ?> FCFA</div>
                    </div>
                    <div>
                        <span class="text-slate-600">Reste à payer:</span>
                        <div class="font-bold text-orange-600"><?php echo e(number_format($subscription['reste_a_payer'] ?? 0, 0, ',', ' ')); ?> FCFA</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div id="montantInfo" class="text-xs text-slate-500 mt-1">
                        Vous pouvez payer jusqu'à <?php echo e(number_format($subscription['reste_a_payer'] ?? 0, 0, ',', ' ')); ?> FCFA pour compléter votre souscription
                    </div>
                </div>
...
document.getElementById('paiementForm').addEventListener('submit', function(e) {
    ...
    // Envoi des données
    fetch("<?php echo e(route('private.subscriptions.effectuer-paiement', $subscription['id'])); ?>", {
        method: 'POST',
        headers: {
...
document.getElementById('validationForm').addEventListener('submit', function(e) {
    ...
    const url = currentAction === 'validate' ?
        `<?php echo e(route('private.paiements.validate', ':id')); ?>`.replace(':id', currentPaymentId) :
        `<?php echo e(route('private.paiements.reject', ':id')); ?>`.replace(':id', currentPaymentId);
...
function desactiverSouscription() {
    showConfirm(
        ...
        function() {
            fetch("<?php echo e(route('private.subscriptions.desactiver', $subscription['id'])); ?>", {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>",
                    'Accept': 'application/json',
...
function reactiverSouscription() {
    showConfirm(
        ...
        function() {
            fetch("<?php echo e(route('private.subscriptions.reactiver', $subscription['id'])); ?>", {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>",
                    'Accept': 'application/json',
...
function deleteSouscription() {
    showConfirm(
        ...
        function() {
            fetch("<?php echo e(route('private.subscriptions.destroy', $subscription['id'])); ?>", {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>",
                    'Accept': 'application/json',
            ...
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = "<?php echo e(route('private.subscriptions.index')); ?>";
                    }, 2000);
                } else {
        ...
        'Supprimer la souscription',
        {
            ...
            //         window.location.href = `<?php echo e(route('private.subscriptions.rapport', $subscription['id'])); ?>?format=${format}`;
            //     }
            // }
...
function calculerImpactPaiement() {
    ...
    const resteAPayer = <?php echo e($subscription['reste_a_payer'] ?? 0); ?>;
    const montantSouscrit = <?php echo e($subscription['montant_souscrit'] ?? 0); ?>;
    const progressionActuelle = <?php echo e($subscription['progression'] ?? 0); ?>;
    ...
    const nouvelleProgression = montantSouscrit > 0 ?
        Math.min(100, ((<?php echo e($subscription['montant_paye'] ?? 0); ?> + montantPourBase) / montantSouscrit) * 100) : 0;
...
function simulerPaiement() {
    ...
    fetch("<?php echo e(route('private.subscriptions.simuler-paiement', $subscription['id'])); ?>", {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': "<?php echo e(csrf_token()); ?>",
            'Accept': 'application/json',
