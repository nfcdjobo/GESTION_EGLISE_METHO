    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($users->where('statut_membre', 'nouveau_converti')->count()); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($users->where('statut_membre', 'visiteur')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.import')): ?>
                            <a href="<?php echo e(route('private.users.import')); ?>"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export-data', 'users')): ?>
                            <a href="<?php echo e(route('private.users.export')); ?>"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.search')): ?>
                <div class="p-6">
                    <form method="GET" action="<?php echo e(route('private.users.index')); ?>"
                        ...
                        <div>
                            ...
                            <select name="statut_membre"
                                ...
                                <option value="actif" <?php echo e(request('statut_membre') === 'actif' ? 'selected' : ''); ?>>Actif
                                </option>
                                <option value="inactif" <?php echo e(request('statut_membre') === 'inactif' ? 'selected' : ''); ?>>Inactif
                                </option>
                                <option value="visiteur" <?php echo e(request('statut_membre') === 'visiteur' ? 'selected' : ''); ?>>
                                    Visiteur</option>
                                <option value="nouveau_converti"
                                    <?php echo e(request('statut_membre') === 'nouveau_converti' ? 'selected' : ''); ?>>Nouveau converti
                                </option>
                            </select>
                        </div>
                            ...
                            <select name="classe_id"
                                ...
                                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($classe->id); ?>"
                                        <?php echo e(request('classe_id') == $classe->id ? 'selected' : ''); ?>>
                ...
                <?php if($users->count() > 0): ?>
                        ...
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b border-slate-200">
                                    ...
                                    <th
                                        class="px-4 py-3 text-right text-xs font-bold text-slate-700 uppercase tracking-wider">
                                        Actions</th>
                                </tr>
                            </thead>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-12 w-12">
                                                    ...
                                                    <?php else: ?>
                                                        <div
                                                            class="h-12 w-12 rounded-full bg-gradient-to-br from-<?php echo e($user->sexe === 'feminin' ? 'pink' : 'blue'); ?>-400 to-<?php echo e($user->sexe === 'feminin' ? 'purple' : 'indigo'); ?>-500 flex items-center justify-center shadow-lg ring-4 ring-white">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex flex-wrap gap-1">
                                                <?php $__currentLoopData = $user->roles->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span
                                                        class="inline-flex items-center px-2 py-1 text-xs font-semibold rounded-lg bg-indigo-100 text-indigo-800">
                                                        <?php echo e($role->name); ?>
                                                ...
                                                <?php if($user->roles->count() > 3): ?>
                                                    <span
                                                        class="inline-flex items-center px-2 py-1 text-xs font-semibold rounded-lg bg-gray-100 text-gray-600">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center justify-end space-x-2">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.toggle-status')): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <button class="inline-flex items-center justify-center w-8 h-8 rounded-lg transition-colors">
                                                        </button>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                    ...
                    <div
                        ...
                        <div class="text-sm text-slate-700">
                            Affichage de <span class="font-medium"><?php echo e($users->firstItem()); ?></span> à <span
                                class="font-medium"><?php echo e($users->lastItem()); ?></span>sur <span
                                class="font-medium"><?php echo e($users->total()); ?></span> résultats
                        </div>
                        <div>
