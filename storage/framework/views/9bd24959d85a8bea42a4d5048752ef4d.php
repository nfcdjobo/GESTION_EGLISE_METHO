...
<div class="space-y-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-1">Administration des membres et utilisateurs - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($users->where('statut_membre', 'nouveau_converti')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($users->where('statut_membre', 'visiteur')->count()); ?></p>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.create')): ?>
                        <a href="<?php echo e(route('private.users.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
                            <i class="fas fa-plus mr-2"></i> Nouvel Utilisateur
                        </a>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.import')): ?>
                        <a href="<?php echo e(route('private.users.import')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-sm font-medium rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
                            <i class="fas fa-upload mr-2"></i> Importer
                        </a>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export-data', 'users')): ?>
                        <a href="<?php echo e(route('private.users.export')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white text-sm font-medium rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.search')): ?>
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('private.users.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                <div class="lg:col-span-2">
                    <label class="block text-sm font-medium text-slate-700 mb-2">Recherche</label>
                    <div class="relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nom, prénom, email, téléphone..." class="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div>
                    ...
                    <select name="statut_membre" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="actif" <?php echo e(request('statut_membre') === 'actif' ? 'selected' : ''); ?>>Actif</option>
                        <option value="inactif" <?php echo e(request('statut_membre') === 'inactif' ? 'selected' : ''); ?>>Inactif</option>
                        <option value="visiteur" <?php echo e(request('statut_membre') === 'visiteur' ? 'selected' : ''); ?>>Visiteur</option>
                        <option value="nouveau_converti" <?php echo e(request('statut_membre') === 'nouveau_converti' ? 'selected' : ''); ?>>Nouveau converti</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="classe_id" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="<?php echo e($classe->id); ?>" <?php echo e(request('classe_id') == $classe->id ? 'selected' : ''); ?>>
                ...
                <div class="lg:col-span-6 flex gap-2 pt-4">
                    ...
                    <a href="<?php echo e(route('private.users.index')); ?>" class="inline-flex items-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-colors">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center space-x-2">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                        <?php echo e($users->total()); ?> résultats
                    </span>
                    <?php if($users->hasPages()): ?>
                    <span class="text-sm text-slate-600">
                        Page <?php echo e($users->currentPage()); ?> sur <?php echo e($users->lastPage()); ?>
        ...
        <div class="p-6">
            <?php if($users->count() > 0): ?>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-slate-200">
                                ...
                                <th class="px-4 py-3 text-left text-xs font-bold text-slate-700 uppercase tracking-wider">
                                    <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'date_adhesion', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])); ?>"
                                       class="group inline-flex items-center hover:text-blue-600 transition-colors">
                                        Adhésion
                                        <span class="ml-2 flex-none rounded text-slate-400 group-hover:text-blue-500">
                                            <i class="fas fa-sort"></i>
                            ...
                            <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200">
                                <td class="px-4 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            ...
                                            <?php else: ?>
                                            <div class="h-12 w-12 rounded-full bg-gradient-to-br from-<?php echo e($user->sexe === 'feminin' ? 'pink' : 'blue'); ?>-400 to-<?php echo e($user->sexe === 'feminin' ? 'purple' : 'indigo'); ?>-500 flex items-center justify-center shadow-lg ring-4 ring-white">
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $user->roles->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td class="px-4 py-4 text-sm text-slate-700">
                                    <?php echo e($user->date_adhesion ? $user->date_adhesion->format('d/m/Y') : '-'); ?>
                                ...
                                <td class="px-4 py-4">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <a href="<?php echo e(route('private.users.edit', $user)); ?>"
                                        ...
                                        <button onclick="toggleStatus('<?php echo e($user->id); ?>')"
                                                class="inline-flex items-center justify-center w-8 h-8 <?php echo e($user->actif ? 'text-orange-600 bg-orange-100 hover:bg-orange-200' : 'text-green-600 bg-green-100 hover:bg-green-200'); ?> rounded-lg transition-colors"
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-6 border-t border-slate-200">
                    <div class="text-sm text-slate-700">
                        Affichage de <span class="font-medium"><?php echo e($users->firstItem()); ?></span> à <span class="font-medium"><?php echo e($users->lastItem()); ?></span>sur <span class="font-medium"><?php echo e($users->total()); ?></span> résultats
                    </div>
                    <div>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('users.create')): ?>
                        <a href="<?php echo e(route('private.users.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/users/index.blade.php ENDPATH**/ ?>