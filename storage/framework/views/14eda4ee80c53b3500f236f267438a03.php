<?php $__env->startSection('title', 'Inscriptions - ' . $event->titre); ?>
...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="flex items-start justify-between">
            <div>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e(route('private.events.show', $event)); ?>" class="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">
                                    <?php echo e(Str::limit($event->titre, 20)); ?>
                ...
                <p class="text-slate-600 mt-1"><?php echo e($event->sous_titre ?? 'Gestion des participants à l\'événement'); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.manage_inscriptions')): ?>
                ...
                <a href="<?php echo e(route('private.events.show', $event)); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-slate-600 to-slate-700 text-white text-sm font-medium rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all duration-200 shadow-md hover:shadow-lg">
                    <i class="fas fa-arrow-left mr-2"></i> Retour à l'événement
                </a>

                <?php if($event->liste_attente): ?>
                    <a href="<?php echo e(route('private.events.liste-attente', $event)); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white text-sm font-medium rounded-xl hover:from-orange-700 hover:to-red-700 transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center p-4 bg-blue-50 rounded-xl">
                    <div class="text-2xl font-bold text-blue-600"><?php echo e($statistiques['total_inscriptions']); ?></div>
                    <div class="text-sm text-blue-800">Total inscriptions</div>
                </div>
                <div class="text-center p-4 bg-green-50 rounded-xl">
                    <div class="text-2xl font-bold text-green-600"><?php echo e($statistiques['inscriptions_actives']); ?></div>
                    <div class="text-sm text-green-800">Inscriptions actives</div>
                </div>
                <div class="text-center p-4 bg-red-50 rounded-xl">
                    <div class="text-2xl font-bold text-red-600"><?php echo e($statistiques['inscriptions_annulees']); ?></div>
                    <div class="text-sm text-red-800">Inscriptions annulées</div>
                </div>
                <?php if($event->capacite_totale): ?>
                    <div class="text-center p-4 bg-purple-50 rounded-xl">
                        <div class="text-2xl font-bold text-purple-600"><?php echo e($statistiques['places_restantes']); ?></div>
            ...
            <?php if($event->capacite_totale): ?>
                <div class="mt-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-sm text-slate-500"><?php echo e($statistiques['taux_remplissage']); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div class="bg-gradient-to-r from-blue-500 to-purple-500 h-3 rounded-full" style="width: <?php echo e($statistiques['taux_remplissage']); ?>%"></div>
                    </div>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('private.events.inscriptions', $event)); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Recherche</label>
                    <div class="relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nom, email, téléphone..." class="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div>
                    ...
                    <select name="statut" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="active" <?php echo e(request('statut') == 'active' ? 'selected' : ''); ?>>Actives</option>
                        <option value="annulee" <?php echo e(request('statut') == 'annulee' ? 'selected' : ''); ?>>Annulées</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Date inscription</label>
                    <input type="date" name="date_inscription" value="<?php echo e(request('date_inscription')); ?>" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                </div>
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-slate-800 flex items-center">
                    ...
                    Liste des Inscriptions (<?php echo e($inscriptions->total()); ?>)
                </h2>
            ...
            <?php if($inscriptions->count() > 0): ?>
                        ...
                        <tbody class="divide-y divide-slate-200">
                            <?php $__currentLoopData = $inscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-4">
                                        <input type="checkbox" name="selected_inscriptions[]" value="<?php echo e($inscription->id); ?>" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 inscription-checkbox">
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="flex items-center space-x-3">
                                            <div class="w-10 h-10 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full flex items-center justify-center">
                                                <span class="text-white font-semibold"><?php echo e(substr($inscription->inscrit->prenom, 0, 1)); ?><?php echo e(substr($inscription->inscrit->nom, 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <div class="font-semibold text-slate-900"><?php echo e($inscription->inscrit->prenom); ?> <?php echo e($inscription->inscrit->nom); ?></div>
                                                <?php if($inscription->inscrit->date_naissance): ?>
                                                    <div class="text-xs text-slate-500"><?php echo e(\Carbon\Carbon::parse($inscription->inscrit->date_naissance)->age); ?> ans</div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="text-sm">
                                            <div class="text-slate-900"><?php echo e($inscription->inscrit->email); ?></div>
                                            <?php if($inscription->inscrit->telephone_1): ?>
                                                <div class="text-slate-500"><?php echo e($inscription->inscrit->telephone_1); ?></div>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4">
                                        <div class="text-sm">
                                            <div class="font-medium text-slate-900"><?php echo e($inscription->date_inscription->format('d/m/Y H:i')); ?></div>
                                            <?php if($inscription->createur): ?>
                                                <div class="text-slate-500">
                                                    <?php if($inscription->est_auto_inscription): ?>
                                                        Auto-inscription
                                                    <?php else: ?>
                                                        Par <?php echo e($inscription->createur->prenom); ?> <?php echo e($inscription->createur->nom); ?>
                                    ...
                                    <td class="px-4 py-4">
                                        <?php if($inscription->est_active): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                <i class="fas fa-check-circle mr-1"></i> Active
                                            </span>
                                        <?php elseif($inscription->est_annulee): ?>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center space-x-2">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.manage_inscriptions')): ?>
                                                <?php if($inscription->est_active): ?>
                                                    <button type="button" onclick="annulerInscription('<?php echo e($inscription->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-red-600 bg-red-100 rounded-lg hover:bg-red-200 transition-colors" title="Annuler">
                                                        <i class="fas fa-times text-sm"></i>
                                                    </button>
                                                <?php elseif($inscription->est_annulee && $inscription->peutEtreReactivee()): ?>
                                                    <button type="button" onclick="reactiverInscription('<?php echo e($inscription->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors" title="Réactiver">
                                                        <i class="fas fa-redo text-sm"></i>
                                                    </button>
                                                <?php endif; ?>

                                                <button type="button" onclick="editInscription('<?php echo e($inscription->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-blue-600 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors" title="Modifier">
                                                    <i class="fas fa-edit text-sm"></i>
                                                </button>

                                                <button type="button" onclick="deleteInscription('<?php echo e($inscription->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors" title="Supprimer">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-6 border-t border-slate-200">
                    <div class="text-sm text-slate-700">
                        Affichage de <span class="font-medium"><?php echo e($inscriptions->firstItem()); ?></span> à <span class="font-medium"><?php echo e($inscriptions->lastItem()); ?></span>
                        sur <span class="font-medium"><?php echo e($inscriptions->total()); ?></span> résultats
                    </div>
                    <div>
                        <?php echo e($inscriptions->appends(request()->query())->links()); ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <p class="text-slate-500 mb-6">
                        <?php if(request()->hasAny(['search', 'statut', 'date_inscription'])): ?>
                ...
                <div class="mb-4">
                    ...
                    <select id="inscrit_id" name="inscrit_id" required class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>"><?php echo e($user->prenom); ?> <?php echo e($user->nom); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </form>
...
document.getElementById('confirmAddInscription').addEventListener('click', function() {
    ...
    fetch('<?php echo e(route("private.events.inscriptions.ajouter", $event)); ?>', {
        method: 'POST',
        headers: {
...
function annulerInscription(inscription) {
    ...
    fetch(`<?php echo e(route('private.events.inscriptions.annuler', [$event, ':inscription'])); ?>`.replace(':inscription', inscription), {
        method: 'PUT',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Content-Type': 'application/json',
...
function reactiverInscription(inscription) {
    ...
    fetch(`<?php echo e(route('private.events.inscriptions.reactivate', [$event, ':inscription'])); ?>`.replace(':inscription', inscription), {
        method: 'PUT',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Content-Type': 'application/json',
...
function deleteInscription(inscription) {
    ...
    fetch(`<?php echo e(route('private.events.inscriptions.supprimer', [$event, ':inscription'])); ?>`.replace(':inscription', inscription), {
        method: 'DELETE',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/events/inscriptions/index.blade.php ENDPATH**/ ?>