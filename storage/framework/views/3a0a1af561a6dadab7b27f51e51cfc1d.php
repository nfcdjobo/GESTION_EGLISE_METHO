<?php $__env->startSection('title', 'Nouveau Rapport de Réunion'); ?>
...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('private.rapports-reunions.store')); ?>" method="POST" id="rapportForm" class="space-y-8">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="titre_rapport" name="titre_rapport" value="<?php echo e(old('titre_rapport')); ?>" required maxlength="200" placeholder="Ex: Rapport de la réunion mensuelle"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = \App\Models\RapportReunion::TYPES_RAPPORT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('type_rapport') == $value ? 'selected' : ''); ?>>
                                            <?php switch($value):
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $redacteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $redacteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($redacteur->id); ?>" <?php echo e(old('redacteur_id') == $redacteur->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $validateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $validateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($validateur->id); ?>" <?php echo e(old('validateur_id') == $validateur->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="resume" name="resume" rows="4" placeholder="Résumé du rapport"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('resume')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="decisions_prises" name="decisions_prises" rows="4" placeholder="Décisions importantes prises lors de la réunion"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('decisions_prises')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="actions_decidees" name="actions_decidees" rows="4" placeholder="Actions décidées et à mettre en œuvre"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('actions_decidees')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="recommandations" name="recommandations" rows="4" placeholder="Recommandations pour l'avenir"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('recommandations')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="commentaires" name="commentaires" rows="3" placeholder="Commentaires généraux sur la réunion"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('commentaires')); ?></textarea>
                            </div>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="nombre_presents" name="nombre_presents" value="<?php echo e(old('nombre_presents', 0)); ?>" min="0"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="montant_collecte" name="montant_collecte" value="<?php echo e(old('montant_collecte')); ?>" min="0" step="0.01"
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span id="preview-redacteur" class="text-sm text-slate-600"><?php echo e(auth()->user()->nom); ?> <?php echo e(auth()->user()->prenom); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e(old('note_satisfaction') == $i ? 'selected' : ''); ?>><?php echo e($i); ?> - <?php echo e(['Très insatisfaisante', 'Insatisfaisante', 'Correcte', 'Satisfaisante', 'Excellente'][$i-1]); ?></option>
                                <?php endfor; ?>
                            </select>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('private.rapports-reunions.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
...
function updatePreview() {
    ...
    const redacteur = redacteurSelect.options[redacteurSelect.selectedIndex]?.text || '<?php echo e(auth()->user()->nom); ?> <?php echo e(auth()->user()->prenom); ?>';
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/rapportsreunions/create.blade.php ENDPATH**/ ?>