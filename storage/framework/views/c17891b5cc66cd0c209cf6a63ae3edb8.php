    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($parametres->horaires_cultes ? count($parametres->horaires_cultes) : '0'); ?></p>
                        ...
                        <?php $__currentLoopData = $parametres->horaires_cultes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $horaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="font-medium text-slate-900"><?php echo e($horaire['jour'] ?? 'N/A'); ?></p>
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/parametres/index.blade.php ENDPATH**/ ?>