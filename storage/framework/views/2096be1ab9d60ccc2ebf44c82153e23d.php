...
<div class="space-y-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-1">Suivi et gestion des projets de l'église - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.create')): ?>
                        <a href="<?php echo e(route('private.projets.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('private.projets.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <div>
                    ...
                    <select name="statut" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $options['statuts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <select name="type_projet" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $options['types_projet']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(request('type_projet') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="priorite" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $options['priorites']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(request('priorite') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="responsable_id" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $options['responsables']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($responsable['id']); ?>" <?php echo e(request('responsable_id') == $responsable['id'] ? 'selected' : ''); ?>><?php echo e($responsable['nom_complet']); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="lg:col-span-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="date" name="date_debut_min" value="<?php echo e(request('date_debut_min')); ?>" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">Date début max</label>
                        <input type="date" name="date_debut_max" value="<?php echo e(request('date_debut_max')); ?>" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">Budget min</label>
                        <input type="number" name="budget_min" value="<?php echo e(request('budget_min')); ?>" placeholder="0" min="0" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    <div class="flex items-end">
                        <div class="w-full space-y-2">
                            <div class="flex items-center">
                                <input type="checkbox" name="visible_public" value="1" <?php echo e(request('visible_public') ? 'checked' : ''); ?> id="visible_public" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                <label for="visible_public" class="ml-2 text-sm text-slate-700">Visibles publiquement</label>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" name="en_retard" value="1" <?php echo e(request('en_retard') ? 'checked' : ''); ?> id="en_retard" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                ...
                <div class="lg:col-span-6 flex gap-2 pt-4">
                    ...
                    <a href="<?php echo e(route('private.projets.index')); ?>" class="inline-flex items-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-colors">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($projets->total()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($projets->where('statut', 'en_cours')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($projets->where('statut', 'termine')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($projets->sum('budget_prevu') ?: 0)); ?> XOF</p>
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h2 class="text-xl font-bold text-slate-800 flex items-center">
                    ...
                    Liste des Projets (<?php echo e($projets->total()); ?>)
                </h2>
                <div class="flex items-center space-x-2">
                    <select id="sortBy" class="px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm">
                        ...
                        <option value="nom_projet" <?php echo e(request('sort_by') == 'nom_projet' ? 'selected' : ''); ?>>Nom</option>
                        <option value="type_projet" <?php echo e(request('sort_by') == 'type_projet' ? 'selected' : ''); ?>>Type</option>
                        <option value="statut" <?php echo e(request('sort_by') == 'statut' ? 'selected' : ''); ?>>Statut</option>
                        <option value="priorite" <?php echo e(request('sort_by') == 'priorite' ? 'selected' : ''); ?>>Priorité</option>
                        <option value="budget_prevu" <?php echo e(request('sort_by') == 'budget_prevu' ? 'selected' : ''); ?>>Budget</option>
                        <option value="pourcentage_completion" <?php echo e(request('sort_by') == 'pourcentage_completion' ? 'selected' : ''); ?>>Progression</option>
                    </select>
            ...
            <?php if($projets->count() > 0): ?>
                    ...
                    <?php $__currentLoopData = $projets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gradient-to-br from-white to-slate-50 rounded-xl border border-slate-200 p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex-1">
                                    <h3 class="text-lg font-bold text-slate-900 mb-1"><?php echo e($projet->nom_projet); ?></h3>
                                    <p class="text-sm text-slate-600"><?php echo e($projet->code_projet); ?> • <?php echo e($projet->type_projet_libelle); ?></p>
                                </div>
                                <div class="flex flex-col items-end space-y-2">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($prioriteColors[$projet->priorite] ?? 'bg-gray-100 text-gray-600'); ?>">
                            ...
                            <div class="space-y-3 mb-4">
                                <?php if($projet->date_debut): ?>
                                    <div class="flex items-center text-sm text-slate-600">
                                        ...
                                        <span><?php echo e(\Carbon\Carbon::parse($projet->date_debut)->format('d/m/Y')); ?></span>
                                        <?php if($projet->date_fin_prevue): ?>
                                            <span class="mx-2">→</span>
                                            <span><?php echo e(\Carbon\Carbon::parse($projet->date_fin_prevue)->format('d/m/Y')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if($projet->responsable): ?>
                                    <div class="flex items-center text-sm text-slate-600">
                                        ...
                                        <span><?php echo e($projet->responsable->nom); ?> <?php echo e($projet->responsable->prenom); ?></span>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if($projet->budget_prevu): ?>
                                    <div class="flex items-center justify-between text-sm text-slate-600">
                                        <div class="flex items-center">
                                            ...
                                            <span><?php echo e($projet->budget_format); ?></span>
                                        </div>
                                        <?php if($projet->budget_collecte > 0): ?>
                                            <span class="text-green-600 font-medium"><?php echo e($projet->pourcentage_financement); ?>%</span>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="w-full bg-slate-200 rounded-full h-2">
                                        <div class="bg-gradient-to-r from-blue-500 to-green-500 h-2 rounded-full transition-all duration-300" style="width: <?php echo e($projet->pourcentage_completion); ?>%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-slate-200">
                                <div class="flex items-center space-x-2">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.read')): ?>
                                        <a href="<?php echo e(route('private.projets.show', $projet)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-cyan-600 bg-cyan-100 rounded-lg hover:bg-cyan-200 transition-colors" title="Voir">
                                            <i class="fas fa-eye text-sm"></i>
                                        </a>
                                    <?php endif; ?>

                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.update')): ?>
                                        <a href="<?php echo e(route('private.projets.edit', $projet)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-yellow-600 bg-yellow-100 rounded-lg hover:bg-yellow-200 transition-colors" title="Modifier">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.delete')): ?>
                                    <?php if(!in_array($projet->statut, ['en_cours', 'suspendu'])): ?>
                                        <button type="button" onclick="deleteProject('<?php echo e($projet->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-red-600 bg-red-100 rounded-lg hover:bg-red-200 transition-colors" title="Supprimer">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-6 border-t border-slate-200">
                    <div class="text-sm text-slate-700">
                        Affichage de <span class="font-medium"><?php echo e($projets->firstItem()); ?></span> à <span class="font-medium"><?php echo e($projets->lastItem()); ?></span>
                        sur <span class="font-medium"><?php echo e($projets->total()); ?></span> résultats
                    </div>
                    <div>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <p class="text-slate-500 mb-6">
                        <?php if(request()->hasAny(['search', 'statut', 'type_projet', 'priorite'])): ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.create')): ?>
                        <a href="<?php echo e(route('private.projets.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
...
function approveProject(projectId) {
    if (confirm('Êtes-vous sûr de vouloir approuver ce projet ?')) {
        fetch(`<?php echo e(route('private.projets.approuver', ':projectid')); ?>`.replace(':projectid', projectId), {
            method: 'POST',
            headers: {
...
function startProject(projectId) {
    if (confirm('Êtes-vous sûr de vouloir démarrer ce projet ?')) {
        fetch(`<?php echo e(route('private.projets.demarrer', ':projectid')); ?>`.replace(':projectid', projectId), {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Accept': 'application/json'
...
function duplicateProject() {
    ...
    fetch(`<?php echo e(route('private.projets.dupliquer', ':projectid')); ?>`.replace(':projectid', projectId), {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Accept': 'application/json'
    ...
    .then(data => {
        if (data.success) {
            window.location.href = `<?php echo e(route('private.projets.show', ':projectid')); ?>`.replace(':projectid', data.data.id);
        } else {
            alert(data.message || 'Une erreur est survenue');
        }
    })
...
function deleteProject(projectId) {
    if (confirm('Êtes-vous sûr de vouloir supprimer ce projet ?')) {
        fetch(`<?php echo e(route('private.projets.destroy', ':projectid')); ?>`.replace(':projectid', projectId), {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Accept': 'application/json'
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/projets/index.blade.php ENDPATH**/ ?>