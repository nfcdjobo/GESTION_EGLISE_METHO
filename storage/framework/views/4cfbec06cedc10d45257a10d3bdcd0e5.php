...
<footer>
    <div class="footer-content">
        ...
        <div class="footer-section">
            ...
            <a href="tel:<?php echo e($AppParametres->telephone_1); ?>"><i class="fas fa-phone"></i><?php echo e($AppParametres->telephone_1); ?></a>
            <?php if($AppParametres->telephone_2): ?>
                <a href="tel:<?php echo e($AppParametres->telephone_2); ?>"><i class="fas fa-mobile-alt"></i><?php echo e($AppParametres->telephone_2); ?></a>
            <?php endif; ?>
            <a href="mailto:<?php echo e($AppParametres->email_principal); ?>"><i class="fas fa-envelope"></i> <?php echo e($AppParametres->email_principal); ?></a>
        </div>
        ...
        <div class="footer-section">
            ...
            <div class="footer-menu">
                <a href="<?php echo e(url()->current() === route('public.accueil') ? '#accueil' : route('public.accueil') . '#accueil'); ?>" class="footer-nav-link" data-section="accueil">Accueil</a>
                <a href="<?php echo e(url()->current() === route('public.accueil') ? '#programmes' : route('public.accueil') . '#programmes'); ?>" class="footer-nav-link" data-section="programmes">Nos Programmes</a>
                <a href="<?php echo e(url()->current() === route('public.accueil') ? '#events' : route('public.accueil') . '#events'); ?>" class="footer-nav-link" data-section="events">Nos Événements</a>
                <a href="<?php echo e(route('public.donates.index')); ?>" class="footer-nav-link external">Faire un don</a>
                <a href="<?php echo e(url()->current() === route('public.accueil') ? '#contact' : route('public.accueil') . '#contact'); ?>" class="footer-nav-link" data-section="contact">Nos Contacts</a>

                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('private.dashboard')); ?>" class="dashboard-link footer-nav-link external">
                        <i class="fas fa-tachometer-alt"></i>
                        Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('security.login')); ?>" class="login-link footer-nav-link external">
        ...
        <div class="footer-section">
            ...
            <p><?php echo e($AppParametres->commune); ?>, <?php echo e($AppParametres->ville); ?><br><?php echo e($AppParametres->pays); ?></p>
        ...
        <div class="footer-section">
            ...
            <div class="social-links">
                <?php if($AppParametres->facebook_url): ?>
                    <a href="<?php echo e($AppParametres->facebook_url ?? '#'); ?>" class="social-link" target="_blank">
                        <i class="fab fa-facebook-f"></i> Facebook
                    </a>
                <?php endif; ?>

                <?php if($AppParametres->youtube_url): ?>
                    <a href="<?php echo e($AppParametres->youtube_url ?? '#'); ?>" class="social-link" target="_blank">
                        <i class="fab fa-youtube"></i> YouTube
                    </a>
                <?php endif; ?>

                <?php if($AppParametres->twitter_url): ?>
                    <a href="<?php echo e($AppParametres->twitter_url ?? '#'); ?>" class="social-link" target="_blank">
                        <i class="fab fa-twitter"></i> Twitter
                    </a>
                <?php endif; ?>

                <?php if($AppParametres->instagram_url): ?>
                    <a href="<?php echo e($AppParametres->instagram_url ?? '#'); ?>" class="social-link" target="_blank">
                        <i class="fab fa-instagram"></i> Instagram
                    </a>
                <?php endif; ?>

                <?php if($AppParametres->tiktok_url): ?>
                    <a href="<?php echo e($AppParametres->tiktok_url ?? '#'); ?>" class="social-link" target="_blank">
                        <i class="fab fa-tiktok"></i> TikTok
                    </a>
                <?php endif; ?>

                <?php if($AppParametres->telephone_1): ?>
                    <a href="https://wa.me/<?php echo e($AppParametres->telephone_1 ?? '#'); ?>" class="social-link" target="_blank">
