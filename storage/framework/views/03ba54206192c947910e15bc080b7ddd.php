<?php $__env->startSection('title', 'Gérer les Permissions: ' . $role->name); ?>
...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="flex items-center space-x-2 mb-2">
            ...
            <?php endif; ?>
            <h1 class="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Gérer les Permissions: <?php echo e($role->name); ?></h1>
        </div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('private.roles.show', $role)); ?>" class="text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors"><?php echo e($role->name); ?></a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="flex items-center space-x-3">
                    ...
                    <?php endif; ?>
                    <div>
                        <div class="font-bold text-slate-900"><?php echo e($role->name); ?></div>
                ...
                <div>
                    ...
                    <span id="current-permissions-count" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-cyan-100 text-cyan-800 ml-2"><?php echo e($rolePermissions->count()); ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('private.roles.show', $role)); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-slate-600 to-gray-600 text-white text-sm font-medium rounded-xl hover:from-slate-700 hover:to-gray-700 transition-all duration-200 shadow-md hover:shadow-lg">
                ...
                <div>
                    ...
                    <select id="filter-category" onchange="filterPermissions()" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryPermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category); ?>"><?php echo e(ucfirst($category)); ?> (<?php echo e($categoryPermissions->count()); ?>)</option>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-gradient-to-br from-blue-500 to-cyan-500 text-white rounded-xl p-6 text-center">
                    <div class="text-3xl font-bold mb-2" id="total-selected"><?php echo e($rolePermissions->count()); ?></div>
    ...
    <div class="bg-white/80  rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <div class="p-6">
            <?php if($permissions->count() > 0): ?>
                <div class="space-y-6">
                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $categoryPermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="permission-category border border-slate-200 rounded-xl overflow-hidden" data-category="<?php echo e($category); ?>">
                            <div class="bg-gradient-to-r from-slate-50 to-blue-50 p-4 border-b border-slate-200">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        <input type="checkbox" data-category="<?php echo e($category); ?>" onchange='toggleCategoryPermissions("<?php echo e($category); ?>")' class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 category-checkbox">
                                        ...
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 category-selected-count" data-category="<?php echo e($category); ?>">0</span>
                                    </div>
                            ...
                            <div class="category-permissions p-4" id="category-<?php echo e($category); ?>">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <?php $__currentLoopData = $categoryPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <div class="permission-item" data-category="<?php echo e($category); ?>" data-permission-name="<?php echo e(strtolower($permission->name)); ?>" data-permission-slug="<?php echo e(strtolower($permission->slug)); ?>" data-assigned="<?php echo e($isAssigned ? 'true' : 'false'); ?>">
                                            <div class="permission-card h-full border-2 rounded-xl p-4 transition-all duration-300 hover:shadow-md <?php echo e($isAssigned ? 'border-green-300 bg-green-50' : 'border-slate-200 bg-white hover:border-blue-300'); ?>">
                                                <div class="flex items-start space-x-3">
                                                    <input type="checkbox" name="permissions[]" value="<?php echo e($permission->id); ?>" id="permission_<?php echo e($permission->id); ?>" data-category="<?php echo e($category); ?>" <?php echo e($isAssigned ? 'checked' : ''); ?> onchange="updatePermissionState(this)" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 permission-checkbox mt-1">
                                                    <div class="flex-1">
                                                        <label for="permission_<?php echo e($permission->id); ?>" class="block cursor-pointer">
                                                            <div class="permission-info">
                                                                <h4 class="permission-name font-semibold text-slate-900 mb-1"><?php echo e($permission->name); ?></h4>
                                                                <?php if($permission->description): ?>
                                                                    <p class="permission-description text-sm text-slate-600 mb-2"><?php echo e($permission->description); ?></p>
                                                                <?php endif; ?>
                                                                <code class="permission-slug text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded"><?php echo e($permission->slug); ?></code>

                                                                <?php if($isAssigned && $rolePermission): ?>
                                                                    <div class="mt-3 permission-details space-y-1">
                                                                        <div class="flex items-center text-sm text-green-600">
                                                                            <i class="fas fa-check-circle mr-2"></i>
                                                                            <span>Assigné
                                                                                <?php if($rolePermission->pivot->attribue_le): ?>
                                                                                    le <?php echo e(\Carbon\Carbon::parse($rolePermission->pivot->attribue_le)->format('d/m/Y')); ?>

                                                                                <?php endif; ?>
                                                                            </span>
                                                                        </div>
                                                                        <?php if($rolePermission->pivot->expire_le): ?>
                                                                            <div class="flex items-center text-sm text-yellow-600">
                                                                                <i class="fas fa-clock mr-2"></i>
                                                                                <span>Expire le <?php echo e(\Carbon\Carbon::parse($rolePermission->pivot->expire_le)->format('d/m/Y')); ?></span>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                        <?php if($rolePermission->pivot->attribue_par): ?>
                                                                            <div class="flex items-center text-sm text-slate-500">
                                                                                <i class="fas fa-user mr-2"></i>
                                                                                <span>Par: <?php echo e(\App\Models\User::find($rolePermission->pivot->attribue_par)?->nom_complet ?? 'N/A'); ?></span>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                <?php endif; ?>
    ...
    <div class="bg-white/80  rounded-2xl shadow-lg border border-white/20 p-6">
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="<?php echo e(route('private.roles.show', $role)); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-slate-600 to-gray-600 text-white font-medium rounded-xl hover:from-slate-700 hover:to-gray-700 transition-all duration-200 shadow-md hover:shadow-lg">
...
function copyFromRole() {
    fetch("<?php echo e(route('private.roles.index')); ?>", {
        headers: {
...
function executeRoleCopy() {
    ...
    fetch( `<?php echo e(route('private.roles.permissions', ':roleid')); ?>`.replace(':roleid', sourceRoleId), {
        headers: {
            'Accept': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
        }
...
function savePermissions() {
    ...
    fetch('<?php echo e(route("private.roles.permissions.sync", $role)); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/roles/permissions.blade.php ENDPATH**/ ?>