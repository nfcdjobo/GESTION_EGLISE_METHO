...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('private.projets.store')); ?>" method="POST" enctype="multipart/form-data" id="projetForm" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="nom_projet" name="nom_projet" value="<?php echo e(old('nom_projet')); ?>" required maxlength="200" placeholder="Ex: Construction nouveau sanctuaire"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="code_projet" name="code_projet" value="<?php echo e(old('code_projet')); ?>" maxlength="50" placeholder="Ex: CONST2024001"
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="objectif" name="objectif" rows="4" placeholder="Objectifs du projet"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('objectif')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                <textarea id="contexte" name="contexte" rows="4" placeholder="Contextes du projet"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('contexte')); ?></textarea>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $options['types_projet']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('type_projet') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                                    <?php $__currentLoopData = $options['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('categorie') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    <?php $__currentLoopData = $options['priorites']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('priorite', 'normale') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" id="budget_prevu" name="budget_prevu" value="<?php echo e(old('budget_prevu')); ?>" min="0" step="0.01" placeholder="0"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="budget_minimum" name="budget_minimum" value="<?php echo e(old('budget_minimum')); ?>" min="0" step="0.01" placeholder="0"
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="XOF" <?php echo e(old('devise', 'XOF') == 'XOF' ? 'selected' : ''); ?>>Franc CFA (XOF)</option>
                                    <option value="EUR" <?php echo e(old('devise') == 'EUR' ? 'selected' : ''); ?>>Euro (EUR)</option>
                                    <option value="USD" <?php echo e(old('devise') == 'USD' ? 'selected' : ''); ?>>Dollar US (USD)</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" id="date_fin_prevue" name="date_fin_prevue" value="<?php echo e(old('date_fin_prevue')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="duree_prevue_jours" name="duree_prevue_jours" value="<?php echo e(old('duree_prevue_jours')); ?>" min="1" placeholder="0"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $options['responsables']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($responsable['id']); ?>" <?php echo e(old('responsable_id') == $responsable['id'] ? 'selected' : ''); ?>><?php echo e($responsable['nom_complet']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $options['responsables']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($responsable['id']); ?>" <?php echo e(old('coordinateur_id') == $responsable['id'] ? 'selected' : ''); ?>><?php echo e($responsable['nom_complet']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $options['responsables']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($responsable['id']); ?>" <?php echo e(old('chef_projet_id') == $responsable['id'] ? 'selected' : ''); ?>><?php echo e($responsable['nom_complet']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" id="localisation" name="localisation" value="<?php echo e(old('localisation')); ?>" maxlength="200" placeholder="Ex: Site de l'église"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="region" name="region" value="<?php echo e(old('region')); ?>" maxlength="100" placeholder="Ex: District Autonome d'Abidjan"
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" id="visible_public" name="visible_public" value="1" <?php echo e(old('visible_public', false) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="ouvert_aux_dons" name="ouvert_aux_dons" value="1" <?php echo e(old('ouvert_aux_dons', true) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="necessite_approbation" name="necessite_approbation" value="1" <?php echo e(old('necessite_approbation', true) ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="projet_recurrent" name="projet_recurrent" value="1" <?php echo e(old('projet_recurrent') ? 'checked' : ''); ?>
                                ...
                                <div>
                                    ...
                                    <select id="frequence_recurrence" name="frequence_recurrence"
                                        ...
                                        <?php $__currentLoopData = $options['frequences_recurrence']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('frequence_recurrence') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <input type="url" id="site_web" name="site_web" value="<?php echo e(old('site_web')); ?>" placeholder="https://..."
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('private.projets.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/projets/create.blade.php ENDPATH**/ ?>