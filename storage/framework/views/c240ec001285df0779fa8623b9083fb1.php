...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-slate-500">Modification de "<?php echo e($classe->nom); ?>" -
                                <?php echo e($classe->nombre_inscrits); ?> membre(s) inscrit(s)</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <form action="<?php echo e(route('private.classes.update', $classe)); ?>" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="age_minimum" name="age_minimum"
                                    value="<?php echo e(old('age_minimum', $classe->age_minimum)); ?>" min="0" max="120"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="age_maximum" name="age_maximum"
                                    value="<?php echo e(old('age_maximum', $classe->age_maximum)); ?>" min="0" max="120"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                existingResponsables = <?php echo json_encode($classe->responsables ?? [], 15, 512) ?>;
