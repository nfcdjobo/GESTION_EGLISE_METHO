<?php $__env->startSection('title', 'Gestion des FIMECOs'); ?>
    ...
    <div class="space-y-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-500 mt-1">
                Financement et Mobilisation Collective - <?php echo e(\Carbon\Carbon::now()->locale('fr')->format('l d F Y')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($fimecos->total()); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($fimecos->where('statut', 'active')->count()); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($fimecos->where('statut_global', 'objectif_atteint')->count()); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($progressionMoyenne ?? 0, 1)); ?>%</p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.create')): ?>
                            <a href="<?php echo e(route('private.fimecos.create')); ?>"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.dashboard')): ?>
                            <a href="<?php echo e(route('private.fimecos.dashboard')); ?>"
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.export')): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.search')): ?>
                <div class="p-6">
                    <form method="GET" action="<?php echo e(route('private.fimecos.index')); ?>"
                        ...
                        <div>
                            ...
                            <select name="statut"
                                ...
                                <option value="active" <?php echo e(request('statut') === 'active' ? 'selected' : ''); ?>>Actif</option>
                                <option value="inactive" <?php echo e(request('statut') === 'inactive' ? 'selected' : ''); ?>>Inactif</option>
                                <option value="cloturee" <?php echo e(request('statut') === 'cloturee' ? 'selected' : ''); ?>>Clôturé</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="statut_global"
                                ...
                                <option value="objectif_atteint" <?php echo e(request('statut_global') === 'objectif_atteint' ? 'selected' : ''); ?>>Objectif atteint</option>
                                <option value="presque_atteint" <?php echo e(request('statut_global') === 'presque_atteint' ? 'selected' : ''); ?>>Presque atteint</option>
                                <option value="en_cours" <?php echo e(request('statut_global') === 'en_cours' ? 'selected' : ''); ?>>En cours</option>
                                <option value="tres_faible" <?php echo e(request('statut_global') === 'tres_faible' ? 'selected' : ''); ?>>Très faible</option>
                            </select>
                        </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            <div class="p-6 border-b border-slate-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <h2 class="text-xl font-bold text-slate-800 flex items-center">
                        ...
                        Liste des FIMECOs (<?php echo e($fimecos->total()); ?>)
                    </h2>
                    <div class="flex items-center space-x-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                            <?php echo e($fimecos->total()); ?> résultats
                        </span>
                        <?php if($fimecos->hasPages()): ?>
                            <span class="text-sm text-slate-600">
                                Page <?php echo e($fimecos->currentPage()); ?> sur <?php echo e($fimecos->lastPage()); ?>
            ...
            <div class="p-6">
                <?php if($fimecos->count() > 0): ?>
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            <thead>
                                <tr class="border-b border-slate-200">
                                    <th class="px-4 py-3 text-left text-xs font-bold text-slate-700 uppercase tracking-wider">
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'nom', 'sort_direction' => request('sort_direction') === 'asc' ? 'desc' : 'asc'])); ?>"
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-bold text-slate-700 uppercase tracking-wider">
                                        <a href="<?php echo e(request()->fullUrlWithQuery(['sort_by' => 'debut', 'sort_direction' => request('sort_direction') === 'asc' ? 'desc' : 'asc'])); ?>"
                                            class="group inline-flex items-center hover:text-blue-600 transition-colors">
                                            Période
                                            <span class="ml-2 flex-none rounded text-slate-400 group-hover:text-blue-500">
                                                <i class="fas fa-sort"></i>
                            ...
                            <tbody class="divide-y divide-slate-200">
                                <?php $__currentLoopData = $fimecos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fimeco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200">
                                            ...
                                            <div>
                                                ...
                                                <?php if($fimeco->description): ?>
                                                    <div class="text-xs text-slate-500 mt-1">
                                                        <?php echo e(Str::limit($fimeco->description, 40)); ?>

                                                    </div>
                                                <?php endif; ?>
                                                <?php if($fimeco->responsable): ?>
                                                    <div class="text-xs text-blue-600 mt-1">
                                                        <i class="fas fa-user mr-1"></i>
                                                        <?php echo e(Str::limit($fimeco->responsable->nom_complet , 40)); ?>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="text-sm text-slate-900">
                                                <?php echo e($fimeco->debut->format('d/m/Y')); ?> - <?php echo e($fimeco->fin->format('d/m/Y')); ?>

                                            </div>
                                            <div class="text-xs text-slate-500">
                                                <?php if($fimeco->jours_restants > 0): ?>
                                                    <?php echo e($fimeco->jours_restants); ?> jours restants
                                                <?php elseif($fimeco->en_retard): ?>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="space-y-1">
                                                <div class="text-sm font-medium text-slate-900">
                                                    Cible: <?php echo e(number_format($fimeco->cible, 0, ',', ' ')); ?> FCFA
                                                </div>
                                                <div class="text-sm text-slate-600">
                                                    Collecté: <?php echo e(number_format($fimeco->montant_solde, 0, ',', ' ')); ?> FCFA
                                                </div>
                                                <?php if($fimeco->montant_supplementaire > 0): ?>
                                                    <div class="text-xs text-green-600">
                                                        Supplément: +<?php echo e(number_format($fimeco->montant_supplementaire, 0, ',', ' ')); ?> FCFA
                                                    </div>
                                                <?php elseif($fimeco->reste > 0): ?>
                                                    <div class="text-xs text-orange-600">
                                                        Reste: <?php echo e(number_format($fimeco->reste, 0, ',', ' ')); ?> FCFA
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                            ...
                                            <div class="space-y-2">
                                                <div class="flex items-center space-x-2">
                                                    <div class="flex-1 bg-slate-200 rounded-full h-2">
                                                        <div class="h-2 rounded-full <?php echo e($fimeco->progression >= 100 ? 'bg-green-500' : ($fimeco->progression >= 75 ? 'bg-blue-500' : ($fimeco->progression >= 50 ? 'bg-yellow-500' : 'bg-red-500'))); ?>"
                                                             style="width: <?php echo e(min($fimeco->progression, 100)); ?>%"></div>
                                                    </div>
                                                    <span class="text-xs font-medium text-slate-700">
                                                        <?php echo e(number_format($fimeco->progression, 1)); ?>%
                                                    </span>
                                                </div>
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                    <?php if($fimeco->statut_global === 'objectif_atteint'): ?> bg-green-100 text-green-800
                                                    <?php elseif($fimeco->statut_global === 'presque_atteint'): ?> bg-blue-100 text-blue-800
                                                    <?php elseif($fimeco->statut_global === 'en_cours'): ?> bg-yellow-100 text-yellow-800
                                                    <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                                    <?php echo e(ucfirst(str_replace('_', ' ', $fimeco->statut_global))); ?>
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="flex flex-col items-center w-6 mr-1">
                                                    <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-blue-800 bg-blue-100 rounded-full">
                                                        <?php echo e($fimeco->subscriptions->count()); ?>
                                                ...
                                                <div class="flex flex-col items-center w-6 mr-1">
                                                    <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-red-800 bg-red-100 rounded-full">
                                                        <?php echo e($fimeco->subscriptions->where('statut', '!=', 'inactive')->count()); ?>
                                                ...
                                                <div class="flex flex-col items-center w-6">
                                                    <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-green-800 bg-green-100 rounded-full">
                                                        <?php echo e($fimeco->subscriptions->where('statut', 'partiellement_payee')->count()); ?>
                                                ...
                                                <div class="flex flex-col items-center w-6">
                                                    <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-purple-800 bg-purple-100 rounded-full">
                                                        <?php echo e($fimeco->subscriptions->where('statut', 'completement_payee')->count()); ?>
                                        ...
                                        <td class="px-4 py-4">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                ...
                                                <?php elseif($fimeco->statut === 'cloturee'): ?> bg-gray-100 text-gray-800
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center justify-end space-x-2">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.read')): ?>
                                                    <a href="<?php echo e(route('private.fimecos.show', $fimeco)); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.update')): ?>
                                                    <a href="<?php echo e(route('private.fimecos.edit', $fimeco)); ?>"
                                                ...
                                                <?php elseif($fimeco->statut === 'cloturee'): ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.delete')): ?>
                                                    <button onclick="deleteFimeco('<?php echo e($fimeco->id); ?>')"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-6 border-t border-slate-200">
                        <div class="text-sm text-slate-700">
                            Affichage de <span class="font-medium"><?php echo e($fimecos->firstItem()); ?></span> à <span
                                class="font-medium"><?php echo e($fimecos->lastItem()); ?></span> sur <span
                                class="font-medium"><?php echo e($fimecos->total()); ?></span> résultats
                        </div>
                        <div>
                            <?php echo e($fimecos->appends(request()->query())->links()); ?>
                ...
                <?php else: ?>
                    <div class="text-center py-12">
                        ...
                        <p class="text-slate-500 mb-6">
                            <?php if(request()->hasAny(['search', 'statut', 'statut_global', 'date_debut', 'date_fin'])): ?>
        ...
        <script>
            function deleteFimeco(fimecoId) {
                if (confirm('Êtes-vous sûr de vouloir supprimer ce FIMECO ?')) {
                    const url = "<?php echo e(route('private.fimecos.destroy', ':fimecoid')); ?>".replace(':fimecoid', fimecoId);
            ...
            function confirmExport() {
                if (selectedFormat) {
                    window.location.href = `<?php echo e(route('private.fimecos.export')); ?>?format=${selectedFormat}`;
                    closeExportModal();
                } else {
