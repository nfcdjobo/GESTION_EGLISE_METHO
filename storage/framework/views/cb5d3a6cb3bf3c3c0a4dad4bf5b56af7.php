<?php $__env->startSection('title', 'Statistiques des Permissions'); ?>
...
<div class="space-y-8">
    ...
    <div class="mb-8">
        ...
        <nav class="flex mt-2" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('private.permissions.index')); ?>" class="inline-flex items-center text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">
        ...
        <p class="text-slate-500 mt-1">Analyse détaillée de l'utilisation des permissions - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('private.permissions.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($general['total_permissions']); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($general['active_permissions']); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($general['system_permissions']); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($general['user_permissions']); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($general['unused_permissions']); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
                <?php if($by_category->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $by_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3 flex-1">
                                    ...
                                    <span class="font-medium text-slate-900"><?php echo e(ucfirst($category->category ?: 'Non définie')); ?></span>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <div class="w-24 bg-slate-200 rounded-full h-2">
                                        <div class="<?php echo e($color); ?> h-2 rounded-full" style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                    <span class="text-sm font-medium text-slate-700 w-16 text-right"><?php echo e($category->count); ?> (<?php echo e($percentage); ?>%)</span>
                                </div>
                            </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
                <?php if($by_action->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $by_action; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-3 flex-1">
                                    <div class="w-4 h-4 <?php echo e($color); ?> rounded-full"></div>
                                    <span class="font-medium text-slate-900"><?php echo e(ucfirst($action->action)); ?></span>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <div class="w-24 bg-slate-200 rounded-full h-2">
                                        <div class="<?php echo e($color); ?> h-2 rounded-full" style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                    <span class="text-sm font-medium text-slate-700 w-16 text-right"><?php echo e($action->count); ?> (<?php echo e($percentage); ?>%)</span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <div class="p-6">
            <?php if($by_resource->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $by_resource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $percentage = $general['total_permissions'] > 0 ? round(($resource->count / $general['total_permissions']) * 100, 1) : 0;
                        ?>
                        <div class="p-4 bg-slate-50 rounded-xl">
                            <div class="flex items-center justify-between mb-2">
                                <span class="font-medium text-slate-900"><?php echo e($resource->resource); ?></span>
                                <span class="text-sm font-medium text-slate-700"><?php echo e($resource->count); ?></span>
                            </div>
                            <div class="w-full bg-slate-200 rounded-full h-2">
                                <div class="bg-purple-500 h-2 rounded-full" style="width: <?php echo e($percentage); ?>%"></div>
                            </div>
                            <div class="text-xs text-slate-500 mt-1"><?php echo e($percentage); ?>% du total</div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php else: ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
                <?php if($most_used->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $most_used; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <div class="font-medium text-slate-900"><?php echo e($permission->name); ?></div>
                                        <div class="text-sm text-slate-500"><?php echo e($permission->resource); ?>.<?php echo e($permission->action); ?></div>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <div class="text-sm font-medium text-slate-700"><?php echo e($permission->last_used_at->diffForHumans()); ?></div>
                                    <div class="text-xs text-slate-500"><?php echo e($permission->last_used_at->format('d/m/Y H:i')); ?></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
                <?php if($never_used->count() > 0): ?>
                    <div class="space-y-4 max-h-64 overflow-y-auto">
                        <?php $__currentLoopData = $never_used; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 bg-red-50 rounded-xl border border-red-100">
                                ...
                                <div class="text-right">
                                    <div class="text-sm font-medium text-red-700">Créée <?php echo e($permission->created_at->diffForHumans()); ?></div>
                                    <div class="text-xs text-red-600"><?php echo e($permission->created_at->format('d/m/Y')); ?></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
        ...
        <div class="flex items-start space-x-4">
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php if($general['unused_permissions'] > 0): ?>
                        <div class="flex items-start space-x-2">
                            <i class="fas fa-exclamation-triangle text-amber-500 mt-1"></i>
                            <div>
                                <p class="font-medium text-slate-800">Permissions non utilisées</p>
                                <p class="text-sm text-slate-600"><?php echo e($general['unused_permissions']); ?> permissions n'ont jamais été utilisées. Considérez leur suppression.</p>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if($by_category->where('category', null)->first()): ?>
                        <div class="flex items-start space-x-2">
                            <i class="fas fa-tag text-blue-500 mt-1"></i>
                            <div>
                                <p class="font-medium text-slate-800">Permissions sans catégorie</p>
                                <p class="text-sm text-slate-600"><?php echo e($by_category->where('category', null)->first()->count ?? 0); ?> permissions n'ont pas de catégorie définie.</p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($ratio > 70): ?>
                        <div class="flex items-start space-x-2">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600"><?php echo e($ratio); ?>% de permissions système. Considérez plus de permissions personnalisées.</p>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="flex items-start space-x-2">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-600">
                                ...
                                <?php elseif($general['unused_permissions'] < 5): ?>
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/permissions/statistics.blade.php ENDPATH**/ ?>