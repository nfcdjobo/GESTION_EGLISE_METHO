...
function envoyerRappel() {
    ...
    fetch(`<?php echo e(route('private.reunions.envoyer-rappel', ':reunion')); ?>`.replace(':reunion', reunionId), {
        method: 'POST',
        headers: {
...
<?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/reunions/modals/rappel.blade.php ENDPATH**/ ?>