...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
            <h1 class="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Galerie Multimédia</h1>
            <p class="text-slate-500 mt-1">Gestion de la médiathèque de la communauté - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
        </div>
    </div>
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('private.multimedia.create')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('moderate_media')): ?>
                        <a href="<?php echo e(route('private.multimedia.moderation.queue')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white text-sm font-medium rounded-xl hover:from-orange-700 hover:to-red-700 transition-all duration-200 shadow-md hover:shadow-lg">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('private.multimedia.galerie')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-sm font-medium rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
                        <i class="fas fa-eye mr-2"></i> Vue Publique
                    </a>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_media')): ?>
                        <a href="<?php echo e(route('private.multimedia.statistiques')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-sm font-medium rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <form method="GET" action="<?php echo e(route('private.multimedia.index')); ?>" class="space-y-6" id="filterForm">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            <input type="text" name="search" value="<?php echo e($currentFilters['search'] ?? ''); ?>" placeholder="Titre, description, photographe, lieu..." class="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    ...
                    <div>
                        ...
                        <select name="event_id" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            <option value="">Tous les événements</option>
                            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($event->id); ?>" <?php echo e(($currentFilters['event_id'] ?? '') == $event->id ? 'selected' : ''); ?>>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                    <div>
                        ...
                        <select name="type_media" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            ...
                            <?php $__currentLoopData = $filters['types_media']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(($currentFilters['type_media'] ?? '') == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
                    ...
                    <div>
                        ...
                        <select name="categorie" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            ...
                            <?php $__currentLoopData = $filters['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(($currentFilters['categorie'] ?? '') == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
                    ...
                    <div>
                        ...
                        <select name="statut_moderation" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            ...
                            <?php $__currentLoopData = $filters['statuts_moderation']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(($currentFilters['statut_moderation'] ?? '') == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
                    ...
                    <div>
                        ...
                        <select name="niveau_acces" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            ...
                            <?php $__currentLoopData = $filters['niveaux_acces']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(($currentFilters['niveau_acces'] ?? '') == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
                    ...
                    <div>
                        ...
                        <select name="telecharge_par" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            ...
                            <?php $__currentLoopData = $uploaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uploader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($uploader->id); ?>" <?php echo e(($currentFilters['telecharge_par'] ?? '') == $uploader->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <div class="space-y-2 pt-1">
                            <label class="flex items-center">
                                <input type="checkbox" name="featured_only" value="1" <?php echo e(request('featured_only') ? 'checked' : ''); ?> class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                <span class="ml-2 text-sm text-slate-700">À la une uniquement</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="visible_only" value="1" <?php echo e(request('visible_only') ? 'checked' : ''); ?> class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                ...
                <div class="flex gap-2 pt-4">
                    <button type="submit" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors">
                        <i class="fas fa-search mr-2"></i> Filtrer
                    </button>
                    <a href="<?php echo e(route('private.multimedia.index')); ?>" class="inline-flex items-center px-6 py-3 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-colors">
                        <i class="fas fa-refresh mr-2"></i> Réinitialiser
                    </a>
                    <button type="button" onclick="toggleAdvancedFilters()" class="inline-flex items-center px-4 py-3 bg-gray-100 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-200 transition-colors">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($multimedia->where('type_media', 'image')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($multimedia->where('type_media', 'video')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($multimedia->where('type_media', 'audio')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($multimedia->where('est_featured', true)->count()); ?></p>
        ...
        <div id="bulkActions" class="hidden bg-amber-50 border border-amber-200 rounded-2xl p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <button type="button" onclick="bulkAction('approve')" class="inline-flex items-center px-3 py-1.5 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors">
                        <i class="fas fa-check mr-1"></i> Approuver
                    </button>
                    <button type="button" onclick="bulkAction('reject')" class="inline-flex items-center px-3 py-1.5 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition-colors">
                        <i class="fas fa-times mr-1"></i> Rejeter
                    </button>
                    <button type="button" onclick="bulkAction('delete')" class="inline-flex items-center px-3 py-1.5 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors">
                        <i class="fas fa-trash mr-1"></i> Supprimer
                    </button>
                    <button type="button" onclick="clearSelection()" class="inline-flex items-center px-3 py-1.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors">
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <div class="p-6">
            <?php if($multimedia->count() > 0): ?>
                ...
                <div id="gridView" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    <?php $__currentLoopData = $multimedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="group relative bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('moderate_media')): ?>
                                <div class="absolute top-2 left-2 z-10">
                                    <input type="checkbox" name="selected_media[]" value="<?php echo e($media->id); ?>" class="w-4 h-4 text-blue-600 bg-white border-gray-300 rounded focus:ring-blue-500 media-checkbox">
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="aspect-square relative overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                                <?php if($media->est_image && $media->url_miniature): ?>
                                    <img src="<?php echo e(asset($media->url_miniature)); ?>" alt="<?php echo e($media->alt_text ?? $media->titre); ?>" class="w-full h-full object-cover">
                                <?php elseif($media->est_image && $media->url_complete): ?>
                                    <img src="<?php echo e(asset($media->url_complete)); ?>" alt="<?php echo e($media->alt_text ?? $media->titre); ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center">
                                        <div class="text-center">
                                            ...
                                            <?php endif; ?>
                                            <p class="text-xs text-slate-500 uppercase font-medium"><?php echo e($media->extension); ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex flex-wrap gap-1">
                                                <?php if($media->est_featured): ?>
                                                    <span class="inline-flex items-center px-1.5 py-0.5 bg-yellow-500 text-white text-xs rounded">
                                                        <i class="fas fa-star mr-1"></i>
                                                    </span>
                                                <?php endif; ?>
                                                <?php if($media->statut_moderation == 'en_attente'): ?>
                                                    <span class="inline-flex items-center px-1.5 py-0.5 bg-orange-500 text-white text-xs rounded">
                                                        <i class="fas fa-clock mr-1"></i>
                                                    </span>
                                                <?php elseif($media->statut_moderation == 'approuve'): ?>
                                                    <span class="inline-flex items-center px-1.5 py-0.5 bg-green-500 text-white text-xs rounded">
                                                        <i class="fas fa-check mr-1"></i>
                                                    </span>
                                                <?php elseif($media->statut_moderation == 'rejete'): ?>
                                                    <span class="inline-flex items-center px-1.5 py-0.5 bg-red-500 text-white text-xs rounded">
                                ...
                                <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div class="flex flex-col space-y-1">
                                        <a href="<?php echo e(route('private.multimedia.show', $media)); ?>" class="inline-flex items-center justify-center w-8 h-8 bg-white/90 text-slate-700 rounded-lg hover:bg-white transition-colors" title="Voir">
                                            <i class="fas fa-eye text-sm"></i>
                                        </a>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $media)): ?>
                                            <a href="<?php echo e(route('private.multimedia.edit', $media)); ?>" class="inline-flex items-center justify-center w-8 h-8 bg-white/90 text-slate-700 rounded-lg hover:bg-white transition-colors" title="Modifier">
                                                <i class="fas fa-edit text-sm"></i>
                                            </a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('private.multimedia.download', $media)); ?>" class="inline-flex items-center justify-center w-8 h-8 bg-white/90 text-slate-700 rounded-lg hover:bg-white transition-colors" title="Télécharger">
                            ...
                            <div class="p-4">
                                <div class="mb-2">
                                    <h3 class="font-semibold text-slate-900 text-sm line-clamp-2 mb-1"><?php echo e($media->titre); ?></h3>
                                ...
                                <div class="mt-3 flex items-center justify-between">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('moderate_media')): ?>
                                        <div class="flex items-center space-x-1">
                                            <?php if($media->statut_moderation == 'en_attente'): ?>
                                                <button type="button" onclick="moderateMedia('<?php echo e($media->id); ?>', 'approve')" class="text-green-600 hover:text-green-700 transition-colors" title="Approuver">
                                                    <i class="fas fa-check text-sm"></i>
                                                </button>
                                                <button type="button" onclick="moderateMedia('<?php echo e($media->id); ?>', 'reject')" class="text-red-600 hover:text-red-700 transition-colors" title="Rejeter">
                                                    <i class="fas fa-times text-sm"></i>
                                                </button>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feature_media')): ?>
                                                <button type="button" onclick="toggleFeatured('<?php echo e($media->id); ?>')" class="text-yellow-600 hover:text-yellow-700 transition-colors <?php echo e($media->est_featured ? 'opacity-100' : 'opacity-50'); ?>" title="Mettre à la une">
                ...
                <div id="listView" class="hidden space-y-4">
                    <?php $__currentLoopData = $multimedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center space-x-4 p-4 bg-white border border-slate-200 rounded-xl hover:shadow-md transition-all duration-300">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('moderate_media')): ?>
                                <div class="flex-shrink-0">
                                    <input type="checkbox" name="selected_media[]" value="<?php echo e($media->id); ?>" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 media-checkbox">
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-slate-100 to-slate-200 rounded-lg overflow-hidden">
                                <?php if($media->est_image && $media->url_miniature): ?>
                                    <img src="<?php echo e(asset($media->url_miniature)); ?>" alt="<?php echo e($media->titre); ?>" class="w-full h-full object-cover">
                                <?php else: ?>
                                    <div class="w-full h-full flex items-center justify-center">
                                        <?php if($media->type_media == 'video'): ?>
                            ...
                            <!-- Actions -->
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo e(route('private.multimedia.show', $media)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-cyan-600 bg-cyan-100 rounded-lg hover:bg-cyan-200 transition-colors" title="Voir">
                                    <i class="fas fa-eye text-sm"></i>
                                </a>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $media)): ?>
                                    <a href="<?php echo e(route('private.multimedia.edit', $media)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-yellow-600 bg-yellow-100 rounded-lg hover:bg-yellow-200 transition-colors" title="Modifier">
                                        <i class="fas fa-edit text-sm"></i>
                                    </a>
                                <?php endif; ?>
                                <a href="<?php echo e(route('private.multimedia.download', $media)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-blue-600 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors" title="Télécharger">
                                    <i class="fas fa-download text-sm"></i>
                                </a>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('moderate_media')): ?>
                                    <?php if($media->statut_moderation == 'en_attente'): ?>
                                        <button type="button" onclick="moderateMedia('<?php echo e($media->id); ?>', 'approve')" class="inline-flex items-center justify-center w-8 h-8 text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors" title="Approuver">
                                            <i class="fas fa-check text-sm"></i>
                                        </button>
                                        <button type="button" onclick="moderateMedia('<?php echo e($media->id); ?>', 'reject')" class="inline-flex items-center justify-center w-8 h-8 text-red-600 bg-red-100 rounded-lg hover:bg-red-200 transition-colors" title="Rejeter">
                                            <i class="fas fa-times text-sm"></i>
                                        </button>
                                    <?php endif; ?>
                                <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-8 pt-6 border-t border-slate-200">
                    <div class="text-sm text-slate-700">
                        Affichage de <span class="font-medium"><?php echo e($multimedia->firstItem()); ?></span> à <span class="font-medium"><?php echo e($multimedia->lastItem()); ?></span>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <a href="<?php echo e(route('private.multimedia.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
                        <i class="fas fa-upload mr-2"></i> Télécharger un média
                    </a>
                </div>
            <?php endif; ?>
    ...
    <div id="moderationModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full">
            <div class="p-6">
                ...
                <p class="text-slate-600 mb-4" id="moderationMessage">Êtes-vous sûr de vouloir effectuer cette action ?</p>
        ...
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full">
            <div class="p-6">
                ...
                <div id="bulkCommentSection" class="mb-4">
                    ...
                    <textarea id="bulkComment" rows="3" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Commentaire optionnel..."></textarea>
                </div>
            </div>
            <div class="flex items-center justify-end space-x-3 p-6 border-t border-slate-200">
                <button type="button" onclick="closeBulkModal()" class="px-4 py-2 text-slate-700 bg-slate-100 rounded-xl hover:bg-slate-200 transition-colors">
                    Annuler
                </button>
                <button type="button" id="confirmBulk" class="px-4 py-2 bg-amber-600 text-white rounded-xl hover:bg-amber-700 transition-colors">
                    Confirmer
                </button>
            </div>
        </div>
...
function toggleFeatured(mediaId) {
    fetch(`<?php echo e(route('private.multimedia.index')); ?>/${mediaId}/toggle-featured`, {
        method: 'PATCH',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Accept': 'application/json'
