                            ...
                            <div
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="mt-3 flex items-center justify-between">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['multimedia.approve', 'multimedia.reject', 'multimedia.toggle-featured'])): ?>
                                            <div class="flex items-center space-x-1">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['multimedia.approve', 'multimedia.reject'])): ?>
                                                    <?php if($media->statut_moderation == 'en_attente'): ?>
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('multimedia.approve')): ?>
                                                            <button type="button"
