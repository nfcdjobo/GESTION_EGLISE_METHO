            ...
            <form id="temoignageForm">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="<?php $__errorArgs = ['details_complementaires'];
...
function enregistrerTemoignage() {
    ...
    fetch(`<?php echo e(route('private.reunions.temoignages', ':reunion')); ?>`.replace(':reunion', reunionId), {
        method: 'POST',
        headers: {
...
<?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/reunions/modals/temoignage.blade.php ENDPATH**/ ?>