<?php $__env->startSection('title', 'Tableau de Bord des Événements'); ?>
...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
            ...
            <p class="text-slate-500 mt-1">Vue d'ensemble des activités - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.planning')): ?>
                <a href="<?php echo e(route('private.events.planning')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-medium rounded-xl hover:from-cyan-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg">
                ...
                <a href="<?php echo e(route('private.events.statistiques')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
                    <i class="fas fa-chart-line mr-2"></i> Statistiques
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('private.events.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 shadow-md hover:shadow-lg">
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6 border-b border-slate-200">
            <h2 class="text-xl font-bold text-slate-800 flex items-center">
                ...
                Aujourd'hui - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        <div class="text-center p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-xl">
                            ...
                            <div class="text-3xl font-bold text-orange-600"><?php echo e($dashboard['aujourd_hui']['nombre']); ?></div>
                            <div class="text-orange-800 font-medium">Événement<?php echo e($dashboard['aujourd_hui']['nombre'] > 1 ? 's' : ''); ?> aujourd'hui</div>
                        </div>
                    </div>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $dashboard['aujourd_hui']['events']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center space-x-3 p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                                <div class="flex-shrink-0">
                                    <?php if($event->image_principale): ?>
                                        <img src="<?php echo e($event->image_principale); ?>" alt="<?php echo e($event->titre); ?>" class="w-12 h-12 object-cover rounded-lg">
                                    <?php else: ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-medium text-slate-900 truncate">
                                        <a href="<?php echo e(route('private.events.show', $event)); ?>" class="hover:text-blue-600 transition-colors"><?php echo e($event->titre); ?></a>
                                    </h3>
                                    <div class="text-sm text-slate-500 flex items-center space-x-2">
                                        <span><i class="fas fa-clock mr-1"></i><?php echo e($event->heure_debut ? \Carbon\Carbon::parse($event->heure_debut)->format('H:i') : '--'); ?></span>
                                        <span><i class="fas fa-map-marker-alt mr-1"></i><?php echo e($event->lieu_nom); ?></span>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                        <?php if($event->statut == 'planifie'): ?> bg-blue-100 text-blue-800
                                        <?php elseif($event->statut == 'en_cours'): ?> bg-green-100 text-green-800
                                        <?php else: ?> bg-slate-100 text-slate-800
                                        <?php endif; ?>">
                                        <?php echo e(ucfirst($event->statut)); ?>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center p-4 bg-blue-50 rounded-xl">
                        <div class="text-2xl font-bold text-blue-600"><?php echo e($dashboard['cette_semaine']['events_a_venir']); ?></div>
                        <div class="text-sm text-blue-800">À venir</div>
                    </div>
                    <div class="text-center p-4 bg-green-50 rounded-xl">
                        <div class="text-2xl font-bold text-green-600"><?php echo e($dashboard['cette_semaine']['events_termines']); ?></div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center p-4 bg-purple-50 rounded-xl">
                        <div class="text-2xl font-bold text-purple-600"><?php echo e($dashboard['ce_mois']['total_events']); ?></div>
                        <div class="text-sm text-purple-800">Événements</div>
                    </div>
                    <div class="text-center p-4 bg-indigo-50 rounded-xl">
                        <div class="text-2xl font-bold text-indigo-600"><?php echo e($dashboard['ce_mois']['events_publics']); ?></div>
                        <div class="text-sm text-indigo-800">Publics</div>
                    </div>
                </div>
                <div class="mt-4 grid grid-cols-2 gap-4">
                    <div class="text-center p-4 bg-cyan-50 rounded-xl">
                        <div class="text-2xl font-bold text-cyan-600"><?php echo e(number_format($dashboard['ce_mois']['total_participants'])); ?></div>
                        <div class="text-sm text-cyan-800">Participants</div>
                    </div>
                    <div class="text-center p-4 bg-emerald-50 rounded-xl">
                        <div class="text-2xl font-bold text-emerald-600"><?php echo e(number_format($dashboard['ce_mois']['total_recettes'])); ?></div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6 border-b border-slate-200">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('private.events.planning')); ?>" class="text-sm text-blue-600 hover:text-blue-800 transition-colors">
                    Voir le planning complet <i class="fas fa-arrow-right ml-1"></i>
                </a>
            </div>
        </div>
        <div class="p-6">
            <?php if($dashboard['prochains_events']->count() > 0): ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $dashboard['prochains_events']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center space-x-4 p-4 border border-slate-200 rounded-xl hover:shadow-md transition-all duration-200">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="font-semibold text-slate-900 hover:text-blue-600 transition-colors">
                                    <a href="<?php echo e(route('private.events.show', $event)); ?>"><?php echo e($event->titre); ?></a>
                                </h3>
                                <?php if($event->sous_titre): ?>
                                    <p class="text-sm text-slate-600"><?php echo e($event->sous_titre); ?></p>
                                <?php endif; ?>
                                <div class="flex items-center space-x-4 mt-1 text-sm text-slate-500">
                                    <span><i class="fas fa-calendar mr-1"></i><?php echo e($event->date_debut->format('d/m/Y')); ?></span>
                                    <span><i class="fas fa-clock mr-1"></i><?php echo e($event->heure_debut ? \Carbon\Carbon::parse($event->heure_debut)->format('H:i') : '--'); ?></span>
                                    <span><i class="fas fa-map-marker-alt mr-1"></i><?php echo e($event->lieu_nom); ?></span>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                <?php if($event->inscription_requise): ?>
                                    <div class="text-center">
                                        <div class="text-lg font-bold text-green-600"><?php echo e($event->nombre_inscrits); ?></div>
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                    ...
                                    <?php switch($event->statut):
                                        case ('planifie'): ?> Planifié <?php break; ?>
                                        <?php case ('en_promotion'): ?> En promotion <?php break; ?>
                                        <?php case ('ouvert_inscription'): ?> Inscriptions ouvertes <?php break; ?>
                                        <?php default: ?> Brouillon <?php break; ?>
                                    <?php endswitch; ?>
                                </span>
                                <?php if($event->organisateurPrincipal): ?>
                                    <div class="text-center">
                                        <div class="text-xs text-slate-500">Organisateur</div>
                                        <div class="text-sm font-medium text-slate-700"><?php echo e($event->organisateurPrincipal->prenom); ?> <?php echo e($event->organisateurPrincipal->nom); ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <div class="text-center py-8">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.create')): ?>
                        <a href="<?php echo e(route('private.events.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center p-6 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl">
                    ...
                    <div class="text-2xl font-bold text-amber-600"><?php echo e($dashboard['statistiques_rapides']['note_moyenne_mois']); ?><span class="text-lg">/10</span></div>
                ...
                <div class="text-center p-6 bg-gradient-to-r from-rose-50 to-pink-50 rounded-xl">
                    ...
                    <div class="text-2xl font-bold text-rose-600"><?php echo e($dashboard['statistiques_rapides']['taux_inscription']); ?>%</div>
                ...
                <div class="text-center p-6 bg-gradient-to-r from-violet-50 to-purple-50 rounded-xl">
                    ...
                    <div class="text-2xl font-bold text-violet-600"><?php echo e($dashboard['cette_semaine']['events_a_venir'] + $dashboard['cette_semaine']['events_termines']); ?></div>
                ...
                <div class="text-center p-6 bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl">
                    ...
                    <div class="text-2xl font-bold text-teal-600">+<?php echo e(number_format(($dashboard['ce_mois']['total_events'] / max($dashboard['cette_semaine']['events_a_venir'] + $dashboard['cette_semaine']['events_termines'], 1) - 1) * 100, 0)); ?>%</div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.create')): ?>
                    <a href="<?php echo e(route('private.events.create')); ?>" class="flex items-center p-4 border border-slate-200 rounded-xl hover:shadow-md hover:border-blue-300 transition-all duration-200 group">
                ...
                <a href="<?php echo e(route('private.events.planning')); ?>" class="flex items-center p-4 border border-slate-200 rounded-xl hover:shadow-md hover:border-green-300 transition-all duration-200 group">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.statistics')): ?>
                <a href="<?php echo e(route('private.events.statistiques')); ?>" class="flex items-center p-4 border border-slate-200 rounded-xl hover:shadow-md hover:border-purple-300 transition-all duration-200 group">
                ...
                <a href="<?php echo e(route('private.events.index', ['statut' => 'ouvert_inscription'])); ?>" class="flex items-center p-4 border border-slate-200 rounded-xl hover:shadow-md hover:border-cyan-300 transition-all duration-200 group">
                ...
                <a href="<?php echo e(route('private.events.index', ['a_venir' => 1])); ?>" class="flex items-center p-4 border border-slate-200 rounded-xl hover:shadow-md hover:border-orange-300 transition-all duration-200 group">
                ...
                <a href="<?php echo e(route('private.events.index', ['termines' => 1])); ?>" class="flex items-center p-4 border border-slate-200 rounded-xl hover:shadow-md hover:border-emerald-300 transition-all duration-200 group">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/events/dashboard.blade.php ENDPATH**/ ?>