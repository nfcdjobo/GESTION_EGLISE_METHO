<?php $__env->startSection('title', 'Nouveau Paiement'); ?>
...
<div class="space-y-8">
    ...
    <?php else: ?>
        ...
        <form action="<?php echo e(route('private.paiements.store')); ?>" method="POST" id="paymentForm" class="space-y-8">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="subscription_id" value="<?php echo e(request('subscription')); ?>">
                    ...
                    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="montant" name="montant" value="<?php echo e(old('montant')); ?>"
                                       required min="1" step="0.01" placeholder="<?php echo e($montantSuggere); ?>" onchange="updatePreview()"
                                       class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['montant'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select id="type_paiement" name="type_paiement" required onchange="updateReferenceField()"
                                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['type_paiement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="especes" <?php echo e(old('type_paiement') == 'especes' ? 'selected' : ''); ?>>Espèces</option>
                                    <option value="cheque" <?php echo e(old('type_paiement') == 'cheque' ? 'selected' : ''); ?>>Chèque</option>
                                    <option value="virement" <?php echo e(old('type_paiement') == 'virement' ? 'selected' : ''); ?>>Virement bancaire</option>
                                    <option value="carte" <?php echo e(old('type_paiement') == 'carte' ? 'selected' : ''); ?>>Carte bancaire</option>
                                    <option value="mobile_money" <?php echo e(old('type_paiement') == 'mobile_money' ? 'selected' : ''); ?>>Mobile Money</option>
                                </select>
                                <?php $__errorArgs = ['type_paiement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="reference_paiement" name="reference_paiement"
                                       value="<?php echo e(old('reference_paiement')); ?>" maxlength="100"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" id="date_paiement" name="date_paiement"
                                       value="<?php echo e(old('date_paiement', date('Y-m-d'))); ?>"
                                       required max="<?php echo e(date('Y-m-d')); ?>"
                                       class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['date_paiement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
                    ...
                    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span id="preview-date" class="text-sm text-slate-600"><?php echo e(date('d/m/Y')); ?></span>
                            </div>
                            <div class="flex items-center justify-between">
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <a href="<?php echo e(route('private.paiements.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
...
<?php if(!request('subscription_id')): ?>
    ...
    setTimeout(() => {
        ...
        subscriptionsList.innerHTML = `
            <div class="text-center py-8 col-span-full">
                ...
                <a href="<?php echo e(route('private.subscriptions.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/paiements/create.blade.php ENDPATH**/ ?>