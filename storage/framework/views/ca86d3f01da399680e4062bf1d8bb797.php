...
<body style="font-family: 'DejaVu Sans', Arial, sans-serif; font-size: 9px; line-height: 1.3; color: #1f2937; margin: 0; padding: 0;">
    ...
    <div style="text-align: center; padding: 15px 0; margin: 20px 0; border-bottom: 3px solid #3b82f6;">
        ...
        <p style="color: #6b7280; font-size: 10px; margin: 0;">
            Export consolidé - Total: <?php echo e($totalAnnonces); ?> annonce(s) - Généré le <?php echo e($dateGeneration); ?>
    ...
    <div style="margin-bottom: 25px;">
        ...
        <div style="width: 100%; margin-bottom: 15px;">
            <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                ...
                <div style="font-size: 12px; font-weight: bold; color: #3b82f6;"><?php echo e(number_format($stats['total'], 0, ',', ' ')); ?></div>
            </div>
            <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">PUBLIÉES</div>
                <div style="font-size: 12px; font-weight: bold; color: #059669;"><?php echo e(number_format($stats['par_statut']['publiee'] ?? 0, 0, ',', ' ')); ?></div>
            </div>
            <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">BROUILLONS</div>
                <div style="font-size: 12px; font-weight: bold; color: #6b7280;"><?php echo e(number_format($stats['par_statut']['brouillon'] ?? 0, 0, ',', ' ')); ?></div>
            </div>
            <div style="float: left; width: 21%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
                ...
                <div style="font-size: 12px; font-weight: bold; color: #dc2626;"><?php echo e(number_format($stats['urgentes'], 0, ',', ' ')); ?></div>
            </div>
            <div style="clear: both;"></div>
        </div>
    </div>
    ...
    <div style="margin-bottom: 25px;">
        ...
        <div style="background-color: #fffbeb; border: 1px solid #fcd34d; border-radius: 4px; padding: 12px;">
            <div style="font-size: 8px; line-height: 1.6; color: #374151;">
                <?php if(!empty($filtres['statut'])): ?>
                    <div style="margin-bottom: 5px;"><strong>Statut:</strong> <?php echo e(ucfirst($filtres['statut'])); ?></div>
                <?php endif; ?>
                <?php if(!empty($filtres['type_annonce'])): ?>
                    <div style="margin-bottom: 5px;"><strong>Type:</strong> <?php echo e(\App\Models\Annonce::getTypesAnnonces()[$filtres['type_annonce']] ?? ucfirst($filtres['type_annonce'])); ?></div>
                <?php endif; ?>
                <?php if(!empty($filtres['audience_cible'])): ?>
                    <div style="margin-bottom: 5px;"><strong>Audience:</strong> <?php echo e(\App\Models\Annonce::getAudiencesCibles()[$filtres['audience_cible']] ?? ucfirst($filtres['audience_cible'])); ?></div>
                <?php endif; ?>
                <?php if(!empty($filtres['niveau_priorite'])): ?>
                    <div style="margin-bottom: 5px;"><strong>Priorité:</strong> <?php echo e(ucfirst($filtres['niveau_priorite'])); ?></div>
                <?php endif; ?>
                <?php if(!empty($filtres['search'])): ?>
                    <div><strong>Recherche:</strong> "<?php echo e(htmlspecialchars($filtres['search'])); ?>"</div>
                <?php endif; ?>
            </div>
        </div>
    </div>
        ...
        <?php if($annonces->count() > 0): ?>
            <div style="margin-bottom: 15px; overflow-x: auto;">
                <table style="width: 100%; border-collapse: collapse; font-size: 7px; background-color: white;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $annonces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $annonce): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $statutColors = [
                            ...
                            <tr style="background-color: <?php echo e($index % 2 === 0 ? '#f9fafb' : 'white'); ?>;">
                                ...
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: left;">
                                    <strong><?php echo e(\Illuminate\Support\Str::limit($annonce->titre, 50)); ?></strong>
                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                ...
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; text-align: center; background-color: <?php echo e($statutColor['bg']); ?>; white-space: nowrap;">
                                    <strong style="color: <?php echo e($statutColor['text']); ?>; font-size: 7px; text-transform: uppercase;"><?php echo e(ucfirst($annonce->statut)); ?></strong>
                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; text-align: center; background-color: <?php echo e($prioriteColor['bg']); ?>; white-space: nowrap;">
                                    <strong style="color: <?php echo e($prioriteColor['text']); ?>; font-size: 7px; text-transform: uppercase;"><?php echo e(ucfirst($annonce->niveau_priorite)); ?></strong>
                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <?php echo e($annonce->publie_le ? $annonce->publie_le->format('d/m/Y') : '-'); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <?php echo e($annonce->expire_le ? $annonce->expire_le->format('d/m/Y') : 'Permanente'); ?>
        ...
        <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 4px; padding: 15px;">
            <div style="margin-bottom: 15px;">
                ...
                <ul style="list-style: none; padding: 0; margin: 5px 0 0 0;">
                    ...
                    <li style="padding: 3px 0; position: relative; padding-left: 15px; font-size: 9px;">
                        ...
                        <?php echo e(ucfirst($statut)); ?> : <?php echo e($count); ?> (<?php echo e($stats['total'] > 0 ? round(($count / $stats['total']) * 100, 1) : 0); ?>%)
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <ul style="list-style: none; padding: 0; margin: 5px 0 0 0;">
                    ...
                    <li style="padding: 3px 0; position: relative; padding-left: 15px; font-size: 9px;">
                        <span style="position: absolute; left: 0; color: #3b82f6; font-weight: bold;">•</span>
                        <?php echo e(\App\Models\Annonce::getTypesAnnonces()[$type] ?? ucfirst($type)); ?> : <?php echo e($count); ?> (<?php echo e($stats['total'] > 0 ? round(($count / $stats['total']) * 100, 1) : 0); ?>%)
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul style="list-style: none; padding: 0; margin: 5px 0 0 0;">
                    <?php $__currentLoopData = $stats['par_priorite']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priorite => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li style="padding: 3px 0; position: relative; padding-left: 15px; font-size: 9px;">
                        <span style="position: absolute; left: 0; color: #3b82f6; font-weight: bold;">•</span>
                        <?php echo e(ucfirst($priorite)); ?> : <?php echo e($count); ?> (<?php echo e($stats['total'] > 0 ? round(($count / $stats['total']) * 100, 1) : 0); ?>%)
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
    ...
    <?php if($annonces->count() > 0 && $annonces->count() <= 10): ?>
        <div style="margin-bottom: 25px;">
                ...
                <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 4px; padding: 12px; margin-bottom: 12px; page-break-inside: avoid;">
                    <div style="border-bottom: 1px solid #e5e7eb; padding-bottom: 6px; margin-bottom: 8px;">
                        <h3 style="color: #1f2937; font-size: 10px; font-weight: bold; margin: 0 0 3px 0;">
                            <?php echo e($loop->iteration); ?>. <?php echo e($annonce->titre); ?>

                        </h3>
                        <div style="font-size: 7px; color: #6b7280;">
                            <?php echo e(\App\Models\Annonce::getTypesAnnonces()[$annonce->type_annonce] ?? ucfirst($annonce->type_annonce)); ?> -
                            <span style="padding: 2px 6px; font-size: 6px; font-weight: 600; border-radius: 10px; text-transform: uppercase; background: <?php echo e($statutColors[$annonce->statut]['bg'] ?? '#f3f4f6'); ?>; color: <?php echo e($statutColors[$annonce->statut]['text'] ?? '#374151'); ?>;">
                    ...
                    <div style="margin-bottom: 8px; font-size: 8px; color: #374151; line-height: 1.4;">
                        ...
                        ?>
                        <?php echo e(\Illuminate\Support\Str::limit($contenuApercu, 200)); ?>

                    </div>

                    <div style="font-size: 7px; color: #6b7280;">
                        <strong>Date de publication:</strong> <?php echo e($annonce->publie_le ? $annonce->publie_le->format('d/m/Y') : 'Non publiée'); ?>

                        <?php if($annonce->expire_le): ?>
                            | <strong>Expiration:</strong> <?php echo e($annonce->expire_le->format('d/m/Y')); ?>
...
<?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/exports/annonces/liste-annonces-pdf.blade.php ENDPATH**/ ?>