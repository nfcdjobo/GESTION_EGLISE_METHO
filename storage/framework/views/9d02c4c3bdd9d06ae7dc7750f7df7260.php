...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', isset($appAcronym) ? $appAcronym : "Église Méthodiste - Belle Ville"); ?></title>
    ...
    <script src="<?php echo e(asset('tailwindcss/tailwindcss.js')); ?>"></script>
    ...
    <style>
        ...
        .ck-content ol {
            all: revert;
            /* rétablit les styles par défaut */
        }
    </style>
...
<body class="bg-gradient-to-br from-slate-50 to-blue-50 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
        ...
        <?php echo $__env->make('layouts.private.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <!-- Main Content -->
        <div class="flex-1 flex flex-col overflow-hidden">

            <?php echo $__env->make('layouts.private.topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- Main Content Area -->
            <main class="flex-1 overflow-y-auto bg-gradient-to-br from-slate-50 to-blue-50">
                <div class="p-6">
                    ...
                    <?php echo $__env->make('layouts.private.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/layouts/private/main.blade.php ENDPATH**/ ?>