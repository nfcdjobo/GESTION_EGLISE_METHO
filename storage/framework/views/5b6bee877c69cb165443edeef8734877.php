...
<?php $__env->startSection('content'); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1
                        ...
                        <?php echo e($contact->nom_eglise); ?></h1>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="text-sm font-medium text-slate-500"><?php echo e(Str::limit($contact->nom_eglise, 30)); ?></span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="flex flex-wrap gap-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.update')): ?>
                        <a href="<?php echo e(route('private.contacts.edit', $contact)); ?>"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.update')): ?>
                        <?php if(!$contact->verifie): ?>
                            <button onclick="verifyContact('<?php echo e($contact->id); ?>')"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.export')): ?>
                        <a href="<?php echo e(route('private.contacts.export', $contact)); ?>"
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="flex-shrink-0">
                            <?php if($contact->logo_url): ?>
                                <img class="h-20 w-20 rounded-2xl object-cover shadow-lg" src="<?php echo e($contact->logo_url); ?>"
                                    alt="<?php echo e($contact->nom_eglise); ?>">
                            <?php else: ?>
                                <div
                                    class="h-20 w-20 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center shadow-lg">
                                    <span
                                        class="text-white font-bold text-2xl"><?php echo e(substr($contact->nom_eglise, 0, 2)); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div>
            ...
            <?php if($contact->capacite_accueil): ?>
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($contact->capacite_accueil)); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-bold text-slate-800">
                                <?php echo e($stats['derniere_verification']->diffForHumans()); ?></p>
                            ...
                            <?php if($contact->telephone_principal): ?>
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-semibold text-slate-900"><?php echo e($contact->telephone_principal); ?>
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-semibold text-slate-900">
                                            <?php echo e($contact->telephone_secondaire); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($contact->email_principal): ?>
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:<?php echo e($contact->email_principal); ?>"
                                            class="text-lg font-semibold text-purple-600 hover:text-purple-700"><?php echo e($contact->email_principal); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($contact->whatsapp): ?>
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contact->whatsapp)); ?>"
                                            target="_blank"
                                            class="text-lg font-semibold text-green-600 hover:text-green-700"><?php echo e($contact->whatsapp); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <?php if($contact->latitude && $contact->longitude): ?>
                            ...
                            <div class="mt-4">
                                <a href="https://www.google.com/maps?q=<?php echo e($contact->latitude); ?>,<?php echo e($contact->longitude); ?>"
                                    target="_blank"
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    <?php if($contact->pasteur_principal): ?>
                                        <h4 class="text-lg font-semibold text-slate-900"><?php echo e($contact->pasteur_principal); ?>
                                    ...
                                    <div class="space-y-2">
                                        <?php if($contact->telephone_pasteur): ?>
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span
                                                    class="text-sm text-slate-700"><?php echo e($contact->telephone_pasteur); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if($contact->email_pasteur): ?>
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <a href="mailto:<?php echo e($contact->email_pasteur); ?>"
                                                    class="text-sm text-purple-600 hover:text-purple-700"><?php echo e($contact->email_pasteur); ?></a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4">
                            <?php if($contact->site_web_principal): ?>
                                <a href="<?php echo e($contact->site_web_principal); ?>" target="_blank"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-blue-600 hover:text-blue-700"><?php echo e($contact->site_web_principal); ?>
                            ...
                            <?php if($contact->facebook_url): ?>
                                <a href="<?php echo e($contact->facebook_url); ?>" target="_blank"
                                    class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-blue-600 hover:text-blue-700 text-sm">
                                            <?php echo e(Str::limit($contact->facebook_url, 30)); ?></p>
                                    </div>
                                </a>
                            <?php endif; ?>

                            <?php if($contact->instagram_url): ?>
                                <a href="<?php echo e($contact->instagram_url); ?>" target="_blank"
                                    class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-pink-600 hover:text-pink-700 text-sm">
                                            <?php echo e(Str::limit($contact->instagram_url, 30)); ?></p>
                                    </div>
                                </a>
                            <?php endif; ?>

                            <?php if($contact->youtube_url): ?>
                                <a href="<?php echo e($contact->youtube_url); ?>" target="_blank"
                                    class="flex items-center space-x-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-red-600 hover:text-red-700 text-sm">
                                            <?php echo e(Str::limit($contact->youtube_url, 30)); ?></p>
                                    </div>
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <?php if($contact->derniere_verification): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="text-sm text-slate-600"><?php echo e($contact->derniere_verification->format('d/m/Y')); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($contact->createur): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm text-slate-600"><?php echo e($contact->createur->nom); ?>

                                    <?php echo e($contact->createur->prenom); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($contact->responsableContact): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-sm text-slate-600"><?php echo e($contact->responsableContact->nom); ?>

                                    <?php echo e($contact->responsableContact->prenom); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="w-16 bg-gray-200 rounded-full h-2">
                                    <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($stats['completude']); ?>%">
                                    </div>
                                </div>
                ...
                <div
                    ...
                    <div class="p-6 space-y-3">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.update')): ?>
                            <button onclick="toggleVisibility('<?php echo e($contact->id); ?>')"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.create')): ?>
                            <a href="<?php echo e(route('private.contacts.duplicate', $contact)); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            //     window.open(`<?php echo e(route('private.contacts.qr-code', ':contact')); ?>`.replace(':contact', contactId), '_blank', 'width=400,height=400');
            // }
        </script>
    <?php $__env->stopPush(); ?>
