...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-2xl transform -translate-x-full transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 border-r border-slate-200">
    ...
    <div class="p-4 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-blue-50">
        <div class="flex items-center space-x-3">
            <div class="relative">
                <img class="h-10 w-10 rounded-full object-cover ring-2 ring-blue-500" src="<?php echo e(auth()->user()->photo_profil ? Storage::url(auth()->user()->photo_profil) : 'https://ui-avatars.com/api/?name='.auth()->user()->nom.'+'.auth()->user()->prenom.'&background=3b82f6&color=fff'); ?>" alt="<?php echo e(auth()->user()->photo_profil); ?>" />
                <span class="absolute bottom-0 right-0 h-3 w-3 bg-green-400 rounded-full border-2 border-white animate-pulse"></span>
            </div>
            <div>
                <h6 class="text-sm font-semibold text-slate-900"><?php echo e((auth()->user()->sexe == 'masculin' ? 'Mr. ' : 'Mme/Mlle. ').auth()->user()->nom); ?></h6>
    ...
    <div class="flex-1 overflow-y-auto max-h-[80%]" id="sidebar-nav">
        <div class="p-4">
            ...
            <nav class="space-y-2">
                ...
                <!-- Dashboard -->
                <a href="<?php echo e(route('private.dashboard')); ?>" class="nav-item flex items-center w-full px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.dashboard') ? 'text-white bg-gradient-to-r from-blue-500 to-purple-500 shadow-lg ring-2 ring-blue-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:text-blue-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.dashboard">
                    <i class="fas fa-chart-line mr-3 <?php echo e(request()->routeIs('private.dashboard') ? 'text-yellow-300' : 'text-blue-500 group-hover:text-blue-600'); ?>"></i>
                    <span>Tableau de bord</span>
                </a>
                <?php endif; ?>

                <!-- Section : Administration -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['roles.read', 'permissions.read', 'classes.read'])): ?>
                <div class="pt-4 pb-2">
                ...
                <!-- Section : Membres -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['users.read', 'contacts.read'])): ?>
                <div class="pt-4 pb-2">
                ...
                <a href="<?php echo e(route('private.users.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.users.*') ? 'text-white bg-gradient-to-r from-green-500 to-emerald-500 shadow-lg ring-2 ring-green-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 hover:text-green-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.users.index">
                    <i class="fas fa-user-friends <?php echo e(request()->routeIs('private.users.*') ? 'text-yellow-300' : 'text-green-500 group-hover:text-green-600'); ?> mr-3"></i>
                    <span>Membres</span>
                </a>
                <?php endif; ?>

                <!-- Contacts -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.read')): ?>
                <a href="<?php echo e(route('private.contacts.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.contacts.*') ? 'text-white bg-gradient-to-r from-teal-500 to-cyan-500 shadow-lg ring-2 ring-teal-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:text-teal-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.contacts.index">
                    <i class="fas fa-address-book <?php echo e(request()->routeIs('private.contacts.*') ? 'text-yellow-300' : 'text-teal-500 group-hover:text-teal-600'); ?> mr-3"></i>
                    <span>Contacts</span>
                </a>
                <?php endif; ?>
                <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['programmes.read', 'cultes.read', 'participantscultes.read', 'events.read'])): ?>
                <div class="pt-4 pb-2">
                    <h5 class="text-xs font-medium text-slate-400 uppercase tracking-wider mb-2">Activités Spirituelles</h5>
                </div>

                <!-- Programmes -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.read')): ?>
                <a href="<?php echo e(route('private.programmes.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.programmes.*') ? 'text-white bg-gradient-to-r from-blue-500 to-indigo-500 shadow-lg ring-2 ring-blue-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.programmes.index">
                    <i class="fas fa-calendar-alt <?php echo e(request()->routeIs('private.programmes.*') ? 'text-yellow-300' : 'text-blue-500 group-hover:text-blue-600'); ?> mr-3"></i>
                ...
                <a href="<?php echo e(route('private.cultes.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.cultes.*') ? 'text-white bg-gradient-to-r from-amber-500 to-yellow-500 shadow-lg ring-2 ring-amber-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-amber-50 hover:to-yellow-50 hover:text-amber-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.cultes.index">
                    <i class="fas fa-church <?php echo e(request()->routeIs('private.cultes.*') ? 'text-yellow-200' : 'text-amber-500 group-hover:text-amber-600'); ?> mr-3"></i>
                    <span>Cultes</span>
                </a>
                <?php endif; ?>

                <!-- Participants -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participantscultes.read')): ?>
                <a href="<?php echo e(route('private.participantscultes.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.participantscultes.*') ? 'text-white bg-gradient-to-r from-amber-500 to-orange-500 shadow-lg ring-2 ring-amber-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-amber-50 hover:to-yellow-50 hover:text-amber-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.participantscultes.index">
                    <i class="fas fa-users-cog <?php echo e(request()->routeIs('private.participantscultes.*') ? 'text-yellow-200' : 'text-amber-500 group-hover:text-amber-600'); ?> mr-3"></i>
                ...
                <a href="<?php echo e(route('private.events.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.events.*') ? 'text-white bg-gradient-to-r from-rose-500 to-pink-500 shadow-lg ring-2 ring-rose-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-rose-50 hover:to-pink-50 hover:text-rose-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.events.index">
                    <i class="fas fa-calendar-check <?php echo e(request()->routeIs('private.events.*') ? 'text-yellow-300' : 'text-rose-500 group-hover:text-rose-600'); ?> mr-3"></i>
                ...
                <!-- Section : Finances -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['fonds.read', 'fimecos.read'])): ?>
                <div class="pt-4 pb-2">
                ...
                <a href="<?php echo e(route('private.fonds.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.fonds.*') ? 'text-white bg-gradient-to-r from-emerald-500 to-green-500 shadow-lg ring-2 ring-emerald-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 hover:text-emerald-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.fonds.index">
                    <i class="fas fa-donate <?php echo e(request()->routeIs('private.fonds.*') ? 'text-yellow-300' : 'text-emerald-500 group-hover:text-emerald-600'); ?> mr-3"></i>
                    <span>Offrandes</span>
                </a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('private.fimecos.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.fimecos.*') ? 'text-white bg-gradient-to-r from-green-500 to-teal-500 shadow-lg ring-2 ring-green-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 hover:text-emerald-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.fimecos.index">
                    <i class="fas fa-piggy-bank <?php echo e(request()->routeIs('private.fimecos.*') ? 'text-yellow-300' : 'text-emerald-500 group-hover:text-emerald-600'); ?> mr-3"></i>
                    <span>FIMECO</span>
                </a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('private.subscriptions.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.subscriptions.*') ? 'text-white bg-gradient-to-r from-teal-500 to-emerald-500 shadow-lg ring-2 ring-teal-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-teal-50 hover:to-emerald-50 hover:text-teal-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.subscriptions.index">
                    <i class="fas fa-file-contract <?php echo e(request()->routeIs('private.subscriptions.*') ? 'text-yellow-300' : 'text-teal-500 group-hover:text-teal-600'); ?> mr-3"></i>
                    <span>Souscriptions</span>
                </a>
                <?php endif; ?>

                <!-- Paiements -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('paiements.read')): ?>
                <a href="<?php echo e(route('private.paiements.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.paiements.*') ? 'text-white bg-gradient-to-r from-cyan-500 to-teal-500 shadow-lg ring-2 ring-cyan-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-teal-50 hover:text-cyan-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.paiements.index">
                    <i class="fas fa-credit-card <?php echo e(request()->routeIs('private.paiements.*') ? 'text-yellow-300' : 'text-cyan-500 group-hover:text-cyan-600'); ?> mr-3"></i>
                    <span>Paiements</span>
                </a>
                <?php endif; ?>

                <!-- Projets -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.read')): ?>
                <a href="<?php echo e(route('private.projets.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.projets.*') ? 'text-white bg-gradient-to-r from-violet-500 to-purple-500 shadow-lg ring-2 ring-violet-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-violet-50 hover:to-purple-50 hover:text-violet-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.projets.index">
                    <i class="fas fa-project-diagram <?php echo e(request()->routeIs('private.projets.*') ? 'text-yellow-300' : 'text-violet-500 group-hover:text-violet-600'); ?> mr-3"></i>
                    <span>Projets</span>
                </a>
                <?php endif; ?>
                 <?php endif; ?>
                ...
                <!-- Section : Réunions -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['types-reunions.read', 'reunions.read', 'rapports-reunions.read'])): ?>
                <div class="pt-4 pb-2">
                ...
                <a href="<?php echo e(route('private.annonces.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.annonces.*') ? 'text-white bg-gradient-to-r from-red-500 to-rose-500 shadow-lg ring-2 ring-red-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 hover:text-red-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.annonces.index">
                    <i class="fas fa-bullhorn <?php echo e(request()->routeIs('private.annonces.*') ? 'text-yellow-300' : 'text-red-500 group-hover:text-red-600'); ?> mr-3"></i>
                    <span>Annonces</span>
                </a>
                <?php endif; ?>

                <!-- Interventions -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.read')): ?>
                <a href="<?php echo e(route('private.interventions.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.interventions.*') ? 'text-white bg-gradient-to-r from-pink-500 to-red-500 shadow-lg ring-2 ring-pink-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 hover:text-red-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.interventions.index">
                    <i class="fas fa-microphone <?php echo e(request()->routeIs('private.interventions.*') ? 'text-yellow-300' : 'text-red-500 group-hover:text-red-600'); ?> mr-3"></i>
                    <span>Interventions</span>
                </a>
                <?php endif; ?>
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['multimedia.read'])): ?>
                <!-- Section : Médias -->
                <div class="pt-4 pb-2">
                ...
                <!-- Médias -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('multimedia.read')): ?>
                <a href="<?php echo e(route('private.multimedia.index')); ?>" class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.multimedia.*') ? 'text-white bg-gradient-to-r from-pink-500 to-rose-500 shadow-lg ring-2 ring-pink-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-pink-50 hover:to-rose-50 hover:text-pink-600'); ?> rounded-xl transition-all duration-200 group" data-route="private.multimedia.index">
                    <i class="fas fa-photo-video <?php echo e(request()->routeIs('private.multimedia.*') ? 'text-yellow-300' : 'text-pink-500 group-hover:text-pink-600'); ?> mr-3"></i>
                    <span>Médias</span>
                </a>
                <?php endif; ?>
                <?php endif; ?>
...
<?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/layouts/private/header.blade.php ENDPATH**/ ?>