...
<aside id="sidebar"
    ...
    <div class="flex items-center justify-center h-16 bg-gradient-to-r from-blue-600 to-purple-600 border-b border-blue-700">
        <div class="flex items-center">
            ...
            <span class="ml-2 text-white font-bold text-lg"><?php echo e($AppParametres->nom_eglise ?? 'Méthodiste'); ?></span>
        </div>
    </div>
    ...
    src="<?php echo e(auth()->check() && auth()->user()->photo_profil ? Storage::url(auth()->user()->photo_profil) : 'https://ui-avatars.com/api/?name=' . urlencode((auth()->user()?->nom ?? 'User') . ' ' . (auth()->user()?->prenom ?? '')) . '&background=3b82f6&color=fff'); ?>"
    alt="<?php echo e(auth()->user()?->nom ?? 'User'); ?>" />
...
<h6 class="text-sm font-semibold text-slate-900">
    <?php echo e((auth()->check() && auth()->user()->sexe == 'masculin' ? 'Mr. ' : 'Mme/Mlle. ') . (auth()->user()?->nom ?? 'Utilisateur')); ?>
            ...
            <nav class="space-y-2">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard.read')): ?>
                    ...
                    <a href="<?php echo e(route('private.dashboard')); ?>"
                        class="nav-item flex items-center w-full px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.dashboard') ? 'text-white bg-gradient-to-r from-blue-500 to-purple-500 shadow-lg ring-2 ring-blue-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:text-blue-600'); ?> rounded-xl transition-all duration-200 group"
                        data-route="private.dashboard">
                        <i
                            class="fas fa-chart-line mr-3 <?php echo e(request()->routeIs('private.dashboard') ? 'text-yellow-300' : 'text-blue-500 group-hover:text-blue-600'); ?>"></i>
                        <span>Tableau de bord</span>
                    </a>
                <?php endif; ?>

                <!-- Section : Administration -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['roles.read', 'permissions.read', 'classes.read', 'parametresdons.read'])): ?>
                    <div class="pt-4 pb-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permissions.read')): ?>
                        <a href="<?php echo e(route('private.permissions.index')); ?>"
                            ...
                            <i
                                class="fas fa-key <?php echo e(request()->routeIs('private.permissions.*') ? 'text-yellow-300' : 'text-purple-500 group-hover:text-purple-600'); ?> mr-3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('classes.read')): ?>
                        <a href="<?php echo e(route('private.classes.index')); ?>"
                            ...
                            <i
                                class="fas fa-users <?php echo e(request()->routeIs('private.classes.*') ? 'text-yellow-300' : 'text-cyan-500 group-hover:text-cyan-600'); ?> mr-3"></i>
                            <span>Classes</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('parametresdons.read')): ?>
                            <a href="<?php echo e(route('private.parametresdons.index')); ?>"
                                ...
                                <i class="fas fa-arrows-rotate <?php echo e(request()->routeIs('private.parametresdons.*') ? 'text-yellow-300' : 'text-violet-500 group-hover:text-violet-600'); ?> mr-3"></i>
                ...
                <!-- Section : Membres -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['users.read', 'contacts.read'])): ?>
                    <div class="pt-4 pb-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts.read')): ?>
                        <a href="<?php echo e(route('private.contacts.index')); ?>"
                            ...
                            <i
                                class="fas fa-address-book <?php echo e(request()->routeIs('private.contacts.*') ? 'text-yellow-300' : 'text-teal-500 group-hover:text-teal-600'); ?> mr-3"></i>
                            <span>Contacts</span>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['programmes.read', 'cultes.read', 'participantscultes.read', 'events.read'])): ?>
                    <div class="pt-4 pb-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.read')): ?>
                        <a href="<?php echo e(route('private.programmes.index')); ?>"
                            ...
                            <i
                                class="fas fa-calendar-alt <?php echo e(request()->routeIs('private.programmes.*') ? 'text-yellow-300' : 'text-blue-500 group-hover:text-blue-600'); ?> mr-3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cultes.read')): ?>
                        <a href="<?php echo e(route('private.cultes.index')); ?>"
                            ...
                            <i
                                class="fas fa-church <?php echo e(request()->routeIs('private.cultes.*') ? 'text-yellow-200' : 'text-amber-500 group-hover:text-amber-600'); ?> mr-3"></i>
                            <span>Cultes</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participantscultes.read')): ?>
                        <a href="<?php echo e(route('private.participantscultes.index')); ?>"
                            ...
                            <i
                                class="fas fa-users-cog <?php echo e(request()->routeIs('private.participantscultes.*') ? 'text-yellow-200' : 'text-amber-500 group-hover:text-amber-600'); ?> mr-3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('events.read')): ?>
                        <a href="<?php echo e(route('private.events.index')); ?>"
                            ...
                            <i
                                class="fas fa-calendar-check <?php echo e(request()->routeIs('private.events.*') ? 'text-yellow-300' : 'text-rose-500 group-hover:text-rose-600'); ?> mr-3"></i>
                ...
                <!-- Section : Finances -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['fonds.read', 'fimecos.read', 'subscriptions.read', 'paiements.read', 'projets.read',
                    'moissons.read'])): ?>
                    <div class="pt-4 pb-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fonds.read')): ?>
                        <a href="<?php echo e(route('private.fonds.index')); ?>"
                            ...
                            <i
                                class="fas fa-donate <?php echo e(request()->routeIs('private.fonds.*') ? 'text-yellow-300' : 'text-emerald-500 group-hover:text-emerald-600'); ?> mr-3"></i>
                            <span>Offrandes</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscriptions.read')): ?>
                        <a href="<?php echo e(route('private.subscriptions.index')); ?>"
                            ...
                            <i
                                class="fas fa-file-contract <?php echo e(request()->routeIs('private.subscriptions.*') ? 'text-yellow-300' : 'text-teal-500 group-hover:text-teal-600'); ?> mr-3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('paiements.read')): ?>
                        <a href="<?php echo e(route('private.paiements.index')); ?>"
                            ...
                            <i
                                class="fas fa-credit-card <?php echo e(request()->routeIs('private.paiements.*') ? 'text-yellow-300' : 'text-cyan-500 group-hover:text-cyan-600'); ?> mr-3"></i>
                            <span>Paiements</span>
                        </a>
                    <?php endif; ?>

                    <!-- Moissons -->
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('moissons.read')): ?>
                        <a href="<?php echo e(route('private.moissons.index')); ?>"
                            ...
                            <i
                                class="fas fa-seedling <?php echo e(request()->routeIs('private.moissons.*') ? 'text-yellow-300' : 'text-emerald-500 group-hover:text-emerald-600'); ?> mr-3"></i>
                            <span>Moissons</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projets.read')): ?>
                        <a href="<?php echo e(route('private.projets.index')); ?>"
                            ...
                            <i
                                class="fas fa-project-diagram <?php echo e(request()->routeIs('private.projets.*') ? 'text-yellow-300' : 'text-violet-500 group-hover:text-violet-600'); ?> mr-3"></i>
                            <span>Projets</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dons.read')): ?>
                            <a href="<?php echo e(route('private.dons.index')); ?>"
                                class="nav-item flex items-center px-3 py-2.5 text-sm font-medium <?php echo e(request()->routeIs('private.dons.*') ? 'text-white bg-gradient-to-r from-violet-500 to-purple-500 shadow-lg ring-2 ring-violet-200' : 'text-slate-700 hover:bg-gradient-to-r hover:from-violet-50 hover:to-purple-50 hover:text-violet-600'); ?> rounded-xl transition-all duration-200 group"
                                data-route="private.dons.index">
                                <i class="fas fa-dove <?php echo e(request()->routeIs('private.dons.*') ? 'text-yellow-300' : 'text-violet-500 group-hover:text-violet-600'); ?> mr-3"></i>
                                <span>Donations</span>
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <!-- Section : Réunions -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['types-reunions.read', 'reunions.read', 'rapports-reunions.read', 'annonces.read',
                    'interventions.read'])): ?>
                    <div class="pt-4 pb-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('types-reunions.read')): ?>
                        <a href="<?php echo e(route('private.types-reunions.index')); ?>"
                            ...
                            <i
                                class="fas fa-tags <?php echo e(request()->routeIs('private.types-reunions.*') ? 'text-yellow-300' : 'text-orange-500 group-hover:text-orange-600'); ?> mr-3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.read')): ?>
                        <a href="<?php echo e(route('private.reunions.index')); ?>"
                            ...
                            <i
                                class="fas fa-handshake <?php echo e(request()->routeIs('private.reunions.*') ? 'text-yellow-300' : 'text-sky-500 group-hover:text-sky-600'); ?> mr-3"></i>
                            <span>Réunions</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rapports-reunions.read')): ?>
                        <a href="<?php echo e(route('private.rapports-reunions.index')); ?>"
                            ...
                            <i
                                class="fas fa-file-alt <?php echo e(request()->routeIs('private.rapports-reunions.*') ? 'text-yellow-300' : 'text-slate-500 group-hover:text-slate-600'); ?> mr-3"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.read')): ?>
                        <a href="<?php echo e(route('private.annonces.index')); ?>"
                            ...
                            <i
                                class="fas fa-bullhorn <?php echo e(request()->routeIs('private.annonces.*') ? 'text-yellow-300' : 'text-red-500 group-hover:text-red-600'); ?> mr-3"></i>
                            <span>Annonces</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.read')): ?>
                        <a href="<?php echo e(route('private.interventions.index')); ?>"
                            ...
                            <i
                                class="fas fa-microphone <?php echo e(request()->routeIs('private.interventions.*') ? 'text-yellow-300' : 'text-red-500 group-hover:text-red-600'); ?> mr-3"></i>
                ...
                <div class="pt-4 space-y-1">
                    ...
                    <div id="pages-menu" class="pl-6 space-y-1 max-h-0 overflow-hidden transition-all duration-300">
                        <a href="<?php echo e(route('private.profil.index')); ?>"
                ...
                <!-- Donations -->
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('parametres.read')): ?>
                        <a href="<?php echo e(route('private.parametres.index')); ?>"
                            ...
                            <i class="fas fa-cog <?php echo e(request()->routeIs('private.parametres.*') ? 'text-gray-300' : 'text-violet-500 group-hover:text-gray-600'); ?> mr-3"></i>
