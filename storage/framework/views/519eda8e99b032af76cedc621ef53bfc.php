    ...
    <div class="flex-1 overflow-y-auto max-h-[80%]" id="sidebar-nav">
        <div class="p-4">
            ...
            <nav class="space-y-2">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['roles.read', 'permissions.read', 'classes.read'])): ?>
                    <div class="pt-4 pb-2">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['multimedia.read'])): ?>
                    <!-- Section : Médias -->
                    <div class="pt-4 pb-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('multimedia.read')): ?>
                        <a href="<?php echo e(route('private.multimedia.index')); ?>"
                            ...
                            <i
                                class="fas fa-photo-video <?php echo e(request()->routeIs('private.multimedia.*') ? 'text-yellow-300' : 'text-pink-500 group-hover:text-pink-600'); ?> mr-3"></i>
                            <span>Médias</span>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
