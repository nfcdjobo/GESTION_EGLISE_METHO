...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('private.events.store')); ?>" method="POST" id="eventForm" enctype="multipart/form-data" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="titre" name="titre" value="<?php echo e(old('titre')); ?>" required maxlength="200" placeholder="Ex: Conférence de Pâques 2024"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="sous_titre" name="sous_titre" value="<?php echo e(old('sous_titre')); ?>" maxlength="200" placeholder="Sous-titre optionnel"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['sous_titre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="resume_court" name="resume_court" rows="2" maxlength="500" placeholder="Résumé pour l'aperçu (500 caractères max)"
                                class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none <?php $__errorArgs = ['resume_court'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('resume_court')); ?></textarea>
                            <?php $__errorArgs = ['resume_court'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="type_evenement" name="type_evenement" required
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['type_evenement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="conference" <?php echo e(old('type_evenement') == 'conference' ? 'selected' : ''); ?>>Conférence</option>
                                    <option value="seminaire" <?php echo e(old('type_evenement') == 'seminaire' ? 'selected' : ''); ?>>Séminaire</option>
                                    <option value="atelier" <?php echo e(old('type_evenement') == 'atelier' ? 'selected' : ''); ?>>Atelier</option>
                                    <option value="camps" <?php echo e(old('type_evenement') == 'camps' ? 'selected' : ''); ?>>Camps</option>
                                    <option value="formation" <?php echo e(old('type_evenement') == 'formation' ? 'selected' : ''); ?>>Formation</option>
                                    <option value="celebration" <?php echo e(old('type_evenement') == 'celebration' ? 'selected' : ''); ?>>Célébration</option>
                                    <option value="festival" <?php echo e(old('type_evenement') == 'festival' ? 'selected' : ''); ?>>Festival</option>
                                    <option value="concert" <?php echo e(old('type_evenement') == 'concert' ? 'selected' : ''); ?>>Concert</option>
                                    <option value="retraite" <?php echo e(old('type_evenement') == 'retraite' ? 'selected' : ''); ?>>Retraite</option>
                                    <option value="evangelisation" <?php echo e(old('type_evenement') == 'evangelisation' ? 'selected' : ''); ?>>Évangélisation</option>
                                    <option value="autre" <?php echo e(old('type_evenement') == 'autre' ? 'selected' : ''); ?>>Autre</option>
                                </select>
                                <?php $__errorArgs = ['type_evenement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="spirituel" <?php echo e(old('categorie') == 'spirituel' ? 'selected' : ''); ?>>Spirituel</option>
                                    <option value="educatif" <?php echo e(old('categorie') == 'educatif' ? 'selected' : ''); ?>>Éducatif</option>
                                    <option value="social" <?php echo e(old('categorie') == 'social' ? 'selected' : ''); ?>>Social</option>
                                    <option value="culturel" <?php echo e(old('categorie') == 'culturel' ? 'selected' : ''); ?>>Culturel</option>
                                    <option value="caritatif" <?php echo e(old('categorie') == 'caritatif' ? 'selected' : ''); ?>>Caritatif</option>
                                    <option value="formation" <?php echo e(old('categorie') == 'formation' ? 'selected' : ''); ?>>Formation</option>
                                    <option value="divertissement" <?php echo e(old('categorie') == 'divertissement' ? 'selected' : ''); ?>>Divertissement</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" id="ouvert_public" name="ouvert_public" value="1" <?php echo e(old('ouvert_public', true) ? 'checked' : ''); ?>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="inscription_requise" name="inscription_requise" value="1" <?php echo e(old('inscription_requise') ? 'checked' : ''); ?>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="inscription_payante" name="inscription_payante" value="1" <?php echo e(old('inscription_payante') ? 'checked' : ''); ?>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="diffusion_en_ligne" name="diffusion_en_ligne" value="1" <?php echo e(old('diffusion_en_ligne') ? 'checked' : ''); ?>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="date" id="date_debut" name="date_debut" value="<?php echo e(old('date_debut')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="time" id="heure_debut" name="heure_debut" value="<?php echo e(old('heure_debut')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" id="date_fin" name="date_fin" value="<?php echo e(old('date_fin')); ?>"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['date_fin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="time" id="heure_fin" name="heure_fin" value="<?php echo e(old('heure_fin')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="evenement_multi_jours" name="evenement_multi_jours" value="1" <?php echo e(old('evenement_multi_jours') ? 'checked' : ''); ?>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="lieu_nom" name="lieu_nom" value="<?php echo e(old('lieu_nom')); ?>" required maxlength="200" placeholder="Ex: Église Centrale"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['lieu_nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" id="lieu_ville" name="lieu_ville" value="<?php echo e(old('lieu_ville')); ?>" maxlength="100" placeholder="Ex: Abidjan"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['lieu_ville'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="lieu_adresse" name="lieu_adresse" rows="3" placeholder="Adresse complète du lieu"
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none <?php $__errorArgs = ['lieu_adresse'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('lieu_adresse')); ?></textarea>
                    <?php $__errorArgs = ['lieu_adresse'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="instructions_acces" name="instructions_acces" rows="2" placeholder="Indications particulières pour accéder au lieu"
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none <?php $__errorArgs = ['instructions_acces'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('instructions_acces')); ?></textarea>
                    <?php $__errorArgs = ['instructions_acces'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" id="capacite_totale" name="capacite_totale" value="<?php echo e(old('capacite_totale')); ?>" min="1" placeholder="100"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['capacite_totale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['capacite_totale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="prix-section" style="display: none;">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="prix_inscription" name="prix_inscription" value="<?php echo e(old('prix_inscription')); ?>" min="0" step="0.01" placeholder="5000"
                                class="w-full pl-16 pr-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['prix_inscription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__errorArgs = ['prix_inscription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center">
                                <input type="checkbox" id="liste_attente" name="liste_attente" value="1" <?php echo e(old('liste_attente') ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" id="date_ouverture_inscription" name="date_ouverture_inscription" value="<?php echo e(old('date_ouverture_inscription')); ?>"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['date_ouverture_inscription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['date_ouverture_inscription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="date" id="date_fermeture_inscription" name="date_fermeture_inscription" value="<?php echo e(old('date_fermeture_inscription')); ?>"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['date_fermeture_inscription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['date_fermeture_inscription'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $organisateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $organisateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($organisateur->id); ?>" <?php echo e(old('organisateur_principal_id') == $organisateur->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e(old('coordinateur_id') == $user->id ? 'selected' : ''); ?>>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="responsable_logistique_id" name="responsable_logistique_id"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['responsable_logistique_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e(old('responsable_logistique_id') == $user->id ? 'selected' : ''); ?>>
                                    <?php echo e($user->prenom); ?> <?php echo e($user->nom); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['responsable_logistique_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="responsable_communication_id" name="responsable_communication_id"
                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['responsable_communication_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <option value="">Sélectionner un responsable</option>
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>" <?php echo e(old('responsable_communication_id') == $user->id ? 'selected' : ''); ?>>
                                    <?php echo e($user->prenom); ?> <?php echo e($user->nom); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['responsable_communication_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <input type="file" id="image_principale" name="image_principale" accept="image/*"
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['image_principale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    <?php $__errorArgs = ['image_principale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="url" id="video_presentation" name="video_presentation" value="<?php echo e(old('video_presentation')); ?>" placeholder="https://youtube.com/watch?v=..."
                        class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['video_presentation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    <?php $__errorArgs = ['video_presentation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="diffusion-section" style="display: none;">
                    ...
                    <input type="url" id="lien_diffusion" name="lien_diffusion" value="<?php echo e(old('lien_diffusion')); ?>" placeholder="https://meet.google.com/..."
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('private.events.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/events/create.blade.php ENDPATH**/ ?>