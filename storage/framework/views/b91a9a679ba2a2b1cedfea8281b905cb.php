<?php $__env->startSection('title', 'Modifier l\'Annonce'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="<?php echo e(route('private.annonces.show', $annonce)); ?>"
                                ...
                                <?php echo e(Str::limit($annonce->titre, 20)); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.update')): ?>
            <form action="<?php echo e(route('private.annonces.update', $annonce)); ?>" method="POST" id="annonceForm" class="space-y-8">
                <?php echo csrf_field(); ?>
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-6">
                                <div>
                                    ...
                                    <input type="text" id="titre" name="titre" value="<?php echo e(old('titre', $annonce->titre)); ?>"
...
unset($__errorArgs, $__bag); ?>">
                                        <textarea id="contenu" name="contenu" rows="6"
                                            ...
                                            class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"><?php echo e(old('contenu', $annonce->contenu)); ?></textarea>
                                    </div>
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $typesAnnonces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(old('type_annonce', $annonce->type_annonce) == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                                            <?php $__currentLoopData = $niveauxPriorite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(old('niveau_priorite', $annonce->niveau_priorite) == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>">
                                            <?php $__currentLoopData = $audiencesCibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php echo e(old('audience_cible', $annonce->audience_cible) == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="evenement_section"
                            class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300 <?php echo e($annonce->type_annonce !== 'evenement' ? 'hidden' : ''); ?>">
                            <div class="p-6 border-b border-slate-200">
                                <h2 class="text-xl font-bold text-slate-800 flex items-center">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="date" id="date_evenement" name="date_evenement"
                                            value="<?php echo e(old('date_evenement', $annonce->date_evenement?->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="lieu_evenement" name="lieu_evenement"
                                            value="<?php echo e(old('lieu_evenement', $annonce->lieu_evenement)); ?>" maxlength="255"
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($contact->id); ?>" <?php echo e(old('contact_principal_id', $annonce->contact_principal_id) == $contact->id ? 'selected' : ''); ?>>
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        <div class="flex items-center">
                                            <input type="checkbox" id="afficher_site_web" name="afficher_site_web" value="1" <?php echo e(old('afficher_site_web', $annonce->afficher_site_web) ? 'checked' : ''); ?>
                                        ...
                                        <div class="flex items-center">
                                            <input type="checkbox" id="annoncer_culte" name="annoncer_culte" value="1" <?php echo e(old('annoncer_culte', $annonce->annoncer_culte) ? 'checked' : ''); ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="datetime-local" id="expire_le" name="expire_le"
                                            value="<?php echo e(old('expire_le', $annonce->expire_le?->format('Y-m-d\TH:i'))); ?>"
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-4">
                                <div class="text-center">
                                    <span
                                        class="inline-flex items-center px-4 py-2 rounded-full text-lg font-medium <?php echo e($annonce->badge_statut); ?>">
                                ...
                                <?php if($annonce->expire_le && $annonce->jours_restants !== null): ?>
                                    <div class="text-center pt-2 border-t border-slate-100">
                                        <?php if($annonce->jours_restants > 0): ?>
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($annonce->jours_restants <= 3 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                                                <?php echo e($annonce->jours_restants); ?> jour<?php echo e($annonce->jours_restants > 1 ? 's' : ''); ?>

                                                restant<?php echo e($annonce->jours_restants > 1 ? 's' : ''); ?>
                            ...
                            <div class="p-6 space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span id="preview-titre"
                                        class="text-sm text-slate-900 font-semibold"><?php echo e($annonce->titre); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-slate-700">Type:</span>
                                    <span id="preview-type"
                                        class="text-sm text-slate-600"><?php echo e($typesAnnonces[$annonce->type_annonce] ?? $annonce->type_annonce); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-slate-700">Priorité:</span>
                                    <span id="preview-priorite"
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($annonce->badge_priorite); ?>"><?php echo e($niveauxPriorite[$annonce->niveau_priorite] ?? $annonce->niveau_priorite); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-slate-700">Audience:</span>
                                    <span id="preview-audience"
                                        class="text-sm text-slate-600"><?php echo e($audiencesCibles[$annonce->audience_cible] ?? $annonce->audience_cible); ?></span>
                                </div>
                                <div class="flex items-center justify-between">
                                    ...
                                    <div id="preview-diffusion" class="flex flex-col items-end space-y-1">
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 <?php echo e($annonce->afficher_site_web ? '' : 'hidden'); ?>"
                                            id="badge-web">
                                            Site web
                                        </span>
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 <?php echo e($annonce->annoncer_culte ? '' : 'hidden'); ?>"
                                            id="badge-culte">
                                            Culte
                                        </span>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-3 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-slate-600"><?php echo e($annonce->created_at->format('d/m/Y H:i')); ?></span>
                                </div>
                                <?php if($annonce->updated_at && $annonce->updated_at != $annonce->created_at): ?>
                                    <div class="flex justify-between">
                                        <span class="font-medium text-slate-700">Modifié:</span>
                                        <span class="text-slate-600"><?php echo e($annonce->updated_at->format('d/m/Y H:i')); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($annonce->publie_le): ?>
                                    <div class="flex justify-between">
                                        <span class="font-medium text-slate-700">Publié:</span>
                                        <span class="text-slate-600"><?php echo e($annonce->publie_le->format('d/m/Y H:i')); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($annonce->auteur): ?>
                                    <div class="pt-2 border-t border-slate-100">
                                        <span class="font-medium text-slate-700">Auteur:</span>
                                        <span class="text-slate-600"><?php echo e($annonce->auteur->nom); ?>

                                            <?php echo e($annonce->auteur->prenom); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <script>
            ...
            function publierAnnonce(annonceId) {
                if (confirm('Êtes-vous sûr de vouloir publier cette annonce ? \nElle sera visible par le public.')) {
                    ...
                    .then(data => {
                        if (data.success) {
                            window.location.href = "<?php echo e(route('private.annonces.show', ':annonce')); ?>".replace(':annonce', annonceId);
                        } else {
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/annonces/edit.blade.php ENDPATH**/ ?>