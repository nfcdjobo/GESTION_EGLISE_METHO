<?php $__env->startSection('title', 'Nouveau Passage - ' . $moisson->theme); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-500 mt-1">
                        Ajouter un passage de collecte pour la moisson "<?php echo e($moisson->theme); ?>"
                    </p>
                </div>
        ...
        <?php if(count($categoriesUtilisees) > 0): ?>
            <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $categoriesUtilisees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-yellow-100 text-yellow-800">
                            <?php echo e(\App\Models\PassageMoisson::CATEGORIES[$categorie] ?? $categorie); ?>
        ...
        <form id="passage-form" action="<?php echo e(route('private.moissons.passages.store', $moisson)); ?>" method="POST" class="space-y-8">
            <?php echo csrf_field(); ?>
                            ...
                            <select name="categorie" id="categorie" required onchange="toggleClasseField()"
                                ...
                                <?php $__currentLoopData = \App\Models\PassageMoisson::CATEGORIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $libelle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($code); ?>"
                                        <?php echo e(old('categorie') === $code ? 'selected' : ''); ?>

                                        <?php echo e(in_array($code, $categoriesUtilisees) ? 'data-used=true' : ''); ?>>
                                        <?php echo e($libelle); ?>

                                        <?php echo e(in_array($code, $categoriesUtilisees) ? ' (déjà utilisée)' : ''); ?>
                        ...
                        <div>
                            ...
                            <select name="collecter_par" id="collecter_par" required
                                ...
                                <?php $__currentLoopData = $collecteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collecteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($collecteur->id); ?>" <?php echo e(old('collecter_par') === $collecteur->id ? 'selected' : ''); ?>>
                                        <?php echo e($collecteur->nom_complet); ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="montant_initial" id="montant_initial" min="0" step="0.01"
                                ...
                                class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                value="<?php echo e(old('montant_initial', 0)); ?>">
                            <p class="text-xs text-slate-500 mt-1">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="date_collecte_initiale" id="date_collecte_initiale"
                                class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                value="<?php echo e(old('date_collecte_initiale')); ?>">
                            <p class="text-xs text-slate-500 mt-1">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="1" <?php echo e(old('status', '1') === '1' ? 'checked' : ''); ?>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="0" <?php echo e(old('status', '1') === '0' ? 'checked' : ''); ?>
                        ...
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="4"
                                class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                placeholder="Notes, instructions particulières, ou remarques concernant ce passage..."><?php echo e(old('notes')); ?></textarea>
                            <p class="text-xs text-slate-500 mt-1">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/moissons/passages/create.blade.php ENDPATH**/ ?>