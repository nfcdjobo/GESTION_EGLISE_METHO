    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.confirm')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.start')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.end')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.suspend')): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.cancel')): ?>
                    ...
                    <?php endif; ?>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.upcoming')): ?>
...
<?php endif; ?>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6">
                    ...
                    <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.mark-attendance')): ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rapports-reunions.create')): ?>
        <?php if($reunion->statut === 'terminee'): ?>
            <a href="<?php echo e(route('private.rapports-reunions.create', ['reunion' => $reunion->id])); ?>"
               class="w-full inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors shadow-sm">
                <i class="fas fa-file-alt mr-2"></i> Rédiger un rapport
            </a>
        <?php endif; ?>
    <?php endif; ?>

    
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.evaluate')): ?>
        <?php if($reunion->statut === 'Terminee' && !$reunion->note_globale): ?>
            <button onclick="openEvaluationModal('<?php echo e($reunion->id); ?>')"
                    class="w-full inline-flex items-center justify-center px-4 py-2 bg-amber-600 text-white text-sm font-medium rounded-xl hover:bg-amber-700 transition-colors shadow-sm">
    ...
    <?php if(in_array($reunion->statut, ['en_cours', 'terminee'])): ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.add-testimonies')): ?>
            <button onclick="openTemoignageModal('<?php echo e($reunion->id); ?>')"
                    class="w-full inline-flex items-center justify-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-xl hover:bg-purple-700 transition-colors shadow-sm">
                <i class="fas fa-comment-dots mr-2"></i> Ajouter témoignage
            </button>
        <?php endif; ?>

        
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.add-prayer-requests')): ?>
            <button onclick="openPriereModal('<?php echo e($reunion->id); ?>')"
                    class="w-full inline-flex items-center justify-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-xl hover:bg-green-700 transition-colors shadow-sm">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.send-reminders')): ?>
        <button onclick="openRappelModal('<?php echo e($reunion->id); ?>', '<?php echo e($reunion); ?>')"
                class="w-full inline-flex items-center justify-center px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded-xl hover:bg-orange-700 transition-colors shadow-sm">
            <i class="fas fa-bell mr-2"></i> Envoyer rappel
        </button>
    <?php endif; ?>

    
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunions.create-recurrence')): ?>
        <?php if(!$reunion->est_recurrente): ?>
            <button onclick="openRecurrenceModal('<?php echo e($reunion->id); ?>', '<?php echo e($reunion); ?>')"
                    class="w-full inline-flex items-center justify-center px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-xl hover:bg-indigo-700 transition-colors shadow-sm">
                <i class="fas fa-calendar-plus mr-2"></i> Créer récurrence
            </button>
        <?php endif; ?>
    <?php endif; ?>
</div>
