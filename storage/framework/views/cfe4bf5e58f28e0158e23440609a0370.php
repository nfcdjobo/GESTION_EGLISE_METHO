<?php $__env->startSection('title', 'Tableau de Bord - Moissons'); ?>
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    ...
                    <p class="text-slate-500 mt-1">
                        Vue d'ensemble des performances et statistiques - <?php echo e(now()->format('l d F Y')); ?>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-2xl font-bold text-slate-900" id="total-moissons"><?php echo e($stats['total_moissons'] ?? 0); ?></p>
                    </div>
                </div>
                <div class="flex items-center">
                    <span class="text-xs px-2 py-1 bg-blue-100 text-blue-600 rounded-full">
                        +<?php echo e($stats['nouvelles_moissons'] ?? 0); ?> ce mois
                    </span>
                </div>
            </div>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-2xl font-bold text-slate-900" id="total-collecte"><?php echo e(number_format($stats['total_collecte'] ?? 0, 0, ',', ' ')); ?></p>
                        <p class="text-xs text-slate-500">FCFA</p>
                    </div>
                </div>
                <div class="flex items-center">
                    <span class="text-xs px-2 py-1 bg-green-100 text-green-600 rounded-full">
                        <?php echo e($stats['evolution_collecte'] ?? '+0'); ?>% vs période précédente
                    </span>
                </div>
            </div>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-2xl font-bold text-slate-900" id="objectifs-atteints"><?php echo e($stats['objectifs_atteints'] ?? 0); ?></p>
                        <p class="text-xs text-slate-500">sur <?php echo e($stats['total_moissons'] ?? 0); ?></p>
                    </div>
                </div>
                <div class="flex items-center">
                    <div class="flex-1 bg-slate-200 rounded-full h-2 mr-2">
                        <div class="bg-purple-600 h-2 rounded-full" style="width: <?php echo e($stats['pourcentage_objectifs'] ?? 0); ?>%"></div>
                    </div>
                    <span class="text-xs font-medium"><?php echo e(number_format($stats['pourcentage_objectifs'] ?? 0, 1)); ?>%</span>
                </div>
            </div>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-2xl font-bold text-slate-900" id="performance-moyenne"><?php echo e(number_format($stats['performance_moyenne'] ?? 0, 1)); ?>%</p>
                    </div>
                </div>
                <div class="flex items-center">
                    <div class="flex-1 bg-slate-200 rounded-full h-2 mr-2">
                        <div class="bg-orange-600 h-2 rounded-full" style="width: <?php echo e(min($stats['performance_moyenne'] ?? 0, 100)); ?>%"></div>
                    </div>
            ...
            <div class="lg:col-span-2 bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6">
                    <div class="space-y-4" id="top-moissons">
                        <?php $__currentLoopData = $topMoissons ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $moisson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-medium text-slate-800"><?php echo e(Str::limit($moisson->theme, 30)); ?></h4>
                                        <p class="text-sm text-slate-500"><?php echo e($moisson->date->format('d/m/Y')); ?></p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <p class="font-bold text-green-600"><?php echo e(number_format($moisson->montant_solde, 0, ',', ' ')); ?> FCFA</p>
                                    <p class="text-sm text-slate-500"><?php echo e(number_format($moisson->pourcentage_realise, 1)); ?>% réalisé</p>
                                </div>
                            </div>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
                ...
                <div class="p-6">
                    <div class="space-y-4" id="alertes">
                        ...
                        <?php if(isset($alertes['engagements_retard']) && count($alertes['engagements_retard']) > 0): ?>
                            <div class="bg-red-50 border border-red-200 rounded-lg p-3">
                                <div class="flex items-center mb-2">
                                    <i class="fas fa-exclamation-triangle text-red-500 mr-2"></i>
                                    <span class="font-medium text-red-700">Engagements en retard</span>
                                </div>
                                <p class="text-sm text-red-600"><?php echo e(count($alertes['engagements_retard'])); ?> engagement(s) dépassent leur échéance</p>
                            </div>
                        <?php endif; ?>

                        <!-- Rappels du jour -->
                        <?php if(isset($alertes['rappels_jour']) && count($alertes['rappels_jour']) > 0): ?>
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-3">
                                ...
                                <p class="text-sm text-orange-600"><?php echo e(count($alertes['rappels_jour'])); ?> rappel(s) à effectuer aujourd'hui</p>
                            </div>
                        <?php endif; ?>

                        <!-- Objectifs en danger -->
                        <?php if(isset($alertes['objectifs_danger']) && count($alertes['objectifs_danger']) > 0): ?>
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                                <div class="flex items-center mb-2">
                                    <i class="fas fa-warning text-yellow-500 mr-2"></i>
                                    <span class="font-medium text-yellow-700">Objectifs en danger</span>
                                </div>
                                <p class="text-sm text-yellow-600"><?php echo e(count($alertes['objectifs_danger'])); ?> moisson(s) sous les 50%</p>
                            </div>
                        <?php endif; ?>

                        <!-- Pas d'alertes -->
                        <?php if(empty($alertes) || (empty($alertes['engagements_retard']) && empty($alertes['rappels_jour']) && empty($alertes['objectifs_danger']))): ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-slate-200" id="moissons-recentes">
                        <?php $__currentLoopData = $moissonRecentes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moisson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-slate-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div>
                                        <div class="font-medium text-slate-900"><?php echo e(Str::limit($moisson->theme, 40)); ?></div>
                                        <div class="text-sm text-slate-500"><?php echo e($moisson->culte->titre ?? 'N/A'); ?></div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-sm text-slate-700">
                                    <?php echo e($moisson->date->format('d/m/Y')); ?>

                                </td>
                                <td class="px-6 py-4 text-sm font-medium text-slate-700">
                                    <?php echo e(number_format($moisson->cible, 0, ',', ' ')); ?> FCFA
                                </td>
                                <td class="px-6 py-4 text-sm font-medium text-green-600">
                                    <?php echo e(number_format($moisson->montant_solde, 0, ',', ' ')); ?> FCFA
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        <div class="flex-1 bg-slate-200 rounded-full h-2">
                                            <div class="h-2 rounded-full <?php echo e($moisson->pourcentage_realise >= 100 ? 'bg-green-500' : ($moisson->pourcentage_realise >= 70 ? 'bg-blue-500' : 'bg-orange-500')); ?>"
                                                 style="width: <?php echo e(min($moisson->pourcentage_realise, 100)); ?>%"></div>
                                        </div>
                                        <span class="text-xs font-medium text-slate-700 w-12">
                                            <?php echo e(number_format($moisson->pourcentage_realise, 1)); ?>%
                                        </span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($moisson->status ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                        ...
                        <div class="flex items-center justify-between p-4 bg-blue-50 rounded-xl">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600"><?php echo e($statsComposants['passages']['nombre'] ?? 0); ?> enregistrements</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-blue-600"><?php echo e(number_format($statsComposants['passages']['total'] ?? 0, 0, ',', ' ')); ?> FCFA</p>
                                <p class="text-sm text-slate-500"><?php echo e(number_format($statsComposants['passages']['pourcentage'] ?? 0, 1)); ?>% du total</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-green-50 rounded-xl">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600"><?php echo e($statsComposants['ventes']['nombre'] ?? 0); ?> enregistrements</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-green-600"><?php echo e(number_format($statsComposants['ventes']['total'] ?? 0, 0, ',', ' ')); ?> FCFA</p>
                                <p class="text-sm text-slate-500"><?php echo e(number_format($statsComposants['ventes']['pourcentage'] ?? 0, 1)); ?>% du total</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-purple-50 rounded-xl">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-600"><?php echo e($statsComposants['engagements']['nombre'] ?? 0); ?> enregistrements</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-bold text-purple-600"><?php echo e(number_format($statsComposants['engagements']['total'] ?? 0, 0, ',', ' ')); ?> FCFA</p>
                                <p class="text-sm text-slate-500"><?php echo e(number_format($statsComposants['engagements']['pourcentage'] ?? 0, 1)); ?>% du total</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <div class="border-l-4 border-green-500 pl-4">
                            ...
                            <p class="text-2xl font-bold text-green-600"><?php echo e($tendances['croissance_mensuelle'] ?? '+0'); ?>%</p>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            ...
                            <p class="text-2xl font-bold text-blue-600"><?php echo e(number_format($tendances['moyenne_moisson'] ?? 0, 0, ',', ' ')); ?></p>
                        ...
                        <div class="border-l-4 border-purple-500 pl-4">
                            ...
                            <p class="text-2xl font-bold text-purple-600"><?php echo e($tendances['meilleur_mois'] ?? 'N/A'); ?></p>
                            <p class="text-sm text-slate-600"><?php echo e(number_format($tendances['montant_meilleur_mois'] ?? 0, 0, ',', ' ')); ?> FCFA collectés</p>
                        </div>

                        <!-- Prochaine échéance importante -->
                        <div class="border-l-4 border-orange-500 pl-4">
                            <h4 class="font-medium text-slate-800 mb-1">Prochaine échéance</h4>
                            <p class="text-lg font-bold text-orange-600"><?php echo e($tendances['prochaine_echeance'] ?? 'Aucune'); ?></p>
                            <p class="text-sm text-slate-600"><?php echo e($tendances['montant_echeance'] ?? ''); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            function initCharts() {
                ...
                const donneesEvolution = <?php echo json_encode($donneesGraphiques['evolution'] ?? ['labels' => [], 'data' => []], 512) ?>;
                const donneesRepartition = <?php echo json_encode($donneesGraphiques['repartition'] ?? ['labels' => [], 'data' => []], 512) ?>;
            ...
            function chargerDonneesPeriode(period, dateDebut = null, dateFin = null) {
                ...
                fetch(`<?php echo e(route('private.moissons.dashboard')); ?>?${params.toString()}`, {
                    method: 'GET',
                    headers: {
            ...
            function exporterDashboard() {
                ...
                if (format && ['excel', 'pdf'].includes(format.toLowerCase())) {
                    window.location.href = `<?php echo e(route('private.moissons.dashboard')); ?>/export?format=${format.toLowerCase()}&periode=${currentPeriod}`;
                }
            }
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/moissons/dashboard.blade.php ENDPATH**/ ?>