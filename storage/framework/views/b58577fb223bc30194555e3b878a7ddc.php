...
<div class="space-y-8">
    <!-- Page Title -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Gestion des Fonds</h1>
        <p class="text-slate-500 mt-1">Suivi des transactions financières - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('creer_fonds')): ?>
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('private.fonds.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                <div class="lg:col-span-2">
                    <label class="block text-sm font-medium text-slate-700 mb-2">Recherche</label>
                    <div class="relative">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Numéro, donateur, référence..." class="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div>
                    ...
                    <select name="statut" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="remboursee" <?php echo e(request('statut') == 'remboursee' ? 'selected' : ''); ?>>Remboursée</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Type</label>
                    <select name="type_transaction" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        <option value="">Tous les types</option>
                        <option value="dime" <?php echo e(request('type_transaction') == 'dime' ? 'selected' : ''); ?>>Dîme</option>
                        <option value="offrande_libre" <?php echo e(request('type_transaction') == 'offrande_libre' ? 'selected' : ''); ?>>Offrande libre</option>
                        <option value="offrande_ordinaire" <?php echo e(request('type_transaction') == 'offrande_ordinaire' ? 'selected' : ''); ?>>Offrande ordinaire</option>
                        <option value="offrande_speciale" <?php echo e(request('type_transaction') == 'offrande_speciale' ? 'selected' : ''); ?>>Offrande spéciale</option>
                        <option value="don_special" <?php echo e(request('type_transaction') == 'don_special' ? 'selected' : ''); ?>>Don spécial</option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">Mode paiement</label>
                    <select name="mode_paiement" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div>
                    ...
                    <select name="donateur_id" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <?php $__currentLoopData = $filterData['donateurs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($donateur->id); ?>" <?php echo e(request('donateur_id') == $donateur->id ? 'selected' : ''); ?>>
                ...
                <div class="lg:col-span-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="montant_min" value="<?php echo e(request('montant_min')); ?>" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">Montant max</label>
                        <input type="number" name="montant_max" value="<?php echo e(request('montant_max')); ?>" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                </div>
                <div class="lg:col-span-6 flex gap-2 pt-4">
                    ...
                    <a href="<?php echo e(route('private.fonds.index')); ?>" class="inline-flex items-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-colors">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($fonds->where('statut', 'en_attente')->count()); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($fonds->where('statut', 'validee')->sum('montant'))); ?></p>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center space-x-2">
                    <select id="perPage" class="px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm">
                        ...
                        <option value="100" <?php echo e(request('per_page') == 100 ? 'selected' : ''); ?>>100 par page</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="p-6">
            <?php if($fonds->count() > 0): ?>
                                ...
                                <tr class="border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                                    <td class="py-4 px-4">
                                        ...
                                        <?php if($fond->est_recurrente): ?>
                                            <div class="text-xs text-purple-600"><i class="fas fa-sync-alt mr-1"></i>Récurrente</div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4 px-4">
                                        <div class="text-slate-900"><?php echo e($fond->date_transaction->format('d/m/Y')); ?></div>
                                        <?php if($fond->heure_transaction): ?>
                                            <div class="text-xs text-slate-500"><?php echo e($fond->heure_transaction->format('H:i')); ?></div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4 px-4">
                                        ...
                                        <?php elseif($fond->donateur): ?>
                                            <div class="font-medium text-slate-900"><?php echo e($fond->donateur->nom); ?> <?php echo e($fond->donateur->prenom); ?></div>
                                    ...
                                    <td class="py-4 px-4">
                                        ...
                                        <?php if($fond->est_flechee): ?>
                                            <div class="text-xs text-orange-600 mt-1"><i class="fas fa-arrow-right mr-1"></i>Fléchée</div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4 px-4">
                                        <div class="font-bold text-slate-900"><?php echo e(number_format($fond->montant, 0, ',', ' ')); ?> <?php echo e($fond->devise); ?></div>
                                    ...
                                    <td class="py-4 px-4">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            ...
                                            <?php elseif($fond->statut == 'remboursee'): ?> bg-purple-100 text-purple-800
                                            <?php endif; ?>">
                                            <?php echo e($fond->statut_libelle ?? ucfirst($fond->statut)); ?>

                                        </span>
                                        <?php if($fond->recu_emis): ?>
                                            <div class="text-xs text-green-600 mt-1"><i class="fas fa-receipt mr-1"></i>Reçu émis</div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="py-4 px-4">
                                        <div class="flex items-center space-x-2">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('voir_fonds')): ?>
                                                <a href="<?php echo e(route('private.fonds.show', $fond)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-cyan-600 bg-cyan-100 rounded-lg hover:bg-cyan-200 transition-colors" title="Voir">
                                                    <i class="fas fa-eye text-sm"></i>
                                                </a>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('modifier_fonds')): ?>
                                                <?php if($fond->peutEtreModifiee()): ?>
                                                    <a href="<?php echo e(route('private.fonds.edit', $fond)); ?>" class="inline-flex items-center justify-center w-8 h-8 text-yellow-600 bg-yellow-100 rounded-lg hover:bg-yellow-200 transition-colors" title="Modifier">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('valider_fonds')): ?>
                                                <?php if($fond->peutEtreValidee()): ?>
                                                    <button type="button" onclick="validateTransaction('<?php echo e($fond->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors" title="Valider">
                                                        <i class="fas fa-check text-sm"></i>
                                                    </button>
                                                <?php endif; ?>

                                                <?php if($fond->peutEtreAnnulee()): ?>
                                                    <button type="button" onclick="openCancelModal('<?php echo e($fond->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-red-600 bg-red-100 rounded-lg hover:bg-red-200 transition-colors" title="Annuler">
                                                        <i class="fas fa-times text-sm"></i>
                                                    </button>
                                                <?php endif; ?>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('generer_recu')): ?>
                                                <?php if($fond->peutGenererRecu()): ?>
                                                    <button type="button" onclick="generateReceipt('<?php echo e($fond->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-purple-600 bg-purple-100 rounded-lg hover:bg-purple-200 transition-colors" title="Générer reçu">
                                                        <i class="fas fa-receipt text-sm"></i>
                                                    </button>
                                                <?php endif; ?>
                                            <?php endif; ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('supprimer_fonds')): ?>
                                                <?php if($fond->peutEtreModifiee()): ?>
                                                    <button type="button" onclick="deleteTransaction('<?php echo e($fond->id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-red-600 bg-red-100 rounded-lg hover:bg-red-200 transition-colors" title="Supprimer">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-6 border-t border-slate-200">
                    <div class="text-sm text-slate-700">
                        Affichage de <span class="font-medium"><?php echo e($fonds->firstItem()); ?></span> à <span class="font-medium"><?php echo e($fonds->lastItem()); ?></span>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('creer_fonds')): ?>
                        <a href="<?php echo e(route('private.fonds.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
