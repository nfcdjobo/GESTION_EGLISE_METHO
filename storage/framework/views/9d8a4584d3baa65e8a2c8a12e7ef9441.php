...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['programmes.planning', 'programmes.create', 'programmes.statistics'])): ?>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.create')): ?>
                                <a href="<?php echo e(route('private.programmes.create')); ?>"
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.planning')): ?>
                                <a href="<?php echo e(route('private.programmes.planning')); ?>"
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.statistics')): ?>
                                <a href="<?php echo e(route('private.programmes.statistiques')); ?>"
            ...
            <?php endif; ?>
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('private.programmes.index')); ?>"
                    ...
                    <div>
                        ...
                        <select name="audience"
                            ...
                            <?php $__currentLoopData = \App\Models\Programme::AUDIENCES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(request('audience') == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="sort"
                            class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                            <option value="created_at" <?php echo e(request('sort') == 'created_at' ? 'selected' : ''); ?>>Date
                                création</option>
                            <option value="nom_programme" <?php echo e(request('sort') == 'nom_programme' ? 'selected' : ''); ?>>Nom
                            </option>
                            <option value="date_debut" <?php echo e(request('sort') == 'date_debut' ? 'selected' : ''); ?>>Date début
                            </option>
                            <option value="type_programme" <?php echo e(request('sort') == 'type_programme' ? 'selected' : ''); ?>>Type
                            </option>
                        </select>
                    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($programmes->where('statut', 'actif')->count()); ?>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($programmes->where('statut', 'planifie')->count()); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($programmes->whereIn('frequence', ['quotidien', 'hebdomadaire'])->count()); ?></p>
                ...
                <?php if($programmes->count() > 0): ?>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div>
                                                    <div class="font-semibold text-slate-900">
                                                        <?php echo e($programme->nom_programme); ?></div>
                                                    <div class="text-sm text-slate-500">
                                                        <code
                                                            class="px-2 py-1 text-xs bg-slate-100 text-slate-800 rounded"><?php echo e($programme->code_programme); ?></code>
                                                    </div>
                                                    <?php if($programme->description): ?>
                                                        <div class="text-sm text-slate-600 mt-1">
                                                            <?php echo e(Str::limit($programme->description, 50)); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="text-sm">
                                                <?php if($programme->heure_debut && $programme->heure_fin): ?>
                                                    <div class="font-medium text-slate-900"><?php echo e($programme->horaires); ?>

                                                    </div>
                                                <?php endif; ?>
                                                <?php if($programme->jours_semaine): ?>
                                                    <div class="text-slate-600"><?php echo e($programme->jours_semaine_texte); ?>
                                            ...
                                            <?php if($programme->responsablePrincipal): ?>
                                                <div class="text-sm">
                                                    <div class="font-medium text-slate-900">
                                                        <?php echo e($programme->responsablePrincipal->prenom); ?>

                                                        <?php echo e($programme->responsablePrincipal->nom); ?></div>
                                                </div>
                                            <?php else: ?>
                                        ...
                                        <td class="px-4 py-4">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                    bg-<?php echo e($programme->statut_badge); ?>-100
                                                    text-<?php echo e($programme->statut_badge); ?>-800">
                                                
                                                <span
                                                    class="w-2 h-2 mr-2 rounded-full bg-<?php echo e($programme->statut_badge); ?>-500"></span>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center space-x-2">
                                                <a href="<?php echo e(route('private.programmes.show', $programme)); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.update')): ?>
                                                    <?php if($programme->peutEtreModifie()): ?>
                                                        <a href="<?php echo e(route('private.programmes.edit', $programme)); ?>"
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.activate')): ?>
                                                    <?php if($programme->statut === 'planifie'): ?>
                                                        <button type="button"
                                                            onclick="changerStatut('<?php echo e($programme->id); ?>', 'activer')"
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.suspend')): ?>
                                                    <?php if($programme->statut === 'actif'): ?>
                                                        <button type="button"
                                                            onclick="changerStatut('<?php echo e($programme->id); ?>', 'suspendre')"
                                                    ...
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.duplicate')): ?>
                                                    <button type="button"
                                                        onclick="dupliquerProgramme('<?php echo e($programme->id); ?>')"
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.delete')): ?>
                                                    <?php if($programme->peutEtreModifie()): ?>
                                                        <button type="button"
                                                            onclick="supprimerProgramme('<?php echo e($programme->id); ?>')"
                    ...
                    <div
                        ...
                        <div class="text-sm text-slate-700">
                            Affichage de <span class="font-medium"><?php echo e($programmes->firstItem()); ?></span> à <span
                                class="font-medium"><?php echo e($programmes->lastItem()); ?></span>
    ...
    <script>
        ...
        function changerStatut(programmeId, action) {
            ...
            showModal(actionData.title, actionData.message, function() {
                fetch(`<?php echo e(route('private.programmes.activer', ':programmeid')); ?>`.replace(':programmeid',
        ...
        function dupliquerProgramme(programmeId) {
            showModal('Dupliquer le programme', 'Voulez-vous créer une copie de ce programme ?', function() {
                ...
                fetch(`<?php echo e(route('private.programmes.dupliquer', ':programmeid')); ?>`.replace(':programmeid',
                        programmeId), {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            // location.reload();
                            window.location.href = `<?php echo e(route('private.programmes.edit', ':programmeid')); ?>`
        ...
        function supprimerProgramme(programmeId) {
            showModal('Supprimer le programme',
                ...
                function() {
                    fetch(`<?php echo e(route('private.programmes.destroy', ':programmeid')); ?>`.replace(':programmeid',
                            programmeId), {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
