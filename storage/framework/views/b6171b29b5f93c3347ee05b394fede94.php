...
<div class="space-y-8">
    ...
    <form action="<?php echo e(route('private.roles.store')); ?>" method="POST" id="roleForm" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" required maxlength="100" placeholder="Ex: Administrateur"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="slug" name="slug" value="<?php echo e(old('slug')); ?>" required maxlength="100" placeholder="administrateur"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" id="level" name="level" value="<?php echo e(old('level', 10)); ?>" required min="0" max="100"
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['level'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:ring-red-500 focus:border-red-500 <?php unset($message);
                            ...
                            <div class="flex items-end">
                                <div class="w-full">
                                    <div class="flex items-center h-12">
                                        <input type="checkbox" id="is_system_role" name="is_system_role" value="1" <?php echo e(old('is_system_role') ? 'checked' : ''); ?>

                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 <?php $__errorArgs = ['is_system_role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__errorArgs = ['is_system_role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="bg-gradient-to-r from-slate-50 to-blue-50 p-4 border-b border-slate-200">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            <input type="checkbox" id="category-<?php echo e($category); ?>" data-category="<?php echo e($category); ?>" onchange="toggleCategoryPermissions('<?php echo e($category); ?>')"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 category-checkbox">
                                            <label for="category-<?php echo e($category); ?>" class="text-lg font-semibold text-slate-800">
                                        ...
                                        <?php $__currentLoopData = $categoryPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="p-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
                                                <div class="flex items-start space-x-3">
                                                    <input type="checkbox" name="permissions[]" value="<?php echo e($permission->id); ?>" id="permission_<?php echo e($permission->id); ?>" data-category="<?php echo e($category); ?>"
                                                    ...
                                                    <div class="flex-1">
                                                        <label for="permission_<?php echo e($permission->id); ?>" class="block text-sm font-semibold text-slate-900 cursor-pointer">
                                                            <?php echo e($permission->name); ?>

                                                        </label>
                                                        <?php if($permission->description): ?>
                                                            <p class="text-xs text-slate-600 mt-1"><?php echo e($permission->description); ?></p>
                                                        <?php endif; ?>
                                                        <code class="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded mt-2 inline-block"><?php echo e($permission->slug); ?></code>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="bg-white/80  rounded-2xl shadow-lg border border-white/20">
            <div class="p-6">
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="<?php echo e(route('private.roles.index')); ?>" class="inline-flex items-center justify-center px-8 py-3 bg-slate-600 text-white font-medium rounded-xl hover:bg-slate-700 transition-colors">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/roles/create.blade.php ENDPATH**/ ?>