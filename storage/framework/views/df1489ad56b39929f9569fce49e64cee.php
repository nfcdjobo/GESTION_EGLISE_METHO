<?php $__env->startSection('title', 'Tableau de bord FIMECOs'); ?>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 mt-1">
                            Vue d'ensemble et analyses - <?php echo e(\Carbon\Carbon::now()->locale('fr')->format('l d F Y')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques_globales['total_fimecos']); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques_globales['fimecos_actifs']); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($statistiques_globales['objectifs_atteints']); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($statistiques_globales['montant_total_cible'], 0, ',', ' ')); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($statistiques_globales['montant_total_solde'], 0, ',', ' ')); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($statistiques_globales['progression_globale'], 1)); ?>%</p>
                    ...
                    <div class="p-6 space-y-3">
                        <?php $__currentLoopData = $alertes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center p-4 rounded-lg border-l-4
                                <?php if($alerte['type'] === 'danger'): ?> bg-red-50 border-red-400
                                <?php elseif($alerte['type'] === 'warning'): ?> bg-yellow-50 border-yellow-400
                                <?php else: ?> bg-blue-50 border-blue-400 <?php endif; ?>">
                                <div class="flex-shrink-0">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium
                                        <?php if($alerte['type'] === 'danger'): ?> text-red-800
                                        <?php elseif($alerte['type'] === 'warning'): ?> text-yellow-800
                                ...
                                <div class="ml-auto">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php if($alerte['type'] === 'danger'): ?> bg-red-100 text-red-800
                                        <?php elseif($alerte['type'] === 'warning'): ?> bg-yellow-100 text-yellow-800
                                        <?php else: ?> bg-blue-100 text-blue-800 <?php endif; ?>">
                                        <?php echo e($alerte['count']); ?>
                ...
                <div class="p-6 border-b border-slate-200">
                    <h2 class="text-xl font-bold text-slate-800 flex items-center">
                        ...
                        <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                            <?php echo e(count($fimecos_urgents)); ?>

                        </span>
                    </h2>
                </div>
                <div class="p-6">
                    <?php if(count($fimecos_urgents) > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $fimecos_urgents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fimeco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-slate-800"><?php echo e(Str::limit($fimeco['nom'], 30)); ?></p>
                                            <p class="text-xs text-slate-500">
                                                <?php if(isset($fimeco['responsable'])): ?>
                                                    <?php echo e($fimeco['responsable']['nom']); ?>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="text-xs text-slate-500 mt-1"><?php echo e(number_format($fimeco['progression'], 1)); ?>%</p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-slate-200">
                                <?php $__currentLoopData = array_slice($performance_mensuelle, -6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mois): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-slate-50">
                                        <td class="px-4 py-3 text-sm font-medium text-slate-900">
                                            <?php echo e(\Carbon\Carbon::parse($mois['mois'] . '-01')->format('M Y')); ?>

                                        </td>
                                        <td class="px-4 py-3 text-sm text-slate-600">
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($mois['nouveaux_fimecos']); ?>

                                            </span>
                                        </td>
                                        <td class="px-4 py-3 text-sm text-slate-600">
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                <?php echo e($mois['objectifs_atteints']); ?>
                ...
                <div class="p-6 border-b border-slate-200">
                    <h2 class="text-xl font-bold text-slate-800 flex items-center">
                        ...
                        <span class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                            <?php echo e(count($top_performeurs)); ?>

                        </span>
                    </h2>
                </div>
                <div class="p-6">
                    <?php if(count($top_performeurs) > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $top_performeurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fimeco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg border border-yellow-200">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-slate-800"><?php echo e(Str::limit($fimeco['nom'], 25)); ?></p>
                                            <p class="text-xs text-slate-500">
                                                <?php if(isset($fimeco['responsable'])): ?>
                                                    <?php echo e($fimeco['responsable']['nom']); ?>
                                    ...
                                    <div class="text-right">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm font-bold text-slate-800"><?php echo e(number_format($fimeco['progression'], 1)); ?>%</span>
                                        </div>
                                        <p class="text-xs text-slate-500"><?php echo e(number_format($fimeco['montant_solde'], 0, ',', ' ')); ?> FCFA</p>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                        <div class="text-3xl font-bold text-blue-600 mb-2">
                            <?php echo e(number_format(($statistiques_globales['objectifs_atteints'] / max($statistiques_globales['total_fimecos'], 1)) * 100, 1)); ?>%
                        </div>
                        <div class="text-sm text-blue-700 font-medium">Taux de réussite</div>
                        <div class="text-xs text-blue-600 mt-1">
                            <?php echo e($statistiques_globales['objectifs_atteints']); ?> / <?php echo e($statistiques_globales['total_fimecos']); ?> FIMECOs
                        </div>
                    </div>
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                        <div class="text-3xl font-bold text-green-600 mb-2">
                            <?php echo e(number_format($statistiques_globales['montant_total_solde'] / max($statistiques_globales['total_fimecos'], 1), 0, ',', ' ')); ?>
                    ...
                    <div class="text-center p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200">
                        <div class="text-3xl font-bold text-purple-600 mb-2">
                            <?php echo e(number_format($statistiques_globales['progression_globale'], 1)); ?>%
                        </div>
        ...
        <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl shadow-lg border border-indigo-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('fimecos.search')): ?>
                    <a href="<?php echo e(route('private.fimecos.search')); ?>"
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            function refreshStats() {
                fetch('<?php echo e(route("private.fimecos.liveStats")); ?>', {
                    headers: {
            ...
            function exporterTableauBord() {
                ...
                if (format && ['json', 'excel', 'pdf'].includes(format.toLowerCase())) {
                    window.location.href = `<?php echo e(route('private.fimecos.export')); ?>?format=${format.toLowerCase()}&dashboard=1`;
                }
            }

            function exporterRapportGlobal() {
                window.location.href = `<?php echo e(route('private.fimecos.export')); ?>?format=pdf&type=global`;
            }
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/fimecos/dashboard.blade.php ENDPATH**/ ?>