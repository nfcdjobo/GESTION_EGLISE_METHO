...
<body style="font-family: 'DejaVu Sans', Arial, sans-serif; font-size: 9px; line-height: 1.3; color: #1f2937; margin: 0; padding: 0;">
    ...
    <div style="text-align: center; padding: 15px 0; margin: 20px 0; border-bottom: 3px solid #3b82f6;">
        ...
        <p style="color: #6b7280; font-size: 10px; margin: 0;">
            Total: <?php echo e(count($data)); ?> souscription(s) - Généré le <?php echo e(now()->format('d/m/Y à H:i:s')); ?>
    ...
    <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
        ...
        <div style="font-size: 12px; font-weight: bold; color: #3b82f6;"><?php echo e(number_format($totalSouscrit, 0, ',', ' ')); ?> FCFA</div>
    </div>
    <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
        <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">TOTAL PAYÉ</div>
        <div style="font-size: 12px; font-weight: bold; color: #059669;"><?php echo e(number_format($totalPaye, 0, ',', ' ')); ?> FCFA</div>
    </div>
    <div style="float: left; width: 21%; margin-right: 2%; margin-bottom: 10px; background-color: #f8fafc; border: 1px solid #e5e7eb; border-radius: 4px; padding: 8px; text-align: center; box-sizing: border-box;">
        <div style="font-size: 8px; color: #6b7280; margin-bottom: 3px; font-weight: 500;">COMPLÈTES</div>
        <div style="font-size: 12px; font-weight: bold; color: #7c3aed;"><?php echo e($nbCompletes); ?> / <?php echo e(count($data)); ?></div>
    </div>
        ...
        <?php if(count($data) > 0): ?>
            <div style="margin-bottom: 15px; overflow-x: auto;">
                <table style="width: 100%; border-collapse: collapse; font-size: 7px; background-color: white;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $souscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <tr style="<?php echo e($index % 2 === 0 ? 'background-color: #f9fafb;' : 'background-color: white;'); ?>">
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: left; white-space: nowrap;">
                                    <strong><?php echo e(htmlspecialchars($souscription['Souscripteur'])); ?></strong>
                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: left; white-space: nowrap;">
                                    <?php echo e(htmlspecialchars($souscription['FIMECO'])); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <?php echo e($souscription['Date souscription']); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <?php echo e($souscription['Date échéance'] ?? '-'); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    <?php echo e(number_format($souscription['Montant souscrit'], 0, ',', ' ')); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    <?php echo e(number_format($souscription['Montant payé'], 0, ',', ' ')); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: right; white-space: nowrap;">
                                    <?php echo e(number_format($souscription['Reste à payer'], 0, ',', ' ')); ?>

                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; text-align: center; white-space: nowrap;">
                                    <span style="padding: 2px 6px; border-radius: 10px; font-size: 7px; font-weight: bold; <?php echo e($rowStyles); ?>">
                                        <?php echo e(number_format($progression, 1)); ?>%
                                    </span>
                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; text-align: center; white-space: nowrap;">
                                    <span style="padding: 2px 6px; border-radius: 10px; font-size: 7px; font-weight: bold; <?php echo e($statutStyle); ?>">
                                        <?php echo e($souscription['Statut']); ?>

                                    </span>
                                </td>
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <?php if($souscription['En retard'] === 'Oui'): ?>
                                ...
                                <td style="padding: 4px 3px; border: 1px solid #d1d5db; color: #1f2937; text-align: center; white-space: nowrap;">
                                    <?php echo e($souscription['Nb paiements']); ?>
                        ...
                        <tr style="background: linear-gradient(135deg, #059669 0%, #10b981 100%);">
                            ...
                            <td style="padding: 8px 3px; border: 1px solid #047857; text-align: right; color: rgb(38,0,188); font-weight: bold;">
                                <?php echo e(number_format($totalSouscrit, 0, ',', ' ')); ?>

                            </td>
                            <td style="padding: 8px 3px; border: 1px solid #047857; text-align: right; color: rgb(38,0,188); font-weight: bold;">
                                <?php echo e(number_format($totalPaye, 0, ',', ' ')); ?>
                            ...
                            <td colspan="3" style="padding: 8px 3px; border: 1px solid #047857; text-align: center; color: rgb(38,0,188); font-weight: bold;">
                                <?php echo e($nbCompletes); ?> complètes
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/exports/subscriptions/liste-souscripteur-pdf.blade.php ENDPATH**/ ?>