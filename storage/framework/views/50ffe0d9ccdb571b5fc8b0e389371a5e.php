        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-4">
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 p-6 text-center">
                    <div class="text-6xl font-bold text-blue-600"><?php echo e($statistiques['total']); ?></div>
                    <div class="text-xl text-slate-600">Total</div>
                </div>
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 p-6 text-center">
                    <div class="text-6xl font-bold text-green-600"><?php echo e($statistiques['presents']); ?></div>
                    <div class="text-xl text-slate-600">Présents</div>
                </div>
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 p-6 text-center">
                    <div class="text-6xl font-bold text-purple-600"><?php echo e($statistiques['en_ligne']); ?></div>
                    <div class="text-xl text-slate-600">En ligne</div>
                </div>
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 p-6 text-center">
                    <div class="text-6xl font-bold text-purple-600"><?php echo e($statistiques['hybride']); ?></div>
                    <div class="text-xl text-slate-600">Hybride</div>
                </div>
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 p-6 text-center">
                    <div class="text-6xl font-bold text-amber-600"><?php echo e($statistiques['premieres_visites']); ?></div>
                    <div class="text-xl text-slate-600">Premières visites</div>
                </div>
                <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 p-6 text-center">
                    <div class="text-6xl font-bold text-red-600"><?php echo e($statistiques['necessitant_suivi']); ?></div>
