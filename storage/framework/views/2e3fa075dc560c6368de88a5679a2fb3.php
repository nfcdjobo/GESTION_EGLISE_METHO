    ...
    <div class="space-y-8">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">Gestion
                des Participations</h1>
            <p class="text-slate-500 mt-1">Suivi des présences et participations aux cultes -
                <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
        </div>

        <!-- Filtres et actions -->
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['participants-cultes.nouveaux-visiteurs', 'participants-cultes.statistics'])): ?>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participants-cultes.nouveaux-visiteurs')): ?>
                                <a href="<?php echo e(route('private.participantscultes.nouveaux-visiteurs')); ?>"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participants-cultes.statistics')): ?>
                                <a href="<?php echo e(route('private.participantscultes.statistiques')); ?>"
            ...
            <?php endif; ?>
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('private.participantscultes.index')); ?>"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            <input type="text" name="participant_search" value="<?php echo e(request('participant_search')); ?>"
                        ...
                        <select name="culte_id"
                            ...
                            <?php $__currentLoopData = $cultes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $culte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($culte->id); ?>">
                                    <?php echo e($culte->titre . ' (' . $culte->date_culte->format('Y-h-d') . ')'); ?></option>
                    ...
                    <div>
                        ...
                        <select name="statut_presence"
                            ...
                            <option value="present" <?php echo e(request('statut_presence') == 'present' ? 'selected' : ''); ?>>Présent
                            </option>
                            <option value="present_partiel"
                                <?php echo e(request('statut_presence') == 'present_partiel' ? 'selected' : ''); ?>>Présent Partiel
                            </option>
                            <option value="en_retard" <?php echo e(request('statut_presence') == 'en_retard' ? 'selected' : ''); ?>>En
                                Retard</option>
                            <option value="parti_tot" <?php echo e(request('statut_presence') == 'parti_tot' ? 'selected' : ''); ?>>
                                Parti Tôt</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="type_participation"
                            ...
                            <option value="physique" <?php echo e(request('type_participation') == 'physique' ? 'selected' : ''); ?>>
                                Physique</option>
                            <option value="en_ligne" <?php echo e(request('type_participation') == 'en_ligne' ? 'selected' : ''); ?>>En
                                Ligne</option>
                            <option value="hybride" <?php echo e(request('type_participation') == 'hybride' ? 'selected' : ''); ?>>
                                Hybride</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <select name="role_culte"
                            ...
                            <option value="participant" <?php echo e(request('role_culte') == 'participant' ? 'selected' : ''); ?>>
                                Participant</option>
                            <option value="equipe_technique"
                                <?php echo e(request('role_culte') == 'equipe_technique' ? 'selected' : ''); ?>>Équipe Technique
                            </option>
                            <option value="equipe_louange"
                                <?php echo e(request('role_culte') == 'equipe_louange' ? 'selected' : ''); ?>>Équipe Louange</option>
                            <option value="equipe_accueil"
                                <?php echo e(request('role_culte') == 'equipe_accueil' ? 'selected' : ''); ?>>Équipe Accueil</option>
                            <option value="orateur" <?php echo e(request('role_culte') == 'orateur' ? 'selected' : ''); ?>>Orateur
                            </option>
                            <option value="dirigeant" <?php echo e(request('role_culte') == 'dirigeant' ? 'selected' : ''); ?>>
                                Dirigeant</option>
                            <option value="nouveau_visiteur"
                                <?php echo e(request('role_culte') == 'nouveau_visiteur' ? 'selected' : ''); ?>>Nouveau Visiteur
                            </option>
                        </select>
                    </div>
                            ...
                            <div class="w-full space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" name="premiere_visite" value="1"
                                        <?php echo e(request('premiere_visite') ? 'checked' : ''); ?> id="premiere_visite"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                    <label for="premiere_visite" class="ml-2 text-sm text-slate-700">Première visite</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="checkbox" name="necessite_suivi" value="1"
                                        <?php echo e(request('necessite_suivi') ? 'checked' : ''); ?> id="necessite_suivi"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($participations->where('statut_presence', 'present')->count() ?? 0); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($participations->where('premiere_visite', true)->count() ?? 0); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($participations->where('demande_contact_pastoral', true)->count() ?? 0); ?></p>
                ...
                <?php $__currentLoopData = $participations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-gradient-to-br from-white to-slate-50 rounded-xl border border-slate-200 p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <h3 class="text-lg font-bold text-slate-900 mb-1">
                                    <?php echo e($participation->participant->nom ?? 'N/A'); ?>

                                    <?php echo e($participation->participant->prenom ?? ''); ?>

                                </h3>
                                <p class="text-sm text-slate-600">
                                    <?php echo e($participation->culte->titre ?? 'Culte supprimé'); ?>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-slate-200">
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo e(route('private.participantscultes.show', [$participation->participant_id, $participation->culte_id])); ?>"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participants-cultes.update')): ?>
                                    <button type="button"
                                        onclick="editParticipation('<?php echo e($participation->participant_id); ?>', '<?php echo e($participation->culte_id); ?>')"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participants-cultes.confirm-presence')): ?>
                                    <?php if(!$participation->presence_confirmee): ?>
                                        <button type="button"
                                            onclick="confirmerPresence('<?php echo e($participation->participant_id); ?>', '<?php echo e($participation->culte_id); ?>')"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('participants-cultes.delete')): ?>
                                <button type="button"
                                    onclick="deleteParticipation('<?php echo e($participation->participant_id); ?>', '<?php echo e($participation->culte_id); ?>')"
                            ...
                            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div class="space-y-1">
                                    <div class="font-bold text-slate-900">
                                        <?php echo e($participation->participant->nom ?? 'N/A'); ?> <?php echo e($participation->participant->prenom ?? ''); ?>
                                    ...
                                    <div class="text-xs text-slate-500">
                                        <?php echo e($participation->culte ? \Carbon\Carbon::parse($participation->culte->date_culte)->format('d/m/Y') : 'N/A'); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="text-sm text-slate-600">
                                        <i class="fas fa-user-tag w-4 mr-1"></i><?php echo e($participation->role_culte_libelle); ?>

                                    </div>
                                    <div class="text-sm text-slate-600">
                                        <i class="fas fa-laptop w-4 mr-1"></i><?php echo e($participation->type_participation_libelle); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <?php if($participation->accompagnateur): ?>
                                        <div class="text-xs text-slate-500">
                                            ...
                                            Accompagné par <?php echo e($participation->accompagnateur->nom); ?>
