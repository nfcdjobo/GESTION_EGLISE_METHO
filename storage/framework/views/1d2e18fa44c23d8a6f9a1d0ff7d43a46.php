    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            ...
            function loadDashboardData(period = null, startDate = null, endDate = null) {
                ...
                fetch(`<?php echo e(route('private.dashboard')); ?>?${params.toString()}`, {
                    method: 'GET',
                    headers: {
            ...
            function processExport() {
                ...
                fetch("<?php echo e(route('private.dashboard.exporte')); ?>", {
                    method: 'POST',
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest',
                        'Accept': 'application/json',
                    ...
                    .then(response => {
                        ...
                        if (response.ok) {
                            ...
                            if (selectedFormat === 'excel' || selectedFormat === 'pdf') {
                                ...
                                const downloadUrl = "<?php echo e(route('private.dashboard.exporte')); ?>?" + params.toString();
