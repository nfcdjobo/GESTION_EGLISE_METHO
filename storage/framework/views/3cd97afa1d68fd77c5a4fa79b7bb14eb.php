<?php $__env->startSection('title', 'Nouveaux Visiteurs - Suivi Pastoral'); ?>
...
<div class="space-y-8">
        ...
        <nav class="flex mt-2" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('private.participantscultes.index')); ?>" class="inline-flex items-center text-sm font-medium text-slate-700 hover:text-blue-600 transition-colors">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-users text-slate-500">Suivi pastoral des nouveaux visiteurs et personnes nécessitant un accompagnement - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('private.participantscultes.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-slate-600 to-slate-700 text-white text-sm font-medium rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('private.participantscultes.nouveaux-visiteurs')); ?>" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                <div>
                    ...
                    <select name="jours" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        <option value="7" <?php echo e(request('jours') == '7' ? 'selected' : ''); ?>>7 derniers jours</option>
                        <option value="30" <?php echo e(request('jours', 30) == '30' ? 'selected' : ''); ?>>30 derniers jours</option>
                        <option value="60" <?php echo e(request('jours') == '60' ? 'selected' : ''); ?>>60 derniers jours</option>
                        <option value="90" <?php echo e(request('jours') == '90' ? 'selected' : ''); ?>>90 derniers jours</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="type_suivi" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <option value="premiere_visite" <?php echo e(request('type_suivi') == 'premiere_visite' ? 'selected' : ''); ?>>Première visite uniquement</option>
                        <option value="contact_pastoral" <?php echo e(request('type_suivi') == 'contact_pastoral' ? 'selected' : ''); ?>>Contact pastoral demandé</option>
                        <option value="bapteme" <?php echo e(request('type_suivi') == 'bapteme' ? 'selected' : ''); ?>>Intéressé baptême</option>
                        <option value="membre" <?php echo e(request('type_suivi') == 'membre' ? 'selected' : ''); ?>>Souhaite devenir membre</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="statut_suivi" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        <option value="">Tous</option>
                        <option value="non_contacte" <?php echo e(request('statut_suivi') == 'non_contacte' ? 'selected' : ''); ?>>Non contacté</option>
                        <option value="contacte" <?php echo e(request('statut_suivi') == 'contacte' ? 'selected' : ''); ?>>Contacté</option>
                        <option value="suivi_en_cours" <?php echo e(request('statut_suivi') == 'suivi_en_cours' ? 'selected' : ''); ?>>Suivi en cours</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="accompagnateur_id" class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        <option value="">Tous</option>
                        <option value="avec" <?php echo e(request('accompagnateur_id') == 'avec' ? 'selected' : ''); ?>>Avec accompagnateur</option>
                        <option value="sans" <?php echo e(request('accompagnateur_id') == 'sans' ? 'selected' : ''); ?>>Sans accompagnateur</option>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($visiteurs->count() ?? 0); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($visiteurs->where('demande_contact_pastoral', true)->count() ?? 0); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($visiteurs->where('interesse_bapteme', true)->count() ?? 0); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($visiteurs->where('souhaite_devenir_membre', true)->count() ?? 0); ?></p>
    ...
    <?php if($visiteurs && $visiteurs->count() > 0): ?>
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            <div class="p-6 border-b border-slate-200">
                <h2 class="text-xl font-bold text-slate-800 flex items-center">
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h2 class="text-xl font-bold text-slate-800 flex items-center">
                    ...
                    Nouveaux Visiteurs (<?php echo e($visiteurs->count() ?? 0); ?>)
                </h2>
        ...
        <div class="p-6">
            <?php if($visiteurs && $visiteurs->count() > 0): ?>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <?php $__currentLoopData = $visiteurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visiteur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gradient-to-br from-white to-slate-50 rounded-xl border border-slate-200 p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-start space-x-3">
                                    <input type="checkbox" name="visiteurs[]" value="<?php echo e($visiteur->participant_id); ?>" class="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 mt-1">
                                    <div class="flex-1">
                                        <h3 class="text-lg font-bold text-slate-900 mb-1">
                                            <?php echo e($visiteur->participant->nom ?? 'N/A'); ?> <?php echo e($visiteur->participant->prenom ?? ''); ?>

                                        </h3>
                                        <p class="text-sm text-slate-600"><?php echo e($visiteur->culte->titre ?? 'Culte supprimé'); ?></p>
                                    </div>
                                </div>
                                <div class="flex flex-col items-end space-y-1">
                                    ...
                                    <?php if($visiteur->statut_presence !== 'present'): ?>
                                        <?php
                                            $statutColors = [
                                        ...
                                        ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statutColors[$visiteur->statut_presence] ?? 'bg-gray-100 text-gray-800'); ?>">
                                            <?php echo e($visiteur->statut_presence_libelle); ?>
                            ...
                            <div class="space-y-3 mb-4">
                                <?php if($visiteur->participant->email): ?>
                                    <div class="flex items-center text-sm text-slate-600">
                                        <i class="fas fa-envelope w-4 mr-2"></i>
                                        <a href="mailto:<?php echo e($visiteur->participant->email); ?>" class="text-blue-600 hover:underline"><?php echo e($visiteur->participant->email); ?></a>
                                    </div>
                                <?php endif; ?>

                                <?php if($visiteur->participant->telephone_1): ?>
                                    <div class="flex items-center text-sm text-slate-600">
                                        <i class="fas fa-phone w-4 mr-2"></i>
                                        <a href="tel:<?php echo e($visiteur->participant->telephone_1); ?>" class="text-blue-600 hover:underline"><?php echo e($visiteur->participant->telephone_1); ?></a>
                                    </div>
                                <?php endif; ?>

                                <div class="flex items-center text-sm text-slate-600">
                                    <i class="fas fa-calendar-alt w-4 mr-2"></i>
                                    <span><?php echo e($visiteur->culte ? \Carbon\Carbon::parse($visiteur->culte->date_culte)->format('d/m/Y') : 'N/A'); ?></span>
                                </div>

                                <?php if($visiteur->accompagnateur): ?>
                                    <div class="flex items-center text-sm text-slate-600">
                                        <i class="fas fa-user-friends w-4 mr-2"></i>
                                        <span>Accompagné par <?php echo e($visiteur->accompagnateur->nom); ?> <?php echo e($visiteur->accompagnateur->prenom); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>

                            <!-- Besoins de suivi -->
                            <?php if($visiteur->demande_contact_pastoral || $visiteur->interesse_bapteme || $visiteur->souhaite_devenir_membre): ?>
                                <div class="mb-4">
                                    <h4 class="text-sm font-semibold text-slate-700 mb-2">Besoins identifiés :</h4>
                                    <div class="flex flex-wrap gap-1">
                                        <?php if($visiteur->demande_contact_pastoral): ?>
                                            <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-blue-100 text-blue-800">
                                                <i class="fas fa-praying-hands mr-1"></i> Contact pastoral
                                            </span>
                                        <?php endif; ?>
                                        <?php if($visiteur->interesse_bapteme): ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if($visiteur->souhaite_devenir_membre): ?>
                            ...
                            <!-- Commentaires -->
                            <?php if($visiteur->commentaires_participant): ?>
                                <div class="mb-4">
                                    <h4 class="text-sm font-semibold text-slate-700 mb-2">Commentaires :</h4>
                                    <div class="bg-slate-50 p-3 rounded-lg">
                                        <p class="text-sm text-slate-600"><?php echo e($visiteur->commentaires_participant); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-slate-200">
                                <div class="flex items-center space-x-2">
                                    <a href="<?php echo e(route('private.participantscultes.show', [$visiteur->participant_id, $visiteur->culte_id])); ?>" class="inline-flex items-center justify-center w-8 h-8 text-cyan-600 bg-cyan-100 rounded-lg hover:bg-cyan-200 transition-colors" title="Voir détails">
                                        <i class="fas fa-eye text-sm"></i>
                                    </a>

                                    <?php if($visiteur->participant->email): ?>
                                        <a href="mailto:<?php echo e($visiteur->participant->email); ?>" class="inline-flex items-center justify-center w-8 h-8 text-blue-600 bg-blue-100 rounded-lg hover:bg-blue-200 transition-colors" title="Envoyer email">
                                            <i class="fas fa-envelope text-sm"></i>
                                        </a>
                                    <?php endif; ?>

                                    <?php if($visiteur->participant->telephone_1): ?>
                                        <a href="tel:<?php echo e($visiteur->participant->telephone_1); ?>" class="inline-flex items-center justify-center w-8 h-8 text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors" title="Appeler">
                                            <i class="fas fa-phone text-sm"></i>
                                        </a>
                                    <?php endif; ?>

                                    <button type="button" onclick="ajouterNote('<?php echo e($visiteur->participant_id); ?>', '<?php echo e($visiteur->culte_id); ?>')" class="inline-flex items-center justify-center w-8 h-8 text-purple-600 bg-purple-100 rounded-lg hover:bg-purple-200 transition-colors" title="Ajouter note">
                                ...
                                <div class="flex items-center space-x-2">
                                    <span class="text-xs text-slate-500">
                                        <?php echo e($visiteur->created_at ? $visiteur->created_at->diffForHumans() : 'Date inconnue'); ?>

                                    </span>
                                    <?php if($visiteur->urgence ?? false): ?>
                ...
                <?php if(method_exists($visiteurs, 'links')): ?>
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 pt-6 border-t border-slate-200">
                        <div class="text-sm text-slate-700">
                            Affichage de <span class="font-medium"><?php echo e($visiteurs->firstItem()); ?></span> à <span class="font-medium"><?php echo e($visiteurs->lastItem()); ?></span>
                            sur <span class="font-medium"><?php echo e($visiteurs->total()); ?></span> résultats
                        </div>
                        <div>
                            <?php echo e($visiteurs->appends(request()->query())->links()); ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <p class="text-slate-500 mb-6">
                        <?php if(request()->hasAny(['jours', 'type_suivi', 'statut_suivi'])): ?>
                    ...
                    <a href="<?php echo e(route('private.participantscultes.index')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/particitantscultes/nouveaux-visiteurs.blade.php ENDPATH**/ ?>