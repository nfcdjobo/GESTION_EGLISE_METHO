...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            <div class="p-6 border-b border-slate-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.create')): ?>
                            <a href="<?php echo e(route('private.interventions.create')); ?>"
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.trash')): ?>
                            <a href="<?php echo e(route('private.interventions.trash')); ?>"
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.by-event')): ?>
                            <a href="<?php echo e(route('private.interventions.par-evenement')); ?>"
            ...
            <div class="p-6">
                <form method="GET" action="<?php echo e(route('private.interventions.index')); ?>"
                    ...
                    <div>
                        ...
                        <select name="reunion_id"
                            ...
                            <?php $__currentLoopData = $reunions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reunion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($reunion->id); ?>"
                                    <?php echo e(($currentFilters['reunion_id'] ?? '') == $reunion->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select name="intervenant_id"
                            ...
                            <?php $__currentLoopData = $intervenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($intervenant->id); ?>"
                                    <?php echo e(($currentFilters['intervenant_id'] ?? '') == $intervenant->id ? 'selected' : ''); ?>>
                        ...
                        <select name="type_intervention"
                            ...
                            <?php $__currentLoopData = $filters['types_intervention']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>"
                                    <?php echo e(($currentFilters['type_intervention'] ?? '') == $key ? 'selected' : ''); ?>>
                                    <?php echo e($label); ?>
                    ...
                    <div class="lg:col-span-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select name="statut"
                                ...
                                <?php $__currentLoopData = $filters['statuts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>"
                                        <?php echo e(($currentFilters['statut'] ?? '') == $key ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
                        ...
                        <div class="flex items-center pt-6">
                            <input type="checkbox" name="ordre_passage" value="1"
                                <?php echo e(request('ordre_passage') ? 'checked' : ''); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($interventions->where('statut', 'terminee')->count()); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($interventions->where('statut', 'prevue')->count()); ?></p>
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e($interventions->where('statut', 'annulee')->count()); ?></p>
                            ...
                            <tbody class="divide-y divide-slate-200">
                                <?php $__currentLoopData = $interventions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-slate-50 transition-colors">
                                            ...
                                            <div class="text-sm">
                                                <?php if($intervention->ordre_passage): ?>
                                                    <div class="flex items-center mb-1">
                                                        ...
                                                        <span
                                                            class="font-medium"><?php echo e($intervention->ordre_passage); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center space-x-2">
                                                <a href="<?php echo e(route('private.interventions.show', $intervention)); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.update')): ?>
                                                    <a href="<?php echo e(route('private.interventions.edit', $intervention)); ?>"
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.change-status')): ?>
                                                    <form method="POST"
                                                        action="<?php echo e(route('private.interventions.change-statut', $intervention)); ?>"
                                                        class="inline-block">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <select name="statut" onchange="this.form.submit()"
                                                            ...
                                                            <?php $__currentLoopData = $filters['statuts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($key); ?>"
                                                                    <?php echo e($intervention->statut == $key ? 'selected' : ''); ?>>
                                                                    <?php echo e($label); ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interventions.delete')): ?>
                                                    <button type="button"
                                                        onclick="deleteIntervention('<?php echo e($intervention->id); ?>')"
