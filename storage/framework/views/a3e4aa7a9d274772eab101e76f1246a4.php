<?php $__env->startSection('title', 'Liste des Souscriptions'); ?>
...
<div class="space-y-8">
    ...
    <div class="mb-8">
        <div class="bg-white rounded-xl shadow-lg p-6 border border-slate-200">
            ...
            <p class="text-slate-500 mt-1">Gérez vos souscriptions FIMECO - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        <div class="p-6 border-b border-slate-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <a href="<?php echo e(route('private.subscriptions.mesStatistiques')); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-sm font-medium rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <div class="p-6">
            ...
            <form method="GET" action="<?php echo e(route('private.subscriptions.index')); ?>" class="space-y-6">
                <!-- Recherche générale -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_souscription" value="<?php echo e(request('date_souscription')); ?>"
                               class="w-full px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-2 pt-4 border-t border-slate-200">
                    ...
                    <a href="<?php echo e(route('private.subscriptions.index')); ?>" class="inline-flex items-center px-4 py-2 bg-slate-600 text-white text-sm font-medium rounded-xl hover:bg-slate-700 transition-colors">
        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-slate-800 flex items-center">
                    ...
                    Souscriptions (<?php echo e($meta['total']); ?>)
                </h2>
                        ...
                        <div class="bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                            <div class="p-6">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        <h3 class="text-lg font-bold text-slate-900 mb-1"><?php echo e($subscription['fimeco']['nom']); ?></h3>
                                        <p class="text-xs text-slate-400 mb-1">ID: <?php echo e(substr($subscription['id'], 0, 8)); ?>...</p>
                                        <p class="text-sm text-slate-600">Souscrit le <?php echo e(\Carbon\Carbon::parse($subscription['date_souscription'])->format('d/m/Y')); ?></p>
                                    </div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center justify-between text-sm">
                                        <a href="<?php echo e(route('private.users.show', $subscription->souscripteur->id)); ?>" class="text-slate-600">Souscripteur:</a>
                                        <a href="<?php echo e(route('private.users.show', $subscription->souscripteur->id)); ?>" class="font-medium text-blue-600 hover:text-blue-800 transition-colors"><?php echo e($subscription->souscripteur->nom. ' '. $subscription->souscripteur->prenom); ?></a>
                                    </div>
                                    <div class="flex items-center justify-between text-sm">
                                        <span class="text-slate-600">Montant souscrit:</span>
                                        <span class="font-medium text-blue-600"><?php echo e(number_format($subscription['montant_souscrit'], 0, ',', ' ')); ?> FCFA</span>
                                    </div>
                                    <div class="flex items-center justify-between text-sm">
                                        <span class="text-slate-600">Montant payé:</span>
                                        <span class="font-medium text-green-600"><?php echo e(number_format($subscription['montant_paye'], 0, ',', ' ')); ?> FCFA</span>
                                    </div>
                                    <div class="flex items-center justify-between text-sm">
                                        <span class="text-slate-600">Reste à payer:</span>
                                        <span class="font-medium text-orange-600"><?php echo e(number_format($subscription['reste_a_payer'], 0, ',', ' ')); ?> FCFA</span>
                                    </div>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-gradient-to-r from-blue-500 to-green-500 h-2 rounded-full" style="width:  <?php echo e($pourcentagePaye > 100 ? 100 : $pourcentagePaye); ?>%"></div>
                                    </div>
                                    <div class="text-center text-sm font-medium text-slate-700">
                                        <?php echo e($pourcentagePaye); ?>% payé
                                    </div>
                                </div>

                                <div class="flex items-center gap-2 mt-6 pt-4 border-t border-slate-200">
                                    <a href="<?php echo e(route('private.subscriptions.show', $subscription['id'])); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-cyan-600 bg-cyan-100 rounded-lg hover:bg-cyan-200 transition-colors">
                                        <i class="fas fa-eye mr-1 text-sm"></i> Voir
                                    </a>
                                    <?php if(in_array($subscription['statut'], ['active', 'partiellement_payee'])): ?>
                                        <a href="<?php echo e(route('private.subscriptions.edit', $subscription['id'])); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-yellow-600 bg-yellow-100 rounded-lg hover:bg-yellow-200 transition-colors">
                                            <i class="fas fa-edit mr-1 text-sm"></i> Modifier
                                        </a>
                                        <?php if($subscription['reste_a_payer'] > 0): ?>
                                            <a href="<?php echo e(route('private.paiements.create', $subscription['id'])); ?>" class="flex-1 inline-flex items-center justify-center px-3 py-2 text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors">
                                    ...
                                    <div class="flex items-center space-x-4 flex-1">
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center space-x-3 mb-2">
                                                <h3 class="text-lg font-bold text-slate-900 truncate"><?php echo e($subscription['fimeco']['nom']); ?></h3>
                                            ...
                                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                                <div>
                                                    ...
                                                    <a href="<?php echo e(route('private.users.show', $subscription->souscripteur->id)); ?>" class="block font-medium text-blue-600 hover:text-blue-800 transition-colors"><?php echo e($subscription->souscripteur->nom. ' '. $subscription->souscripteur->prenom); ?></a>
                                                </div>
                                                <div>
                                                    <span class="text-slate-600">Souscrit:</span>
                                                    <div class="font-medium text-blue-600"><?php echo e(number_format($subscription['montant_souscrit'], 0, ',', ' ')); ?> FCFA</div>
                                                </div>
                                                <div>
                                                    <span class="text-slate-600">Payé:</span>
                                                    <div class="font-medium text-green-600"><?php echo e(number_format($subscription['montant_paye'], 0, ',', ' ')); ?> FCFA</div>
                                                </div>
                                                <div>
                                                    <span class="text-slate-600">Reste:</span>
                                                    <div class="font-medium text-orange-600"><?php echo e(number_format($subscription['reste_a_payer'], 0, ',', ' ')); ?> FCFA</div>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                ...
                                                <div class="text-xs text-slate-600 mt-1"><?php echo e($pourcentagePaye); ?>% payé - Souscrit le <?php echo e(\Carbon\Carbon::parse($subscription['date_souscription'])->format('d/m/Y')); ?></div>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-2">
                                            <a href="<?php echo e(route('private.subscriptions.show', $subscription['id'])); ?>" class="inline-flex items-center px-3 py-2 text-cyan-600 bg-cyan-100 rounded-lg hover:bg-cyan-200 transition-colors">
                                                <i class="fas fa-eye mr-1 text-sm"></i> Voir
                                            </a>
                                            <?php if(in_array($subscription['statut'], ['active', 'partiellement_payee'])): ?>
                                                <a href="<?php echo e(route('private.subscriptions.edit', $subscription['id'])); ?>" class="inline-flex items-center px-3 py-2 text-yellow-600 bg-yellow-100 rounded-lg hover:bg-yellow-200 transition-colors">
                                                    <i class="fas fa-edit mr-1 text-sm"></i> Modifier
                                                </a>
                                                <?php if($subscription['reste_a_payer'] > 0): ?>
                                                    <a href="<?php echo e(route('private.paiements.create', $subscription['id'])); ?>" class="inline-flex items-center px-3 py-2 text-green-600 bg-green-100 rounded-lg hover:bg-green-200 transition-colors">
                                                        <i class="fas fa-plus mr-1 text-sm"></i> Solder
                                                    </a>
                                                <?php endif; ?>
                                            <?php endif; ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <p class="text-slate-500 mb-6">
                        <?php if(request()->hasAny(['search', 'fimeco_id', 'statut', 'montant_min', 'montant_max', 'date_souscription'])): ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($subscriptions->sum('montant_souscrit'), 0, ',', ' ')); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e(number_format($subscriptions->sum('reste_a_payer'), 0, ',', ' ')); ?></p>
            ...
            <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($subscriptions->sum('montant_souscrit') > 0 ? round(($subscriptions->sum('montant_paye') / $subscriptions->sum('montant_souscrit')) * 100, 1) : 0); ?>%</p>
                        <p class="text-sm text-slate-500">Taux de paiement</p> 
