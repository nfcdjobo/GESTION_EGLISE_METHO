                            ...
                            <label for="fimeco_id" class="block text-sm font-medium text-slate-700 mb-2">
                                ...
                                <div class="p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                    ...
                                    <div class="flex items-center gap-4 mt-3 text-sm text-blue-600">
                                        <span><i class="fas fa-calendar mr-1"></i><?php echo e(\Carbon\Carbon::parse($fimecoActive->debut)->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($fimecoActive->fin)->format('d/m/Y')); ?></span>
                                        <span><i class="fas fa-target mr-1"></i><?php echo e(number_format($fimecoActive->cible, 0, ',', ' ')); ?> FCFA</span>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $utilisateursDisponibles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" data-nom="<?php echo e($user->nom); ?>" data-telephone="<?php echo e($user->telephone_1); ?>"
                                                data-name="<?php echo e($user->nom); ?>" data-prenom="<?php echo e($user->prenom); ?>" data-email="<?php echo e($user->email); ?>"
                                                <?php echo e(old('souscripteur_id') == $user->id ? 'selected' : ''); ?>>
                                            <?php echo e($user->nom. ' '. $user->prenom. ' ('. $user->telephone_1. ')'); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="montant_souscrit" name="montant_souscrit" value="<?php echo e(old('montant_souscrit')); ?>"
