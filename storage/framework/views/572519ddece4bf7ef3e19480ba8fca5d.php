<?php $__env->startSection('title', 'Nouveau Don'); ?>
...
<div class="space-y-8">
        ...
        <div class="p-6">
            <div class="flex flex-wrap gap-3">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dons.dashboard')): ?>
                    <a href="<?php echo e(route('private.dons.dashboard')); ?>"
    ...
    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
        ...
        <form action="<?php echo e(route('private.dons.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text"
                               ...
                               value="<?php echo e(old('prenom_donateur')); ?>"
                               required
                               class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['prenom_donateur'];
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__errorArgs = ['prenom_donateur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="nom_donateur"
                               name="nom_donateur"
                               value="<?php echo e(old('nom_donateur')); ?>"
                               required
                               class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['nom_donateur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel"
                               id="telephone_1"
                               name="telephone_1"
                               value="<?php echo e(old('telephone_1')); ?>"
                               required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="tel"
                               id="telephone_2"
                               name="telephone_2"
                               value="<?php echo e(old('telephone_2')); ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="parametre_fond_id"
                                ...
                                required
                                class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['parametre_fond_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $parametres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parametre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($parametre->id); ?>" <?php echo e(old('parametre_fond_id') == $parametre->id ? 'selected' : ''); ?>>
                                    <?php echo e($parametre->operateur); ?> - <?php echo e($parametre->type_libelle); ?>

                                    <?php if($parametre->numero_compte): ?>
                                        (<?php echo e($parametre->numero_compte); ?>)
                                    <?php endif; ?>
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['parametre_fond_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = \App\Models\Don::DEVISES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $libelle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($code); ?>" <?php echo e(old('devise') == $code ? 'selected' : ''); ?>>
                                    <?php echo e($libelle); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-slate-200">
                ...
                <a href="<?php echo e(route('private.dons.index')); ?>" class="inline-flex justify-center items-center px-6 py-3 bg-white border border-slate-300 text-slate-700 font-medium rounded-xl hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/dons/create.blade.php ENDPATH**/ ?>