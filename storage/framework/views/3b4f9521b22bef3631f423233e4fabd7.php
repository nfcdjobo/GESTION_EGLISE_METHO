<?php $__env->startSection('title', 'Importer des membres'); ?>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-users text-slate-500">Importation en lot depuis un fichier CSV - <?php echo e(\Carbon\Carbon::now()->format('l d F Y')); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
...
Pierre,Kouassi,pierre.kouassi@email.com,0147258369,masculin,789 Boulevard du Progrès,Yamoussoukro,nouveau_converti,baptise</code></pre>
        ...
        <form action="<?php echo e(route('private.users.process-import')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if(session('success') || session('import_errors')): ?>
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            <div class="p-6 border-b border-slate-200">
                <h3 class="text-lg font-bold text-slate-800 flex items-center">
                    <div class="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mr-3 shadow-lg">
            ...
            <div class="p-6">
                ...
                <div class="bg-green-50 border-2 border-green-200 rounded-xl p-4 mb-4">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <p class="text-green-700 text-sm mt-1"><?php echo e(session('success')); ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="bg-red-50 border-2 border-red-200 rounded-xl p-4">
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            <h4 class="text-red-800 font-medium">Erreurs rencontrées (<?php echo e(count(session('import_errors'))); ?>)</h4>
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/users/import.blade.php ENDPATH**/ ?>