            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div>
                    <h1
                        ...
                        <?php echo e($programme->nom_programme); ?></h1>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.activate')): ?>
                        <?php if($programme->statut === 'planifie'): ?>
                            <button type="button" onclick="changerStatut('activer')"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.suspend')): ?>
                        <?php if($programme->statut === 'actif'): ?>
                            <button type="button" onclick="changerStatut('suspendre')"
                                class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm font-medium rounded-xl hover:from-orange-600 hover:to-red-600 transition-all duration-200 shadow-md hover:shadow-lg">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.duplicate')): ?>
                        <button type="button" onclick="dupliquerProgramme()"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('programmes.delete')): ?>
                        <?php if($programme->peutEtreModifie()): ?>
                            <button type="button" onclick="supprimerProgramme()"
                                class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-sm font-medium rounded-xl hover:from-red-600 hover:to-pink-600 transition-all duration-200 shadow-md hover:shadow-lg">
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <dd><code
                                        class="px-3 py-1 text-sm bg-slate-100 text-slate-800 rounded-lg"><?php echo e($programme->code_programme); ?></code>
                                </dd>
                            </div>
                            ...
                            <div>
                                ...
                                <dd>
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-<?php echo e($programme->statut_badge); ?>-100 text-<?php echo e($programme->statut_badge); ?>-800">
                                        
                                        <span class="w-2 h-2 mr-2 rounded-full bg-<?php echo e($programme->statut_badge); ?>-500"></span>
                                    ...
                                    <dd>
                                        <div class="flex flex-wrap gap-2">
                                            <?php $__currentLoopData = $programme->jours_semaine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                ?>
                                                <span
                                                    class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-slate-100 text-slate-800">
            ...
            <div class="space-y-6">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <div class="font-semibold text-slate-900">
                                        ...
                                        <?php echo e($programme->responsablePrincipal->nom); ?>

                                    </div>
                                    <?php if($programme->responsablePrincipal->email): ?>
                                        <div class="text-sm text-slate-600"><?php echo e($programme->responsablePrincipal->email); ?>
                ...
                <div
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <?php if($programme->createurMembres): ?>
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-slate-700">Créé par:</span>
                                <span class="text-sm text-slate-900"><?php echo e($programme->createurMembres->prenom); ?>

                                    <?php echo e($programme->createurMembres->nom); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($programme->updated_at != $programme->created_at): ?>
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="text-sm text-slate-900"><?php echo e($programme->updated_at->format('d/m/Y H:i')); ?></span>
                            </div>
                        <?php endif; ?>

                        <?php if($programme->modificateurMembres && $programme->updated_at != $programme->created_at): ?>
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-slate-700">Modifié par:</span>
                                <span class="text-sm text-slate-900"><?php echo e($programme->modificateurMembres->prenom); ?>

                                    <?php echo e($programme->modificateurMembres->nom); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6 space-y-3">
                        <a href="<?php echo e(route('private.programmes.index')); ?>?type=<?php echo e($programme->type_programme); ?>"
                        ...
                        <button type="button" onclick="imprimerProgramme()"
                            class="flex items-center p-3 rounded-lg hover:bg-slate-50 transition-colors w-full text-left">
