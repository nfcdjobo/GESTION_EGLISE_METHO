        ...
        <div class="p-6">
                                    ...
                                    <div class="aspect-video relative rounded-lg overflow-hidden shadow-lg border-2 <?php echo e($slide['active'] ? 'border-purple-300' : 'border-gray-400'); ?>">
                                        ...
                                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 hover:opacity-100 transition-opacity">
                                            <div class="absolute bottom-2 left-2 right-2">
                                                <p class="text-white text-sm font-medium line-clamp-2">
                                                    <i class="fas fa-expand mr-1"></i>Cliquer pour agrandir
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="absolute top-2 left-2">
                                            <span class="inline-flex items-center px-2 py-1 text-xs font-semibold bg-black/70 text-white rounded backdrop-blur-sm">
                                                <i class="fas fa-image mr-1"></i>Slide Hero
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 pl-6">
                                        ...
                                        <div class="flex items-center space-x-2 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-slate-900">16:9 (Full HD)</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <?php if(collect($parametres->images_hero)->where('active', true)->count() === 0): ?>
                <div class="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-yellow-800">Aucun slide actif</p>
                            <p class="text-xs text-yellow-700 mt-1">
                                Tous les slides sont actuellement désactivés. Activez au moins un slide pour l'afficher sur la page d'accueil.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul class="text-xs text-blue-800 space-y-1">
                    ...
                    <li>✓ <strong>Images de qualité</strong> représentant votre église et communauté</li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
// Fonction pour télécharger une image de slide
function downloadSlideImage(imageUrl, titre) {
    fetch(imageUrl)
        ...
        .then(blob => {
            ...
            a.href = url;
            a.download = `slide_${slugify(titre)}_${Date.now()}.jpg`;
            document.body.appendChild(a);
            a.click();
            document.body.removeChild(a);
            window.URL.revokeObjectURL(url);
            showNotification('Slide téléchargé avec succès!', 'success');
        })
        .catch(error => {
