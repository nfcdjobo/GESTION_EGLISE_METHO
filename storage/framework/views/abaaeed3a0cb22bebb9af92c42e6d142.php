                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.publish')): ?>
                                <?php if($annonce->statut === 'brouillon'): ?>
                                    <button onclick="publierAnnonce('<?php echo e($annonce->id); ?>')"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.archive')): ?>
                                <?php if($annonce->statut === 'publiee'): ?>
                                    <button onclick="archiverAnnonce('<?php echo e($annonce->id); ?>')"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.duplicate')): ?>
                                <button onclick="dupliquerAnnonce('<?php echo e($annonce->id); ?>')"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.delete')): ?>
                                <button onclick="supprimerAnnonce('<?php echo e($annonce->id); ?>')"
                            ...
                            <a href="<?php echo e(route('private.annonces.export-pdf', $annonce)); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors">
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <div class="flex flex-wrap items-center gap-3">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($annonce->badge_statut); ?>">
                                        <?php echo e(\App\Models\Annonce::getStatuts()[$annonce->statut] ?? $annonce->statut); ?>

                                    </span>
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($annonce->badge_priorite); ?>">
                            ...
                            <div class="text-right">
                                ...
                                <p class="font-semibold text-slate-700">
                                    <?php echo e(\App\Models\Annonce::getAudiencesCibles()[$annonce->audience_cible] ?? $annonce->audience_cible); ?>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center justify-between py-3 border-b border-slate-100">
                            ...
                            <?php if($annonce->auteur): ?>
                                <span class="text-sm text-slate-600"><?php echo e($annonce->auteur->nom); ?>
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-slate-100">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600"><?php echo e($annonce->publie_le->format('d/m/Y à H:i')); ?>
                            ...
                            <div class="flex items-center justify-between py-3">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600"><?php echo e($annonce->updated_at->format('d/m/Y à H:i')); ?>
                                    ...
                                    <div class="mt-2">
                                        <?php if($annonce->jours_restants > 0): ?>
                                            <span
                                                ...
                                                <?php echo e($annonce->jours_restants); ?>

                                                jour<?php echo e($annonce->jours_restants > 1 ? 's' : ''); ?>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="font-semibold text-slate-800"><?php echo e($annonce->contactPrincipal->nom); ?>

                                        <?php echo e($annonce->contactPrincipal->prenom); ?></p>
                                    <div class="space-y-1">
                                        <a href="mailto:<?php echo e($annonce->contactPrincipal->email); ?>"
                                        ...
                                        <?php if($annonce->contactPrincipal->telephone): ?>
                                            <a href="tel:<?php echo e($annonce->contactPrincipal->telephone); ?>"
                                                class="flex items-center text-sm text-blue-600 hover:text-blue-800 transition-colors">
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-slate-800"><?php echo e($annonce->created_at->diffForHumans()); ?>
                            ...
                            <?php if($annonce->publie_le): ?>
                                <div class="text-center pt-3 border-t border-slate-100">
                                    <div class="text-2xl font-bold text-green-600">
                                        <?php echo e($annonce->publie_le->diffForHumans()); ?></div>
                    ...
                    <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20">
                        <div class="p-6">
                            ...
                            <div class="flex flex-col space-y-3">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('annonces.update')): ?>
                                    <a href="<?php echo e(route('private.annonces.edit', $annonce->id)); ?>"
