...
<div class="space-y-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-2">Analyse complète des données des classes - <?php echo e(\Carbon\Carbon::now()->format('l d F Y à H:i')); ?></p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-xs text-slate-600 mt-1">
                        <?php echo e(round(($stats['classes_actives'] / max($stats['total_classes'], 1)) * 100, 1)); ?>% du total
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['total_inscrits']); ?></p>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-6 border border-white/20 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['taux_occupation_moyen']); ?></p>
                    <p class="text-sm text-slate-500">Moyenne par classe</p>
                    <p class="text-xs text-slate-600 mt-1">
                        Taux occupation: <?php echo e(round(($stats['taux_occupation_moyen'] / 50) * 100, 1)); ?>%
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <?php $__currentLoopData = $stats['tranches_age']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tranche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center flex-1">
                                    <div class="w-3 h-3 bg-gradient-to-r <?php echo e($colorClass); ?> rounded-full mr-3"></div>
                                    <span class="text-sm font-medium text-slate-700"><?php echo e($tranche); ?></span>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <div class="w-24 bg-slate-200 rounded-full h-2">
                                        <div class="bg-gradient-to-r <?php echo e($colorClass); ?> h-2 rounded-full transition-all duration-500" style="width: <?php echo e($percentage); ?>%"></div>
                                    </div>
                                    <span class="text-sm font-semibold text-slate-900 w-12 text-right"><?php echo e(number_format($percentage, 1)); ?>%</span>
                                </div>
                            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-6">
                    <div class="text-center p-4 bg-green-50 rounded-xl border border-green-200">
                        <div class="text-2xl font-bold text-green-600"><?php echo e($stats['classes_actives']); ?></div>
                    ...
                    <div class="text-center p-4 bg-yellow-50 rounded-xl border border-yellow-200">
                        <div class="text-2xl font-bold text-yellow-600"><?php echo e($stats['total_classes'] - $stats['classes_actives']); ?></div>
                ...
                <div class="mt-6">
                    <div class="text-center p-4 bg-red-50 rounded-xl border border-red-200">
                        <div class="text-2xl font-bold text-red-600"><?php echo e($stats['classes_completes']); ?></div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <div class="flex justify-between items-center mb-1">
                                    <span class="text-sm font-medium text-slate-700"><?php echo e($className); ?></span>
                                    <span class="text-sm font-semibold text-slate-900"><?php echo e($percentage); ?>%</span>
                                </div>
                ...
                <div class="space-y-4">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                            <div class="flex items-center space-x-3">
                                <span class="text-2xl"><?php echo e($medals[$i-1]); ?></span>
                                <div>
                                    <p class="font-medium text-slate-900"><?php echo e($names[$i-1]); ?></p>
                                    <p class="text-sm text-slate-500"><?php echo e($counts[$i-1]); ?> membres</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="text-lg font-bold text-blue-600"><?php echo e($counts[$i-1]); ?></div>
                                <div class="text-xs text-slate-500"><?php echo e(round(($counts[$i-1]/50)*100)); ?>%</div>
                            </div>
                        </div>
                    <?php endfor; ?>
                </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold">
                                    <?php echo e(substr(explode(' ', $names[$i-1])[0], 0, 1)); ?><?php echo e(substr(explode(' ', $names[$i-1])[1], 0, 1)); ?>

                                </div>
                                <div>
                                    <p class="font-medium text-slate-900"><?php echo e($names[$i-1]); ?></p>
                                    <p class="text-sm text-slate-500"><?php echo e($classes[$i-1]); ?> classe(s)</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="text-sm font-bold text-blue-600"><?php echo e($members[$i-1]); ?></div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg border border-white/20 hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="flex items-center justify-between p-3 bg-purple-50 rounded-xl">
                    ...
                    <span class="text-lg font-bold text-purple-600"><?php echo e($stats['classes_actives']); ?></span>
                </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200">
                    ...
                    <p class="text-sm text-slate-600 mb-3"><?php echo e($stats['classes_completes']); ?> classes sont complètes. Envisagez de créer de nouvelles classes pour répondre à la demande.</p>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('classes.create')): ?>
                        <a href="<?php echo e(route('private.classes.create')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm font-medium">
                ...
                <div class="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                    ...
                    <p class="text-sm text-slate-600 mb-3"><?php echo e($stats['total_classes'] - $stats['classes_actives']); ?> classes sont sans responsable et nécessitent une supervision.</p>
