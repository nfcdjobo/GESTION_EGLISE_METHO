                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cultes.statistics')): ?>
                            <a href="<?php echo e(route('private.cultes.statistiques')); ?>"
                ...
                <form method="GET" action="<?php echo e(route('private.cultes.index')); ?>"
                    ...
                    <div>
                        ...
                        <select name="statut"
                            ...
                            <option value="en_preparation" <?php echo e(request('statut') == 'en_preparation' ? 'selected' : ''); ?>>En
                                Préparation</option>
                            ...
                            <div class="w-full space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" name="a_venir" value="1"
                                        <?php echo e(request('a_venir') ? 'checked' : ''); ?> id="a_venir"
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="publics_seulement" value="1"
                                        <?php echo e(request('publics_seulement') ? 'checked' : ''); ?> id="publics_seulement"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800"><?php echo e($cultes->where('statut', 'planifie')->count()); ?>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-2xl font-bold text-slate-800">
                            <?php echo e(number_format($cultes->sum('offrande_totale') ?: 0)); ?> FCFA</p>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <select id="sortBy"
                            ...
                            <option value="date_culte" <?php echo e(request('sort_by') == 'date_culte' ? 'selected' : ''); ?>>Date
                            </option>
                            <option value="titre" <?php echo e(request('sort_by') == 'titre' ? 'selected' : ''); ?>>Titre</option>
                            <option value="type_culte" <?php echo e(request('sort_by') == 'type_culte' ? 'selected' : ''); ?>>Type
                            </option>
                            <option value="statut" <?php echo e(request('sort_by') == 'statut' ? 'selected' : ''); ?>>Statut</option>
                            <option value="nombre_participants"
                                <?php echo e(request('sort_by') == 'nombre_participants' ? 'selected' : ''); ?>>Participants</option>
                        </select>
                        <select id="sortOrder"
                            class="px-3 py-2 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm">
                ...
                <?php if($cultes->count() > 0): ?>
                            ...
                            <div
                                ...
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <div class="flex flex-col items-end space-y-2">
                                        ...
                                        ?>
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statutColors[$culte->statut] ?? 'bg-gray-100 text-gray-800'); ?>">
                    ...
                    <div
                        ...
                        <div class="text-sm text-slate-700">
                            Affichage de <span class="font-medium"><?php echo e($cultes->firstItem()); ?></span> à <span
                                class="font-medium"><?php echo e($cultes->lastItem()); ?></span>
