<?php $__env->startSection('title', 'Nouvelle Moisson'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        ...
        <form id="moisson-form" action="<?php echo e(route('private.moissons.store')); ?>" method="POST" class="space-y-8">
            <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="1" <?php echo e(old('status', '0') == '1' ? 'checked' : ''); ?>

                                        class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300">
                                    <span class="ml-2 text-sm text-slate-700">Active</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="status" value="0" <?php echo e(old('status', '0') == '0' ? 'checked' : ''); ?>
                        ...
                        <div class="donateur-field hidden">
                            ...
                            <select name="engagements[${id}][donateur_id]"
                                ...
                                <?php $__currentLoopData = $responsables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($responsable->id); ?>"><?php echo e($responsable->nom_complet); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.private.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\MICRISERVICES\methodiste_belle_ville\resources\views/components/private/moissons/create.blade.php ENDPATH**/ ?>